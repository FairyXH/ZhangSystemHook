...
class StringsKt__StringBuilderJVMKt extends com.android.server.permission.jarjar.kotlin.text.StringsKt__RegexExtensionsKt {
    ...
    private static final java.lang.StringBuilder setRange(java.lang.StringBuilder $this$setRange, int startIndex, int endIndex, java.lang.String value) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$setRange, "<this>");
        ...
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(sbReplace, "replace(...)");
        return sbReplace;
    }

    private static final java.lang.StringBuilder deleteAt(java.lang.StringBuilder $this$deleteAt, int index) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$deleteAt, "<this>");
        java.lang.StringBuilder sbDeleteCharAt = $this$deleteAt.deleteCharAt(index);
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(sbDeleteCharAt, "deleteCharAt(...)");
    ...
    private static final java.lang.StringBuilder deleteRange(java.lang.StringBuilder $this$deleteRange, int startIndex, int endIndex) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$deleteRange, "<this>");
        java.lang.StringBuilder sbDelete = $this$deleteRange.delete(startIndex, endIndex);
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(sbDelete, "delete(...)");
        return sbDelete;
    }
    ...
    static /* synthetic */ void toCharArray$default(java.lang.StringBuilder $this$toCharArray_u24default, char[] destination, int destinationOffset, int startIndex, int endIndex, int i, java.lang.Object obj) {
        ...
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$toCharArray_u24default, "<this>");
    ...
    private static final void toCharArray(java.lang.StringBuilder $this$toCharArray, char[] destination, int destinationOffset, int startIndex, int endIndex) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$toCharArray, "<this>");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(destination, "destination");
    ...
    private static final java.lang.StringBuilder appendRange(java.lang.StringBuilder $this$appendRange, char[] value, int startIndex, int endIndex) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$appendRange, "<this>");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(value, "value");
    ...
    private static final java.lang.StringBuilder insertRange(java.lang.StringBuilder $this$insertRange, int index, char[] value, int startIndex, int endIndex) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$insertRange, "<this>");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(value, "value");
        java.lang.StringBuilder sbInsert = $this$insertRange.insert(index, value, startIndex, endIndex - startIndex);
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(sbInsert, "insert(...)");
        return sbInsert;
    }
    ...
    @com.android.server.permission.jarjar.kotlin.Deprecated(level = com.android.server.permission.jarjar.kotlin.DeprecationLevel.WARNING, message = "Use appendLine instead. Note that the new method always appends the line feed character '\\n' regardless of the system line separator.", replaceWith = @com.android.server.permission.jarjar.kotlin.ReplaceWith(expression = "appendLine()", imports = {}))
    public static final java.lang.Appendable appendln(java.lang.Appendable $this$appendln) throws java.io.IOException {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$appendln, "<this>");
        java.lang.Appendable appendableAppend = $this$appendln.append(com.android.server.permission.jarjar.kotlin.text.SystemProperties.LINE_SEPARATOR);
    ...
    @com.android.server.permission.jarjar.kotlin.Deprecated(level = com.android.server.permission.jarjar.kotlin.DeprecationLevel.WARNING, message = "Use appendLine instead. Note that the new method always appends the line feed character '\\n' regardless of the system line separator.", replaceWith = @com.android.server.permission.jarjar.kotlin.ReplaceWith(expression = "appendLine(value)", imports = {}))
    private static final java.lang.Appendable appendln(java.lang.Appendable $this$appendln, java.lang.CharSequence value) throws java.io.IOException {
        ...
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(appendableAppend, "append(...)");
        return com.android.server.permission.jarjar.kotlin.text.StringsKt.appendln(appendableAppend);
    }
    ...
    public static final java.lang.StringBuilder appendln(java.lang.StringBuilder $this$appendln) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$appendln, "<this>");
        java.lang.StringBuilder sbAppend = $this$appendln.append(com.android.server.permission.jarjar.kotlin.text.SystemProperties.LINE_SEPARATOR);
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(sbAppend, "append(...)");
        return sbAppend;
    }
    ...
    private static final java.lang.StringBuilder appendln(java.lang.StringBuilder $this$appendln, java.lang.StringBuffer value) {
        ...
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(sbAppend, "append(...)");
        return com.android.server.permission.jarjar.kotlin.text.StringsKt.appendln(sbAppend);
    }
