...
public class XmlParser {
    public static com.android.server.policy.devicestate.config.DeviceStateConfig read(java.io.InputStream in) throws org.xmlpull.v1.XmlPullParserException, javax.xml.datatype.DatatypeConfigurationException, java.io.IOException {
        ...
        if (!_tagName.equals("device-state-config")) {
            return null;
        }
        com.android.server.policy.devicestate.config.DeviceStateConfig _value = com.android.server.policy.devicestate.config.DeviceStateConfig.read(_parser);
        return _value;
    }
