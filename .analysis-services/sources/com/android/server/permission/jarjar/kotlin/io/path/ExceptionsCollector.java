...
final class ExceptionsCollector {
    ...
    public /* synthetic */ ExceptionsCollector(int i, int i2, com.android.server.permission.jarjar.kotlin.jvm.internal.DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? 64 : i);
    }
    ...
    public final void exitEntry(java.nio.file.Path name) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(name, "name");
        java.nio.file.Path path = this.path;
        if (!com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.areEqual(name, path != null ? path.getFileName() : null)) {
    ...
    public final void collect(java.lang.Exception exception) {
        java.nio.file.FileSystemException restoredException;
        ...
        if (shouldCollect) {
            if (this.path != null) {
                ...
                com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNull(thInitCause, "null cannot be cast to non-null type java.nio.file.FileSystemException");
                restoredException = (java.nio.file.FileSystemException) thInitCause;
            } else {
