...
public interface IIris extends vendor.pixelworks.hardware.display.V1_0.IIris {
    public static final java.lang.String kInterfaceName = "vendor.pixelworks.hardware.display@1.1::IIris";

    @java.lang.FunctionalInterface
    public interface getCurrentConfigCallback {
        void onValues(int i, vendor.pixelworks.hardware.display.V1_1.IrisFixedConfig irisFixedConfig);
    }

    @java.lang.FunctionalInterface
    public interface getLayerToneMappingLutCallback {
        void onValues(int i, vendor.pixelworks.hardware.display.V1_1.LutData lutData);
    }
    ...
    void buildLayerStack(long j, vendor.pixelworks.hardware.display.V1_1.LayerStack layerStack) throws android.os.RemoteException;
    ...
    void getCurrentConfig(vendor.pixelworks.hardware.display.V1_1.IIris.getCurrentConfigCallback getcurrentconfigcallback) throws android.os.RemoteException;
    ...
    void getLayerToneMappingLut(long j, int i, vendor.pixelworks.hardware.display.V1_1.IIris.getLayerToneMappingLutCallback getlayertonemappinglutcallback) throws android.os.RemoteException;
    ...
    void initialize(vendor.pixelworks.hardware.display.V1_1.DisplayConfigVariableInfo displayConfigVariableInfo) throws android.os.RemoteException;
    ...
    void isHDR10Plus(boolean z) throws android.os.RemoteException;
    ...
    void registerCallback_1_1(long j, vendor.pixelworks.hardware.display.V1_1.IIrisCallback iIrisCallback) throws android.os.RemoteException;

    void registerSoftIrisClient(vendor.pixelworks.hardware.display.V1_1.ISoftIrisClient iSoftIrisClient) throws android.os.RemoteException;

    void reportDualChannelStatus(int i) throws android.os.RemoteException;

    void setActiveConfig(long j, vendor.pixelworks.hardware.display.V1_1.DisplayConfigVariableInfo displayConfigVariableInfo) throws android.os.RemoteException;
    ...
    void setLayerBuffer(long j, long j2, android.os.NativeHandle nativeHandle, int i, vendor.pixelworks.hardware.display.V1_1.BufferInfo bufferInfo) throws android.os.RemoteException;

    void setLayerCompositionType(long j, long j2, int i) throws android.os.RemoteException;

    void setLayerDisplayFrame(long j, long j2, vendor.pixelworks.hardware.display.V1_1.HwcRect hwcRect) throws android.os.RemoteException;
    ...
    void setLayerSourceCrop(long j, long j2, vendor.pixelworks.hardware.display.V1_1.HwcRect hwcRect) throws android.os.RemoteException;
    ...
    void updateDisplayBrightness(long j, int i, java.util.ArrayList<java.lang.Integer> arrayList, vendor.pixelworks.hardware.display.V1_1.IIris.updateDisplayBrightnessCallback updatedisplaybrightnesscallback) throws android.os.RemoteException;

    static vendor.pixelworks.hardware.display.V1_1.IIris asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        android.os.IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof vendor.pixelworks.hardware.display.V1_1.IIris)) {
            return (vendor.pixelworks.hardware.display.V1_1.IIris) iface;
        }
        vendor.pixelworks.hardware.display.V1_1.IIris proxy = new vendor.pixelworks.hardware.display.V1_1.IIris.Proxy(binder);
        try {
    ...
    static vendor.pixelworks.hardware.display.V1_1.IIris castFrom(android.os.IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static vendor.pixelworks.hardware.display.V1_1.IIris getService(java.lang.String serviceName, boolean retry) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static vendor.pixelworks.hardware.display.V1_1.IIris getService(boolean retry) throws android.os.RemoteException {
        return getService("default", retry);
    }

    @java.lang.Deprecated
    static vendor.pixelworks.hardware.display.V1_1.IIris getService(java.lang.String serviceName) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName));
    }

    @java.lang.Deprecated
    static vendor.pixelworks.hardware.display.V1_1.IIris getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements vendor.pixelworks.hardware.display.V1_1.IIris {
    ...
    public static abstract class Stub extends android.os.HwBinder implements vendor.pixelworks.hardware.display.V1_1.IIris {
        @Override // vendor.pixelworks.hardware.display.V1_1.IIris, vendor.pixelworks.hardware.display.V1_0.IIris, android.hidl.base.V1_0.IBase
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(vendor.pixelworks.hardware.display.V1_1.IIris.kInterfaceName, vendor.pixelworks.hardware.display.V1_0.IIris.kInterfaceName, android.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String descriptor) {
            if (vendor.pixelworks.hardware.display.V1_1.IIris.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags) throws android.os.RemoteException {
            switch (_hidl_code) {
                ...
                case 2:
                    ...
                    irisConfigureGet(type2, values2, new vendor.pixelworks.hardware.display.V1_0.IIris.irisConfigureGetCallback() { // from class: vendor.pixelworks.hardware.display.V1_1.IIris.Stub.1
                ...
                case 5:
                    ...
                    panelReadWrite(highSpeed, dtype, vc, last, tx, rxLen, new vendor.pixelworks.hardware.display.V1_0.IIris.panelReadWriteCallback() { // from class: vendor.pixelworks.hardware.display.V1_1.IIris.Stub.2
                ...
                case 6:
                    ...
                    irisConfigureBatch(type3, json, new vendor.pixelworks.hardware.display.V1_0.IIris.irisConfigureBatchCallback() { // from class: vendor.pixelworks.hardware.display.V1_1.IIris.Stub.3
                ...
                case 14:
                    ...
                    getLayerToneMappingLut(display5, type4, new vendor.pixelworks.hardware.display.V1_1.IIris.getLayerToneMappingLutCallback() { // from class: vendor.pixelworks.hardware.display.V1_1.IIris.Stub.4
                ...
                case 16:
                    ...
                    updateDisplayBrightness(display7, syncMethod, values3, new vendor.pixelworks.hardware.display.V1_1.IIris.updateDisplayBrightnessCallback() { // from class: vendor.pixelworks.hardware.display.V1_1.IIris.Stub.5
                ...
                case 35:
                    _hidl_request.enforceInterface(vendor.pixelworks.hardware.display.V1_1.IIris.kInterfaceName);
                    getCurrentConfig(new vendor.pixelworks.hardware.display.V1_1.IIris.getCurrentConfigCallback() { // from class: vendor.pixelworks.hardware.display.V1_1.IIris.Stub.6
