...
public final class UIntKt {
    private static final int toUInt(byte $this$toUInt) {
        return com.android.server.permission.jarjar.kotlin.UInt.m6184constructorimpl($this$toUInt);
    }
    ...
    private static final int toUInt(long $this$toUInt) {
        return com.android.server.permission.jarjar.kotlin.UInt.m6184constructorimpl((int) $this$toUInt);
    }

    private static final int toUInt(float $this$toUInt) {
        return com.android.server.permission.jarjar.kotlin.UnsignedKt.doubleToUInt($this$toUInt);
    }
