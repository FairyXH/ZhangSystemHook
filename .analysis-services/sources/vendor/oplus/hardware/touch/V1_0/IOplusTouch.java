...
public interface IOplusTouch extends android.hidl.base.V1_0.IBase {
    public static final java.lang.String kInterfaceName = "vendor.oplus.hardware.touch@1.0::IOplusTouch";
    ...
    static vendor.oplus.hardware.touch.V1_0.IOplusTouch asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        android.os.IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof vendor.oplus.hardware.touch.V1_0.IOplusTouch)) {
            return (vendor.oplus.hardware.touch.V1_0.IOplusTouch) iface;
        }
        vendor.oplus.hardware.touch.V1_0.IOplusTouch proxy = new vendor.oplus.hardware.touch.V1_0.IOplusTouch.Proxy(binder);
        try {
    ...
    static vendor.oplus.hardware.touch.V1_0.IOplusTouch castFrom(android.os.IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static vendor.oplus.hardware.touch.V1_0.IOplusTouch getService(java.lang.String serviceName, boolean retry) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static vendor.oplus.hardware.touch.V1_0.IOplusTouch getService(boolean retry) throws android.os.RemoteException {
        return getService("default", retry);
    }

    @java.lang.Deprecated
    static vendor.oplus.hardware.touch.V1_0.IOplusTouch getService(java.lang.String serviceName) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName));
    }

    @java.lang.Deprecated
    static vendor.oplus.hardware.touch.V1_0.IOplusTouch getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements vendor.oplus.hardware.touch.V1_0.IOplusTouch {
        ...
        @Override // vendor.oplus.hardware.touch.V1_0.IOplusTouch, android.hidl.base.V1_0.IBase
        ...
        public int initialize() throws android.os.RemoteException {
            ...
            _hidl_request.writeInterfaceToken(vendor.oplus.hardware.touch.V1_0.IOplusTouch.kInterfaceName);
        ...
        @Override // vendor.oplus.hardware.touch.V1_0.IOplusTouch
        public int isTouchNodeSupport(int deivceid, int nodeFlag) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(vendor.oplus.hardware.touch.V1_0.IOplusTouch.kInterfaceName);
    ...
    public static abstract class Stub extends android.os.HwBinder implements vendor.oplus.hardware.touch.V1_0.IOplusTouch {
        @Override // vendor.oplus.hardware.touch.V1_0.IOplusTouch, android.hidl.base.V1_0.IBase
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(vendor.oplus.hardware.touch.V1_0.IOplusTouch.kInterfaceName, android.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public final java.lang.String interfaceDescriptor() {
            return vendor.oplus.hardware.touch.V1_0.IOplusTouch.kInterfaceName;
        }

        @Override // vendor.oplus.hardware.touch.V1_0.IOplusTouch, android.hidl.base.V1_0.IBase
        public final java.util.ArrayList<byte[]> getHashChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(new byte[]{124, -33, -80, -24, -28, -79, 78, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_ENDPOINT_COMPANION, -90, -4, -43, -62, 105, 47, -100, -109, 51, 0, com.android.server.usb.descriptors.UsbASFormat.EXT_FORMAT_TYPE_I, 113, 57, 10, 77, -42, 56, 72, -80, -54, -6, -34, -91, 98}, new byte[]{-20, 127, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_PHYSICAL, -17, 5, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_INTERFACE, -13, -51, 105, 87, 19, -109, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_INTERFACE, -72, 59, 24, -54, 76}));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String descriptor) {
            if (vendor.oplus.hardware.touch.V1_0.IOplusTouch.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, android.os.HwParcel _hidl_reply, int _hidl_flags) throws android.os.RemoteException {
            switch (_hidl_code) {
                case 1:
                    _hidl_request.enforceInterface(vendor.oplus.hardware.touch.V1_0.IOplusTouch.kInterfaceName);
                ...
                case 2:
                    ...
                    int _hidl_out_status2 = touchWriteNodeFile(deviceId, nodeFlag, info);
                    _hidl_reply.writeStatus(0);
                ...
                case 3:
                    ...
                    java.lang.String _hidl_out_result = touchReadNodeFile(deviceId2, nodeFlag2);
                    _hidl_reply.writeStatus(0);
                ...
                case 4:
                    ...
                    int _hidl_out_status3 = isTouchNodeSupport(deivceid, nodeFlag3);
                    _hidl_reply.writeStatus(0);
