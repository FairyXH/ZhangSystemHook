...
public class UIntProgression implements java.lang.Iterable<kotlin.UInt>, kotlin.jvm.internal.markers.KMappedMarker {
    ...
    private UIntProgression(int start, int endInclusive, int step) {
        ...
        this.first = start;
        this.last = kotlin.internal.UProgressionUtilKt.m12516getProgressionLastElementNkh28Cs(start, endInclusive, step);
        this.step = step;
    }
    ...
    public boolean equals(java.lang.Object other) {
        return (other instanceof kotlin.ranges.UIntProgression) && ((isEmpty() && ((kotlin.ranges.UIntProgression) other).isEmpty()) || (this.first == ((kotlin.ranges.UIntProgression) other).first && this.last == ((kotlin.ranges.UIntProgression) other).last && this.step == ((kotlin.ranges.UIntProgression) other).step));
    }
    ...
    public java.lang.String toString() {
        ...
        int i;
        if (this.step > 0) {
            sbAppend = new java.lang.StringBuilder().append((java.lang.Object) kotlin.UInt.m11448toStringimpl(this.first)).append("..").append((java.lang.Object) kotlin.UInt.m11448toStringimpl(this.last)).append(" step ");
            i = this.step;
        } else {
            sbAppend = new java.lang.StringBuilder().append((java.lang.Object) kotlin.UInt.m11448toStringimpl(this.first)).append(" downTo ").append((java.lang.Object) kotlin.UInt.m11448toStringimpl(this.last)).append(" step ");
            i = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final kotlin.ranges.UIntProgression m12532fromClosedRangeNkh28Cs(int rangeStart, int rangeEnd, int step) {
