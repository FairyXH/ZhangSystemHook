...
public interface IBiometricsFaceClientCallback extends android.hidl.base.V1_0.IBase {
    ...
    static android.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        android.os.IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof android.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback)) {
            return (android.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback) iface;
        }
        android.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback proxy = new android.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback.Proxy(binder);
        try {
    ...
    static android.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback castFrom(android.os.IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static android.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback getService(java.lang.String serviceName, boolean retry) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static android.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback getService(boolean retry) throws android.os.RemoteException {
        return getService("default", retry);
    }

    @java.lang.Deprecated
    static android.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback getService(java.lang.String serviceName) throws android.os.RemoteException {
    ...
    public static final class Proxy implements android.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback {
        ...
        public void onEnrollResult(long deviceId, int faceId, int userId, int remaining) throws android.os.RemoteException {
        ...
        @Override // android.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback
        public void onAuthenticated(long deviceId, int faceId, int userId, java.util.ArrayList<java.lang.Byte> token) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback.kInterfaceName);
            _hidl_request.writeInt64(deviceId);
            _hidl_request.writeInt32(faceId);
        ...
        @Override // android.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback
        public void onAcquired(long deviceId, int userId, int acquiredInfo, int vendorCode) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback.kInterfaceName);
            _hidl_request.writeInt64(deviceId);
            _hidl_request.writeInt32(userId);
        ...
        @Override // android.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback
        public void onError(long deviceId, int userId, int error, int vendorCode) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback.kInterfaceName);
            _hidl_request.writeInt64(deviceId);
            _hidl_request.writeInt32(userId);
        ...
        @Override // android.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback
        public void onRemoved(long deviceId, java.util.ArrayList<java.lang.Integer> removed, int userId) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback.kInterfaceName);
            _hidl_request.writeInt64(deviceId);
        ...
        @Override // android.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback
        public void onEnumerate(long deviceId, java.util.ArrayList<java.lang.Integer> faceIds, int userId) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback.kInterfaceName);
            _hidl_request.writeInt64(deviceId);
        ...
        @Override // android.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback
        public void onLockoutChanged(long duration) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback.kInterfaceName);
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback {
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String descriptor) {
            if (android.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, android.os.HwParcel _hidl_reply, int _hidl_flags) throws android.os.RemoteException {
            switch (_hidl_code) {
                ...
                case 5:
                    ...
                    java.util.ArrayList<java.lang.Integer> removed = _hidl_request.readInt32Vector();
                ...
                case 6:
                    ...
                    java.util.ArrayList<java.lang.Integer> faceIds = _hidl_request.readInt32Vector();
