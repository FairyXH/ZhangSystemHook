        ...
        public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    android.net.ipmemorystore.NetworkAttributesParcelable _arg2 = (android.net.ipmemorystore.NetworkAttributesParcelable) data.readTypedObject(android.net.ipmemorystore.NetworkAttributesParcelable.CREATOR);
        ...
        private static class Proxy implements android.net.ipmemorystore.IOnNetworkAttributesRetrievedListener {
            ...
            public synchronized java.lang.String getInterfaceHash() throws android.os.RemoteException {
                if ("-1".equals(this.mCachedHash)) {
                    ...
                    try {
                        data.writeInterfaceToken(DESCRIPTOR);
                        this.mRemote.transact(android.net.ipmemorystore.IOnNetworkAttributesRetrievedListener.Stub.TRANSACTION_getInterfaceHash, data, reply, 0);
                        reply.readException();
