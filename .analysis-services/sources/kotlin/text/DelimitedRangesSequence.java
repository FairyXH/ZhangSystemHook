...
final class DelimitedRangesSequence implements kotlin.sequences.Sequence<kotlin.ranges.IntRange> {
    ...
    public DelimitedRangesSequence(java.lang.CharSequence input, int startIndex, int limit, kotlin.jvm.functions.Function2<? super java.lang.CharSequence, ? super java.lang.Integer, kotlin.Pair<java.lang.Integer, java.lang.Integer>> getNextMatch) {
    ...
    public static final class AnonymousClass1 implements java.util.Iterator<kotlin.ranges.IntRange>, kotlin.jvm.internal.markers.KMappedMarker {
        ...
        AnonymousClass1() {
            this.currentStartIndex = kotlin.ranges.RangesKt.coerceIn(kotlin.text.DelimitedRangesSequence.this.startIndex, 0, kotlin.text.DelimitedRangesSequence.this.input.length());
        ...
        */
        ...
        public kotlin.ranges.IntRange next() {
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNull(result, "null cannot be cast to non-null type kotlin.ranges.IntRange");
            this.nextItem = null;
            this.nextState = -1;
            return result;
        }
