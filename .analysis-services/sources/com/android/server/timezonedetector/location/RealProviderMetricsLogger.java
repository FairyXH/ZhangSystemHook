...
final class RealProviderMetricsLogger implements com.android.server.timezonedetector.location.LocationTimeZoneProvider.ProviderMetricsLogger {
    ...
    RealProviderMetricsLogger(int providerIndex) {
    ...
    public void onProviderStateChanged(int stateEnum) {
        com.android.internal.util.FrameworkStatsLog.write(com.android.internal.util.FrameworkStatsLog.LOCATION_TIME_ZONE_PROVIDER_STATE_CHANGED, this.mProviderIndex, metricsProviderState(stateEnum));
    }
