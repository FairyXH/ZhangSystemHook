...
final class EnumEntriesList<T extends java.lang.Enum<T>> extends kotlin.collections.AbstractList<T> implements kotlin.enums.EnumEntries<T>, java.io.Serializable {
    ...
    public boolean contains(T element) {
        ...
        java.lang.Enum target = (java.lang.Enum) kotlin.collections.ArraysKt.getOrNull(this.entries, element.ordinal());
    ...
    public int indexOf(T element) {
        ...
        java.lang.Enum target = (java.lang.Enum) kotlin.collections.ArraysKt.getOrNull(this.entries, ordinal);
        if (target == element) {
            return ordinal;
        }
        return -1;
