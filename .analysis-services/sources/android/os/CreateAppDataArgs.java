...
public class CreateAppDataArgs implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.os.CreateAppDataArgs> CREATOR = new android.os.Parcelable.Creator<android.os.CreateAppDataArgs>() { // from class: android.os.CreateAppDataArgs.1
        ...
        public android.os.CreateAppDataArgs createFromParcel(android.os.Parcel _aidl_source) {
            android.os.CreateAppDataArgs _aidl_out = new android.os.CreateAppDataArgs();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.os.CreateAppDataArgs[] newArray(int _aidl_size) {
            return new android.os.CreateAppDataArgs[_aidl_size];
        }
    };
