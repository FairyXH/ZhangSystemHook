...
public final class ThreadLocal<T> implements kotlinx.coroutines.ThreadContextElement<T> {
    ...
    public ThreadLocal(T t, java.lang.ThreadLocal<T> threadLocal) {
        ...
        this.key = new kotlinx.coroutines.internal.ThreadLocalKey(this.threadLocal);
    }
