...
class RangesKt__RangesKt {
    ...
    public static final kotlin.ranges.ClosedFloatingPointRange<java.lang.Double> rangeTo(double $this$rangeTo, double that) {
        return new kotlin.ranges.ClosedDoubleRange($this$rangeTo, that);
    }

    public static final kotlin.ranges.OpenEndRange<java.lang.Double> rangeUntil(double $this$rangeUntil, double that) {
        return new kotlin.ranges.OpenEndDoubleRange($this$rangeUntil, that);
    }

    public static final kotlin.ranges.ClosedFloatingPointRange<java.lang.Float> rangeTo(float $this$rangeTo, float that) {
        return new kotlin.ranges.ClosedFloatRange($this$rangeTo, that);
    }

    public static final kotlin.ranges.OpenEndRange<java.lang.Float> rangeUntil(float $this$rangeUntil, float that) {
        return new kotlin.ranges.OpenEndFloatRange($this$rangeUntil, that);
    }
    ...
    private static final boolean contains(kotlin.ranges.ClosedRange $this$contains, java.lang.Object element) {
    ...
    private static final boolean contains(kotlin.ranges.OpenEndRange $this$contains, java.lang.Object element) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$contains, "<this>");
        return element != null && $this$contains.contains((java.lang.Comparable) element);
    }
