...
public interface IServiceNotification extends android.hidl.base.V1_0.IBase {
    ...
    static android.hidl.manager.V1_0.IServiceNotification asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        android.os.IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof android.hidl.manager.V1_0.IServiceNotification)) {
            return (android.hidl.manager.V1_0.IServiceNotification) iface;
        }
        android.hidl.manager.V1_0.IServiceNotification proxy = new android.hidl.manager.V1_0.IServiceNotification.Proxy(binder);
        try {
    ...
    static android.hidl.manager.V1_0.IServiceNotification castFrom(android.os.IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static android.hidl.manager.V1_0.IServiceNotification getService(java.lang.String serviceName, boolean retry) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static android.hidl.manager.V1_0.IServiceNotification getService(boolean retry) throws android.os.RemoteException {
        return getService("default", retry);
    }

    @java.lang.Deprecated
    static android.hidl.manager.V1_0.IServiceNotification getService(java.lang.String serviceName) throws android.os.RemoteException {
    ...
    public static final class Proxy implements android.hidl.manager.V1_0.IServiceNotification {
        ...
        public void onRegistration(java.lang.String fqName, java.lang.String name, boolean preexisting) throws android.os.RemoteException {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hidl.manager.V1_0.IServiceNotification {
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String descriptor) {
            if (android.hidl.manager.V1_0.IServiceNotification.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
