...
public final class OptionalInt64 {
    ...
    public final boolean equals(java.lang.Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != android.hardware.configstore.V1_0.OptionalInt64.class) {
            return false;
        }
    ...
    public static final java.util.ArrayList<android.hardware.configstore.V1_0.OptionalInt64> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<android.hardware.configstore.V1_0.OptionalInt64> _hidl_vec = new java.util.ArrayList<>();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel parcel, java.util.ArrayList<android.hardware.configstore.V1_0.OptionalInt64> _hidl_vec) {
        android.os.HwBlob _hidl_blob = new android.os.HwBlob(16);
