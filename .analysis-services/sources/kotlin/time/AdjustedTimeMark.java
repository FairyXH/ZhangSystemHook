...
final class AdjustedTimeMark implements kotlin.time.TimeMark {
    ...
    public kotlin.time.TimeMark mo12624minusLRDsOJo(long duration) {
        return kotlin.time.TimeMark.DefaultImpls.m12770minusLRDsOJo(this, duration);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: elapsedNow-UwyO8pc */
    public long mo12623elapsedNowUwyO8pc() {
        return kotlin.time.Duration.m12668minusLRDsOJo(this.mark.mo12623elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public kotlin.time.TimeMark mo12626plusLRDsOJo(long duration) {
        return new kotlin.time.AdjustedTimeMark(this.mark, kotlin.time.Duration.m12669plusLRDsOJo(this.adjustment, duration), null);
    }
}
