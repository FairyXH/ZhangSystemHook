...
public final class HexExtensionsKt {
    ...
    public static final java.lang.String toHexString(byte[] $this$toHexString, com.android.server.permission.jarjar.kotlin.text.HexFormat format) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$toHexString, "<this>");
    ...
    public static /* synthetic */ java.lang.String toHexString$default(byte[] bArr, com.android.server.permission.jarjar.kotlin.text.HexFormat hexFormat, int i, java.lang.Object obj) {
        if ((i & 1) != 0) {
            hexFormat = com.android.server.permission.jarjar.kotlin.text.HexFormat.Companion.getDefault();
        }
        return toHexString(bArr, hexFormat);
    }

    public static /* synthetic */ java.lang.String toHexString$default(byte[] bArr, int i, int i2, com.android.server.permission.jarjar.kotlin.text.HexFormat hexFormat, int i3, java.lang.Object obj) {
        if ((i3 & 1) != 0) {
            i = 0;
        }
        if ((i3 & 2) != 0) {
    ...
    public static final java.lang.String toHexString(byte[] $this$toHexString, int startIndex, int endIndex, com.android.server.permission.jarjar.kotlin.text.HexFormat format) {
        byte[] bArr = $this$toHexString;
        int i = endIndex;
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(bArr, "<this>");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(format, "format");
        com.android.server.permission.jarjar.kotlin.collections.AbstractList.Companion.checkBoundsIndexes$kotlin_stdlib(startIndex, i, bArr.length);
        if (startIndex == i) {
            return "";
        }
        java.lang.String digits = format.getUpperCase() ? UPPER_CASE_HEX_DIGITS : LOWER_CASE_HEX_DIGITS;
        com.android.server.permission.jarjar.kotlin.text.HexFormat.BytesHexFormat bytesFormat = format.getBytes();
    ...
    public static final int formattedStringLength(int totalBytes, int bytesPerLine, int bytesPerGroup, int groupSeparatorLength, int byteSeparatorLength, int bytePrefixLength, int byteSuffixLength) {
        ...
        if (com.android.server.permission.jarjar.kotlin.ranges.RangesKt.intRangeContains((com.android.server.permission.jarjar.kotlin.ranges.ClosedRange<java.lang.Integer>) new com.android.server.permission.jarjar.kotlin.ranges.IntRange(0, Integer.MAX_VALUE), totalLength)) {
            return (int) totalLength;
        }
        throw new java.lang.IllegalArgumentException("The resulting string length is too big: " + ((java.lang.Object) com.android.server.permission.jarjar.kotlin.ULong.m6309toStringimpl(com.android.server.permission.jarjar.kotlin.ULong.m6263constructorimpl(totalLength))));
    }

    public static final byte[] hexToByteArray(java.lang.String $this$hexToByteArray, com.android.server.permission.jarjar.kotlin.text.HexFormat format) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$hexToByteArray, "<this>");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(format, "format");
        return hexToByteArray($this$hexToByteArray, 0, $this$hexToByteArray.length(), format);
    }

    public static /* synthetic */ byte[] hexToByteArray$default(java.lang.String str, com.android.server.permission.jarjar.kotlin.text.HexFormat hexFormat, int i, java.lang.Object obj) {
        if ((i & 1) != 0) {
            hexFormat = com.android.server.permission.jarjar.kotlin.text.HexFormat.Companion.getDefault();
        }
    ...
    static /* synthetic */ byte[] hexToByteArray$default(java.lang.String str, int i, int i2, com.android.server.permission.jarjar.kotlin.text.HexFormat hexFormat, int i3, java.lang.Object obj) {
        if ((i3 & 1) != 0) {
            i = 0;
        }
        if ((i3 & 2) != 0) {
    ...
    private static final byte[] hexToByteArray(java.lang.String $this$hexToByteArray, int startIndex, int endIndex, com.android.server.permission.jarjar.kotlin.text.HexFormat format) {
        com.android.server.permission.jarjar.kotlin.collections.AbstractList.Companion.checkBoundsIndexes$kotlin_stdlib(startIndex, endIndex, $this$hexToByteArray.length());
        ...
        while (i < endIndex) {
            ...
            com.android.server.permission.jarjar.kotlin.text.HexFormat.BytesHexFormat bytesFormat2 = bytesFormat;
            checkHexLength($this$hexToByteArray, i2, com.android.server.permission.jarjar.kotlin.ranges.RangesKt.coerceAtMost(i2 + 2, endIndex), 2, true);
            int i3 = i2 + 1;
    ...
    public static /* synthetic */ java.lang.String toHexString$default(byte b, com.android.server.permission.jarjar.kotlin.text.HexFormat hexFormat, int i, java.lang.Object obj) {
        if ((i & 1) != 0) {
            hexFormat = com.android.server.permission.jarjar.kotlin.text.HexFormat.Companion.getDefault();
        }
    ...
    public static final byte hexToByte(java.lang.String $this$hexToByte, com.android.server.permission.jarjar.kotlin.text.HexFormat format) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$hexToByte, "<this>");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(format, "format");
        return hexToByte($this$hexToByte, 0, $this$hexToByte.length(), format);
    }

    public static /* synthetic */ byte hexToByte$default(java.lang.String str, com.android.server.permission.jarjar.kotlin.text.HexFormat hexFormat, int i, java.lang.Object obj) {
        if ((i & 1) != 0) {
            hexFormat = com.android.server.permission.jarjar.kotlin.text.HexFormat.Companion.getDefault();
        }
    ...
    static /* synthetic */ byte hexToByte$default(java.lang.String str, int i, int i2, com.android.server.permission.jarjar.kotlin.text.HexFormat hexFormat, int i3, java.lang.Object obj) {
        if ((i3 & 1) != 0) {
            i = 0;
        }
        if ((i3 & 2) != 0) {
    ...
    private static final byte hexToByte(java.lang.String $this$hexToByte, int startIndex, int endIndex, com.android.server.permission.jarjar.kotlin.text.HexFormat format) {
        return (byte) hexToLongImpl($this$hexToByte, startIndex, endIndex, format, 2);
    }

    public static final java.lang.String toHexString(short $this$toHexString, com.android.server.permission.jarjar.kotlin.text.HexFormat format) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(format, "format");
        return toHexStringImpl($this$toHexString, format, 16);
    }

    public static /* synthetic */ java.lang.String toHexString$default(short s, com.android.server.permission.jarjar.kotlin.text.HexFormat hexFormat, int i, java.lang.Object obj) {
        if ((i & 1) != 0) {
            hexFormat = com.android.server.permission.jarjar.kotlin.text.HexFormat.Companion.getDefault();
        }
    ...
    public static final short hexToShort(java.lang.String $this$hexToShort, com.android.server.permission.jarjar.kotlin.text.HexFormat format) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$hexToShort, "<this>");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(format, "format");
        return hexToShort($this$hexToShort, 0, $this$hexToShort.length(), format);
    }

    public static /* synthetic */ short hexToShort$default(java.lang.String str, com.android.server.permission.jarjar.kotlin.text.HexFormat hexFormat, int i, java.lang.Object obj) {
        if ((i & 1) != 0) {
            hexFormat = com.android.server.permission.jarjar.kotlin.text.HexFormat.Companion.getDefault();
        }
    ...
    static /* synthetic */ short hexToShort$default(java.lang.String str, int i, int i2, com.android.server.permission.jarjar.kotlin.text.HexFormat hexFormat, int i3, java.lang.Object obj) {
        if ((i3 & 1) != 0) {
            i = 0;
        }
        if ((i3 & 2) != 0) {
    ...
    private static final short hexToShort(java.lang.String $this$hexToShort, int startIndex, int endIndex, com.android.server.permission.jarjar.kotlin.text.HexFormat format) {
        return (short) hexToLongImpl($this$hexToShort, startIndex, endIndex, format, 4);
    }

    public static final java.lang.String toHexString(int $this$toHexString, com.android.server.permission.jarjar.kotlin.text.HexFormat format) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(format, "format");
        return toHexStringImpl($this$toHexString, format, 32);
    }

    public static /* synthetic */ java.lang.String toHexString$default(int i, com.android.server.permission.jarjar.kotlin.text.HexFormat hexFormat, int i2, java.lang.Object obj) {
        if ((i2 & 1) != 0) {
            hexFormat = com.android.server.permission.jarjar.kotlin.text.HexFormat.Companion.getDefault();
        }
    ...
    public static final int hexToInt(java.lang.String $this$hexToInt, com.android.server.permission.jarjar.kotlin.text.HexFormat format) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$hexToInt, "<this>");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(format, "format");
        return hexToInt($this$hexToInt, 0, $this$hexToInt.length(), format);
    }

    public static /* synthetic */ int hexToInt$default(java.lang.String str, com.android.server.permission.jarjar.kotlin.text.HexFormat hexFormat, int i, java.lang.Object obj) {
        if ((i & 1) != 0) {
            hexFormat = com.android.server.permission.jarjar.kotlin.text.HexFormat.Companion.getDefault();
        }
    ...
    static /* synthetic */ int hexToInt$default(java.lang.String str, int i, int i2, com.android.server.permission.jarjar.kotlin.text.HexFormat hexFormat, int i3, java.lang.Object obj) {
        if ((i3 & 1) != 0) {
            i = 0;
        }
        if ((i3 & 2) != 0) {
    ...
    private static final int hexToInt(java.lang.String $this$hexToInt, int startIndex, int endIndex, com.android.server.permission.jarjar.kotlin.text.HexFormat format) {
        return (int) hexToLongImpl($this$hexToInt, startIndex, endIndex, format, 8);
    }

    public static final java.lang.String toHexString(long $this$toHexString, com.android.server.permission.jarjar.kotlin.text.HexFormat format) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(format, "format");
        return toHexStringImpl($this$toHexString, format, 64);
    }

    public static /* synthetic */ java.lang.String toHexString$default(long j, com.android.server.permission.jarjar.kotlin.text.HexFormat hexFormat, int i, java.lang.Object obj) {
        if ((i & 1) != 0) {
            hexFormat = com.android.server.permission.jarjar.kotlin.text.HexFormat.Companion.getDefault();
        }
    ...
    public static final long hexToLong(java.lang.String $this$hexToLong, com.android.server.permission.jarjar.kotlin.text.HexFormat format) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$hexToLong, "<this>");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(format, "format");
        return hexToLong($this$hexToLong, 0, $this$hexToLong.length(), format);
    }

    public static /* synthetic */ long hexToLong$default(java.lang.String str, com.android.server.permission.jarjar.kotlin.text.HexFormat hexFormat, int i, java.lang.Object obj) {
        if ((i & 1) != 0) {
            hexFormat = com.android.server.permission.jarjar.kotlin.text.HexFormat.Companion.getDefault();
        }
    ...
    static /* synthetic */ long hexToLong$default(java.lang.String str, int i, int i2, com.android.server.permission.jarjar.kotlin.text.HexFormat hexFormat, int i3, java.lang.Object obj) {
        if ((i3 & 1) != 0) {
            i = 0;
        }
        if ((i3 & 2) != 0) {
    ...
    private static final long hexToLong(java.lang.String $this$hexToLong, int startIndex, int endIndex, com.android.server.permission.jarjar.kotlin.text.HexFormat format) {
        return hexToLongImpl($this$hexToLong, startIndex, endIndex, format, 16);
    }

    private static final java.lang.String toHexStringImpl(long $this$toHexStringImpl, com.android.server.permission.jarjar.kotlin.text.HexFormat format, int bits) {
        if (!((bits & 3) == 0)) {
            throw new java.lang.IllegalArgumentException("Failed requirement.".toString());
        }
        java.lang.String digits = format.getUpperCase() ? UPPER_CASE_HEX_DIGITS : LOWER_CASE_HEX_DIGITS;
    ...
    static /* synthetic */ long hexToLongImpl$default(java.lang.String str, int i, int i2, com.android.server.permission.jarjar.kotlin.text.HexFormat hexFormat, int i3, int i4, java.lang.Object obj) {
        if ((i4 & 1) != 0) {
            i = 0;
        }
        if ((i4 & 2) != 0) {
    ...
    private static final long hexToLongImpl(java.lang.String $this$hexToLongImpl, int startIndex, int endIndex, com.android.server.permission.jarjar.kotlin.text.HexFormat format, int maxDigits) {
        com.android.server.permission.jarjar.kotlin.collections.AbstractList.Companion.checkBoundsIndexes$kotlin_stdlib(startIndex, endIndex, $this$hexToLongImpl.length());
        java.lang.String prefix = format.getNumber().getPrefix();
        java.lang.String suffix = format.getNumber().getSuffix();
        if (prefix.length() + suffix.length() >= endIndex - startIndex) {
            ...
            com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNull($this$hexToLongImpl, "null cannot be cast to non-null type java.lang.String");
    ...
    private static final int checkContainsAt(java.lang.String $this$checkContainsAt, java.lang.String part, int index, int endIndex, java.lang.String partName) {
        ...
        if (end > endIndex || !com.android.server.permission.jarjar.kotlin.text.StringsKt.regionMatches($this$checkContainsAt, index, part, 0, part.length(), true)) {
            ...
            int iCoerceAtMost = com.android.server.permission.jarjar.kotlin.ranges.RangesKt.coerceAtMost(end, endIndex);
            com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNull($this$checkContainsAt, "null cannot be cast to non-null type java.lang.String");
    ...
    private static final void checkHexLength(java.lang.String $this$checkHexLength, int startIndex, int endIndex, int maxDigits, boolean requireMaxLength) {
        ...
        if (!isCorrectLength) {
            ...
            com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNull($this$checkHexLength, "null cannot be cast to non-null type java.lang.String");
            java.lang.String substring = $this$checkHexLength.substring(startIndex, endIndex);
            com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(substring, "substring(...)");
