...
public final class Charsets {
    public static final com.android.server.permission.jarjar.kotlin.text.Charsets INSTANCE = new com.android.server.permission.jarjar.kotlin.text.Charsets();
    ...
    static {
        ...
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(charsetForName, "forName(...)");
        UTF_8 = charsetForName;
        java.nio.charset.Charset charsetForName2 = java.nio.charset.Charset.forName("UTF-16");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(charsetForName2, "forName(...)");
        UTF_16 = charsetForName2;
        java.nio.charset.Charset charsetForName3 = java.nio.charset.Charset.forName("UTF-16BE");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(charsetForName3, "forName(...)");
        UTF_16BE = charsetForName3;
        java.nio.charset.Charset charsetForName4 = java.nio.charset.Charset.forName("UTF-16LE");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(charsetForName4, "forName(...)");
        UTF_16LE = charsetForName4;
        java.nio.charset.Charset charsetForName5 = java.nio.charset.Charset.forName("US-ASCII");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(charsetForName5, "forName(...)");
        US_ASCII = charsetForName5;
        java.nio.charset.Charset charsetForName6 = java.nio.charset.Charset.forName("ISO-8859-1");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(charsetForName6, "forName(...)");
    ...
    public final java.nio.charset.Charset UTF32() {
        ...
        if (charset == null) {
            ...
            com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(charset2, "forName(...)");
            utf_32 = charset2;
            return charset2;
        }
        return charset;
