...
public final class SetBuilder<E> extends com.android.server.permission.jarjar.kotlin.collections.AbstractMutableSet<E> implements java.util.Set<E>, java.io.Serializable, com.android.server.permission.jarjar.kotlin.jvm.internal.markers.KMutableSet {
    private static final com.android.server.permission.jarjar.kotlin.collections.builders.SetBuilder.Companion Companion = new com.android.server.permission.jarjar.kotlin.collections.builders.SetBuilder.Companion(null);
    private static final com.android.server.permission.jarjar.kotlin.collections.builders.SetBuilder Empty = new com.android.server.permission.jarjar.kotlin.collections.builders.SetBuilder(com.android.server.permission.jarjar.kotlin.collections.builders.MapBuilder.Companion.getEmpty$kotlin_stdlib());
    ...
    public SetBuilder(com.android.server.permission.jarjar.kotlin.collections.builders.MapBuilder<E, ?> mapBuilder) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(mapBuilder, "backing");
        this.backing = mapBuilder;
    }

    public SetBuilder() {
        this(new com.android.server.permission.jarjar.kotlin.collections.builders.MapBuilder());
    }

    public SetBuilder(int initialCapacity) {
        this(new com.android.server.permission.jarjar.kotlin.collections.builders.MapBuilder(initialCapacity));
    }
    ...
    private final java.lang.Object writeReplace() throws java.io.NotSerializableException {
        if (this.backing.isReadOnly$kotlin_stdlib()) {
            return new com.android.server.permission.jarjar.kotlin.collections.builders.SerializedCollection(this, 1);
        }
