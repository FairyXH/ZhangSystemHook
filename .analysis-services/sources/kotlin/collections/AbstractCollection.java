...
public abstract class AbstractCollection<E> implements java.util.Collection<E>, kotlin.jvm.internal.markers.KMappedMarker {
    ...
    public boolean contains(E element) {
        kotlin.collections.AbstractCollection<E> $this$any$iv = this;
        if (($this$any$iv instanceof java.util.Collection) && $this$any$iv.isEmpty()) {
            return false;
        }
        for (java.lang.Object element$iv : $this$any$iv) {
            if (kotlin.jvm.internal.Intrinsics.areEqual(element$iv, element)) {
                return true;
            }
        }
        return false;
    ...
    public boolean containsAll(java.util.Collection<? extends java.lang.Object> elements) {
        ...
        java.util.Collection<? extends java.lang.Object> $this$all$iv = elements;
