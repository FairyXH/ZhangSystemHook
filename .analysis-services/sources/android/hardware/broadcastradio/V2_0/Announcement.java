...
public final class Announcement {
    ...
    public final boolean equals(java.lang.Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != android.hardware.broadcastradio.V2_0.Announcement.class) {
            return false;
        }
        android.hardware.broadcastradio.V2_0.Announcement other = (android.hardware.broadcastradio.V2_0.Announcement) otherObject;
        if (android.os.HidlSupport.deepEquals(this.selector, other.selector) && this.type == other.type && android.os.HidlSupport.deepEquals(this.vendorInfo, other.vendorInfo)) {
            return true;
        }
        return false;
    }
    ...
    public static final java.util.ArrayList<android.hardware.broadcastradio.V2_0.Announcement> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<android.hardware.broadcastradio.V2_0.Announcement> _hidl_vec = new java.util.ArrayList<>();
    ...
    public final void readEmbeddedFromParcel(android.os.HwParcel parcel, android.os.HwBlob _hidl_blob, long _hidl_offset) {
        ...
        android.os.HwBlob childBlob = parcel.readEmbeddedBuffer(_hidl_vec_size * 32, _hidl_blob.handle(), _hidl_offset + 40 + 0, true);
    ...
    public static final void writeVectorToParcel(android.os.HwParcel parcel, java.util.ArrayList<android.hardware.broadcastradio.V2_0.Announcement> _hidl_vec) {
