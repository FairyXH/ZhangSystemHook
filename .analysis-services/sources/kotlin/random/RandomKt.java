...
public final class RandomKt {
    public static final kotlin.random.Random Random(int seed) {
        return new kotlin.random.XorWowRandom(seed, seed >> 31);
    }

    public static final kotlin.random.Random Random(long seed) {
        return new kotlin.random.XorWowRandom((int) seed, (int) (seed >> 32));
    }

    public static final int nextInt(kotlin.random.Random $this$nextInt, kotlin.ranges.IntRange range) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$nextInt, "<this>");
    ...
    public static final long nextLong(kotlin.random.Random $this$nextLong, kotlin.ranges.LongRange range) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$nextLong, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(range, "range");
        if (range.isEmpty()) {
            throw new java.lang.IllegalArgumentException("Cannot get random in empty range: " + range);
        }
