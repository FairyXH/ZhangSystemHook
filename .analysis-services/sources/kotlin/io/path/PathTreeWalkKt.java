...
public final class PathTreeWalkKt {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean createsCycle(kotlin.io.path.PathNode $this$createsCycle) {
        for (kotlin.io.path.PathNode ancestor = $this$createsCycle.getParent(); ancestor != null; ancestor = ancestor.getParent()) {
            if (ancestor.getKey() != null && $this$createsCycle.getKey() != null) {
                if (kotlin.jvm.internal.Intrinsics.areEqual(ancestor.getKey(), $this$createsCycle.getKey())) {
                    return true;
                }
            } else {
                try {
