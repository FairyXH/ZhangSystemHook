...
public class TetherOffloadRuleParcel implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.net.TetherOffloadRuleParcel> CREATOR = new android.os.Parcelable.Creator<android.net.TetherOffloadRuleParcel>() { // from class: android.net.TetherOffloadRuleParcel.1
        ...
        public android.net.TetherOffloadRuleParcel createFromParcel(android.os.Parcel _aidl_source) {
            android.net.TetherOffloadRuleParcel _aidl_out = new android.net.TetherOffloadRuleParcel();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.net.TetherOffloadRuleParcel[] newArray(int _aidl_size) {
            return new android.net.TetherOffloadRuleParcel[_aidl_size];
        }
    };
