...
class ArraysKt__ArraysJVMKt {
    ...
    public static final <T> T[] arrayOfNulls(T[] tArr, int i) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(tArr, "reference");
        java.lang.Object objNewInstance = java.lang.reflect.Array.newInstance(tArr.getClass().getComponentType(), i);
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNull(objNewInstance, "null cannot be cast to non-null type kotlin.Array<T of kotlin.collections.ArraysKt__ArraysJVMKt.arrayOfNulls>");
