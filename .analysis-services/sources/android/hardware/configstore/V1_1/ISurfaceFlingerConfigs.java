...
public interface ISurfaceFlingerConfigs extends android.hardware.configstore.V1_0.ISurfaceFlingerConfigs {
    ...
    static android.hardware.configstore.V1_1.ISurfaceFlingerConfigs asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        android.os.IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof android.hardware.configstore.V1_1.ISurfaceFlingerConfigs)) {
            return (android.hardware.configstore.V1_1.ISurfaceFlingerConfigs) iface;
        }
        android.hardware.configstore.V1_1.ISurfaceFlingerConfigs proxy = new android.hardware.configstore.V1_1.ISurfaceFlingerConfigs.Proxy(binder);
        try {
    ...
    static android.hardware.configstore.V1_1.ISurfaceFlingerConfigs castFrom(android.os.IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static android.hardware.configstore.V1_1.ISurfaceFlingerConfigs getService(java.lang.String serviceName, boolean retry) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static android.hardware.configstore.V1_1.ISurfaceFlingerConfigs getService(boolean retry) throws android.os.RemoteException {
        return getService("default", retry);
    }

    @java.lang.Deprecated
    static android.hardware.configstore.V1_1.ISurfaceFlingerConfigs getService(java.lang.String serviceName) throws android.os.RemoteException {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.configstore.V1_1.ISurfaceFlingerConfigs {
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String descriptor) {
            if (android.hardware.configstore.V1_1.ISurfaceFlingerConfigs.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, android.os.HwParcel _hidl_reply, int _hidl_flags) throws android.os.RemoteException {
            switch (_hidl_code) {
                ...
                case 2:
                    _hidl_request.enforceInterface(android.hardware.configstore.V1_0.ISurfaceFlingerConfigs.kInterfaceName);
                    android.hardware.configstore.V1_0.OptionalInt64 _hidl_out_value2 = vsyncSfEventPhaseOffsetNs();
                    _hidl_reply.writeStatus(0);
                ...
                case 3:
                    _hidl_request.enforceInterface(android.hardware.configstore.V1_0.ISurfaceFlingerConfigs.kInterfaceName);
                    android.hardware.configstore.V1_0.OptionalBool _hidl_out_value3 = useContextPriority();
                    _hidl_reply.writeStatus(0);
                ...
                case 4:
                    _hidl_request.enforceInterface(android.hardware.configstore.V1_0.ISurfaceFlingerConfigs.kInterfaceName);
                    android.hardware.configstore.V1_0.OptionalBool _hidl_out_value4 = hasWideColorDisplay();
                    _hidl_reply.writeStatus(0);
                ...
                case 5:
                    _hidl_request.enforceInterface(android.hardware.configstore.V1_0.ISurfaceFlingerConfigs.kInterfaceName);
                    android.hardware.configstore.V1_0.OptionalBool _hidl_out_value5 = hasHDRDisplay();
                    _hidl_reply.writeStatus(0);
                ...
                case 6:
                    _hidl_request.enforceInterface(android.hardware.configstore.V1_0.ISurfaceFlingerConfigs.kInterfaceName);
                    android.hardware.configstore.V1_0.OptionalInt64 _hidl_out_value6 = presentTimeOffsetFromVSyncNs();
                    _hidl_reply.writeStatus(0);
                ...
                case 7:
                    _hidl_request.enforceInterface(android.hardware.configstore.V1_0.ISurfaceFlingerConfigs.kInterfaceName);
                    android.hardware.configstore.V1_0.OptionalBool _hidl_out_value7 = useHwcForRGBtoYUV();
                    _hidl_reply.writeStatus(0);
                ...
                case 8:
                    _hidl_request.enforceInterface(android.hardware.configstore.V1_0.ISurfaceFlingerConfigs.kInterfaceName);
                    android.hardware.configstore.V1_0.OptionalUInt64 _hidl_out_value8 = maxVirtualDisplaySize();
                    _hidl_reply.writeStatus(0);
                ...
                case 9:
                    _hidl_request.enforceInterface(android.hardware.configstore.V1_0.ISurfaceFlingerConfigs.kInterfaceName);
                    android.hardware.configstore.V1_0.OptionalBool _hidl_out_value9 = hasSyncFramework();
                    _hidl_reply.writeStatus(0);
                ...
                case 10:
                    _hidl_request.enforceInterface(android.hardware.configstore.V1_0.ISurfaceFlingerConfigs.kInterfaceName);
                    android.hardware.configstore.V1_0.OptionalBool _hidl_out_value10 = useVrFlinger();
                    _hidl_reply.writeStatus(0);
                ...
                case 11:
                    _hidl_request.enforceInterface(android.hardware.configstore.V1_0.ISurfaceFlingerConfigs.kInterfaceName);
                    android.hardware.configstore.V1_0.OptionalInt64 _hidl_out_value11 = maxFrameBufferAcquiredBuffers();
                    _hidl_reply.writeStatus(0);
                ...
                case 12:
                    _hidl_request.enforceInterface(android.hardware.configstore.V1_0.ISurfaceFlingerConfigs.kInterfaceName);
                    android.hardware.configstore.V1_0.OptionalBool _hidl_out_value12 = startGraphicsAllocatorService();
                    _hidl_reply.writeStatus(0);
                ...
                case 13:
                    ...
                    android.hardware.configstore.V1_1.OptionalDisplayOrientation _hidl_out_value13 = primaryDisplayOrientation();
                    _hidl_reply.writeStatus(0);
