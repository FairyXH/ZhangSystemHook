...
public interface IBiometricsFace extends android.hidl.base.V1_0.IBase {
    ...
    static android.hardware.biometrics.face.V1_0.IBiometricsFace asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        android.os.IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof android.hardware.biometrics.face.V1_0.IBiometricsFace)) {
            return (android.hardware.biometrics.face.V1_0.IBiometricsFace) iface;
        }
        android.hardware.biometrics.face.V1_0.IBiometricsFace proxy = new android.hardware.biometrics.face.V1_0.IBiometricsFace.Proxy(binder);
        try {
    ...
    static android.hardware.biometrics.face.V1_0.IBiometricsFace castFrom(android.os.IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static android.hardware.biometrics.face.V1_0.IBiometricsFace getService(java.lang.String serviceName, boolean retry) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static android.hardware.biometrics.face.V1_0.IBiometricsFace getService(boolean retry) throws android.os.RemoteException {
        return getService("default", retry);
    }

    @java.lang.Deprecated
    static android.hardware.biometrics.face.V1_0.IBiometricsFace getService(java.lang.String serviceName) throws android.os.RemoteException {
    ...
    public static final class Proxy implements android.hardware.biometrics.face.V1_0.IBiometricsFace {
        ...
        public android.hardware.biometrics.face.V1_0.OptionalUint64 setCallback(android.hardware.biometrics.face.V1_0.IBiometricsFaceClientCallback clientCallback) throws android.os.RemoteException {
        ...
        @Override // android.hardware.biometrics.face.V1_0.IBiometricsFace
        public int setActiveUser(int userId, java.lang.String storePath) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.biometrics.face.V1_0.IBiometricsFace.kInterfaceName);
        ...
        @Override // android.hardware.biometrics.face.V1_0.IBiometricsFace
        public android.hardware.biometrics.face.V1_0.OptionalUint64 generateChallenge(int challengeTimeoutSec) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.biometrics.face.V1_0.IBiometricsFace.kInterfaceName);
        ...
        @Override // android.hardware.biometrics.face.V1_0.IBiometricsFace
        public int enroll(java.util.ArrayList<java.lang.Byte> hat, int timeoutSec, java.util.ArrayList<java.lang.Integer> disabledFeatures) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.biometrics.face.V1_0.IBiometricsFace.kInterfaceName);
        ...
        @Override // android.hardware.biometrics.face.V1_0.IBiometricsFace
        public int setFeature(int feature, boolean enabled, java.util.ArrayList<java.lang.Byte> hat, int faceId) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.biometrics.face.V1_0.IBiometricsFace.kInterfaceName);
        ...
        @Override // android.hardware.biometrics.face.V1_0.IBiometricsFace
        public android.hardware.biometrics.face.V1_0.OptionalBool getFeature(int feature, int faceId) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.biometrics.face.V1_0.IBiometricsFace.kInterfaceName);
            _hidl_request.writeInt32(feature);
            _hidl_request.writeInt32(faceId);
        ...
        @Override // android.hardware.biometrics.face.V1_0.IBiometricsFace
        public int authenticate(long operationId) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.biometrics.face.V1_0.IBiometricsFace.kInterfaceName);
        ...
        @Override // android.hardware.biometrics.face.V1_0.IBiometricsFace
        public int resetLockout(java.util.ArrayList<java.lang.Byte> hat) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.biometrics.face.V1_0.IBiometricsFace.kInterfaceName);
            _hidl_request.writeInt8Vector(hat);
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.biometrics.face.V1_0.IBiometricsFace {
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String descriptor) {
            if (android.hardware.biometrics.face.V1_0.IBiometricsFace.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, android.os.HwParcel _hidl_reply, int _hidl_flags) throws android.os.RemoteException {
            switch (_hidl_code) {
                ...
                case 3:
                    ...
                    android.hardware.biometrics.face.V1_0.OptionalUint64 _hidl_out_result2 = generateChallenge(challengeTimeoutSec);
                    _hidl_reply.writeStatus(0);
                ...
                case 4:
                    _hidl_request.enforceInterface(android.hardware.biometrics.face.V1_0.IBiometricsFace.kInterfaceName);
                    java.util.ArrayList<java.lang.Byte> hat = _hidl_request.readInt8Vector();
                    int timeoutSec = _hidl_request.readInt32();
                    java.util.ArrayList<java.lang.Integer> disabledFeatures = _hidl_request.readInt32Vector();
                ...
                case 6:
                    ...
                    java.util.ArrayList<java.lang.Byte> hat2 = _hidl_request.readInt8Vector();
                ...
                case 7:
                    ...
                    android.hardware.biometrics.face.V1_0.OptionalBool _hidl_out_result3 = getFeature(feature2, faceId2);
                    _hidl_reply.writeStatus(0);
                ...
                case 8:
                    _hidl_request.enforceInterface(android.hardware.biometrics.face.V1_0.IBiometricsFace.kInterfaceName);
                    android.hardware.biometrics.face.V1_0.OptionalUint64 _hidl_out_result4 = getAuthenticatorId();
                    _hidl_reply.writeStatus(0);
                ...
                case 14:
                    _hidl_request.enforceInterface(android.hardware.biometrics.face.V1_0.IBiometricsFace.kInterfaceName);
                    java.util.ArrayList<java.lang.Byte> hat3 = _hidl_request.readInt8Vector();
