...
public class AppGrammaticalGenderBackupHelper extends android.app.backup.BlobBackupHelper {
    ...
    protected byte[] getBackupPayload(java.lang.String key) {
        if (!KEY_APP_GENDER.equals(key) || this.mGrammarInflectionManagerInternal == null) {
            return null;
        }
    ...
    protected void applyRestoredPayload(java.lang.String key, byte[] payload) {
        if (KEY_APP_GENDER.equals(key) && this.mGrammarInflectionManagerInternal != null) {
            this.mGrammarInflectionManagerInternal.stageAndApplyRestoredPayload(payload, this.mUserId);
        }
    }
}
