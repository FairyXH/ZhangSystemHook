...
public final class PathTreeWalk implements kotlin.sequences.Sequence<java.nio.file.Path> {
    ...
    private final java.lang.Object yieldIfNeeded(kotlin.sequences.SequenceScope<? super java.nio.file.Path> sequenceScope, kotlin.io.path.PathNode node, kotlin.io.path.DirectoryEntriesReader entriesReader, kotlin.jvm.functions.Function1<? super java.util.List<kotlin.io.path.PathNode>, kotlin.Unit> function1, kotlin.coroutines.Continuation<? super kotlin.Unit> continuation) throws java.nio.file.FileSystemLoopException {
        ...
        if (java.nio.file.Files.isDirectory(path, (java.nio.file.LinkOption[]) java.util.Arrays.copyOf(linkOptionArr, linkOptionArr.length))) {
            if (!kotlin.io.path.PathTreeWalkKt.createsCycle(node)) {
    ...
    static final class C00821 extends kotlin.coroutines.jvm.internal.RestrictedSuspendLambda implements kotlin.jvm.functions.Function2<kotlin.sequences.SequenceScope<? super java.nio.file.Path>, kotlin.coroutines.Continuation<? super kotlin.Unit>, java.lang.Object> {
        ...
        C00821(kotlin.coroutines.Continuation<? super kotlin.io.path.PathTreeWalk.C00821> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final kotlin.coroutines.Continuation<kotlin.Unit> create(java.lang.Object obj, kotlin.coroutines.Continuation<?> continuation) {
            kotlin.io.path.PathTreeWalk.C00821 c00821 = kotlin.io.path.PathTreeWalk.this.new C00821(continuation);
            c00821.L$0 = obj;
            return c00821;
        }
        ...
        public final java.lang.Object invoke(kotlin.sequences.SequenceScope<? super java.nio.file.Path> sequenceScope, kotlin.coroutines.Continuation<? super kotlin.Unit> continuation) {
            return ((kotlin.io.path.PathTreeWalk.C00821) create(sequenceScope, continuation)).invokeSuspend(kotlin.Unit.INSTANCE);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r18) throws java.lang.Throwable {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlin.io.path.PathTreeWalk.C00821.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }

    private final java.util.Iterator<java.nio.file.Path> dfsIterator() {
        return kotlin.sequences.SequencesKt.iterator(new kotlin.io.path.PathTreeWalk.C00821(null));
    }
