...
public final class WeaverConfig {
    ...
    public final boolean equals(java.lang.Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != android.hardware.weaver.V1_0.WeaverConfig.class) {
            return false;
        }
    ...
    public static final java.util.ArrayList<android.hardware.weaver.V1_0.WeaverConfig> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<android.hardware.weaver.V1_0.WeaverConfig> _hidl_vec = new java.util.ArrayList<>();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel parcel, java.util.ArrayList<android.hardware.weaver.V1_0.WeaverConfig> _hidl_vec) {
