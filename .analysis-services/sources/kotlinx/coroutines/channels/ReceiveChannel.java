...
public interface ReceiveChannel<E> {
    ...
    java.lang.Object mo12813receiveCatchingJP2dKIU(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> continuation);
    ...
    java.lang.Object mo12814tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(kotlinx.coroutines.channels.ReceiveChannel<? extends E> receiveChannel) throws java.lang.Throwable {
            java.lang.Object objMo12814tryReceivePtdJZtk = receiveChannel.mo12814tryReceivePtdJZtk();
            if (kotlinx.coroutines.channels.ChannelResult.m12829isSuccessimpl(objMo12814tryReceivePtdJZtk)) {
                return (E) kotlinx.coroutines.channels.ChannelResult.m12825getOrThrowimpl(objMo12814tryReceivePtdJZtk);
            }
            java.lang.Throwable thM12823exceptionOrNullimpl = kotlinx.coroutines.channels.ChannelResult.m12823exceptionOrNullimpl(objMo12814tryReceivePtdJZtk);
            if (thM12823exceptionOrNullimpl == null) {
                return null;
            }
            throw kotlinx.coroutines.internal.StackTraceRecoveryKt.recoverStackTrace(thM12823exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r3, kotlin.coroutines.Continuation<? super E> r4) throws java.lang.Throwable {
            ...
            L38:
                ...
                return r1
            L45:
                java.lang.Object r3 = kotlinx.coroutines.channels.ChannelResult.m12824getOrNullimpl(r3)
                return r3
            */
