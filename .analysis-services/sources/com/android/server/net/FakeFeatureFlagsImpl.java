...
public class FakeFeatureFlagsImpl extends com.android.server.net.CustomFeatureFlags {
    private final com.android.server.net.FeatureFlags mDefaults;
    ...
    public FakeFeatureFlagsImpl(com.android.server.net.FeatureFlags defaults) {
        super(null);
    ...
    @Override // com.android.server.net.CustomFeatureFlags
