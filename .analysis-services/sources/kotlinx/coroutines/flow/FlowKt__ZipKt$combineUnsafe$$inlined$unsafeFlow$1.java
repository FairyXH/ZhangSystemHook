...
public final class FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1<R> implements kotlinx.coroutines.flow.Flow<R> {
    ...
    public java.lang.Object collect$$forInline(kotlinx.coroutines.flow.FlowCollector collector, kotlin.coroutines.Continuation $completion) {
        ...
        new kotlin.coroutines.jvm.internal.ContinuationImpl($completion) { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1.1
            int label;
        ...
        kotlinx.coroutines.flow.internal.CombineKt.combineInternal(collector, flowArr, function0NullArrayFactory$FlowKt__ZipKt, flowKt__ZipKt$combineUnsafe$1$1, $completion);
