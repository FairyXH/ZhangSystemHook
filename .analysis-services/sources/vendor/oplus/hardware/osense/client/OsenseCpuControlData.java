...
public class OsenseCpuControlData implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<vendor.oplus.hardware.osense.client.OsenseCpuControlData> CREATOR = new android.os.Parcelable.Creator<vendor.oplus.hardware.osense.client.OsenseCpuControlData>() { // from class: vendor.oplus.hardware.osense.client.OsenseCpuControlData.1
        @Override // android.os.Parcelable.Creator
        public vendor.oplus.hardware.osense.client.OsenseCpuControlData createFromParcel(android.os.Parcel _aidl_source) {
            vendor.oplus.hardware.osense.client.OsenseCpuControlData _aidl_out = new vendor.oplus.hardware.osense.client.OsenseCpuControlData();
            _aidl_out.readFromParcel(_aidl_source);
            return _aidl_out;
        }

        @Override // android.os.Parcelable.Creator
        public vendor.oplus.hardware.osense.client.OsenseCpuControlData[] newArray(int _aidl_size) {
            return new vendor.oplus.hardware.osense.client.OsenseCpuControlData[_aidl_size];
        }
    };
