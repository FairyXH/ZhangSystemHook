...
@com.android.server.permission.jarjar.kotlin.Metadata(d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\b\n\u0002\u0010\u0005\n\u0002\u0010\n\n\u0002\b\b\u001a\r\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u0087\b\u001a\r\u0010\u0000\u001a\u00020\u0001*\u00020\u0003H\u0087\b\u001a\r\u0010\u0004\u001a\u00020\u0001*\u00020\u0002H\u0087\b\u001a\r\u0010\u0004\u001a\u00020\u0001*\u00020\u0003H\u0087\b\u001a\r\u0010\u0005\u001a\u00020\u0001*\u00020\u0002H\u0087\b\u001a\r\u0010\u0005\u001a\u00020\u0001*\u00020\u0003H\u0087\b\u001a\u0014\u0010\u0006\u001a\u00020\u0002*\u00020\u00022\u0006\u0010\u0007\u001a\u00020\u0001H\u0007\u001a\u0014\u0010\u0006\u001a\u00020\u0003*\u00020\u00032\u0006\u0010\u0007\u001a\u00020\u0001H\u0007\u001a\u0014\u0010\b\u001a\u00020\u0002*\u00020\u00022\u0006\u0010\u0007\u001a\u00020\u0001H\u0007\u001a\u0014\u0010\b\u001a\u00020\u0003*\u00020\u00032\u0006\u0010\u0007\u001a\u00020\u0001H\u0007\u001a\r\u0010\t\u001a\u00020\u0002*\u00020\u0002H\u0087\b\u001a\r\u0010\t\u001a\u00020\u0003*\u00020\u0003H\u0087\b\u001a\r\u0010\n\u001a\u00020\u0002*\u00020\u0002H\u0087\b\u001a\r\u0010\n\u001a\u00020\u0003*\u00020\u0003H\u0087\b¨\u0006\u000b"}, d2 = {"countLeadingZeroBits", "", "", "", "countOneBits", "countTrailingZeroBits", "rotateLeft", "bitCount", "rotateRight", "takeHighestOneBit", "takeLowestOneBit", "kotlin-stdlib"}, k = 5, mv = {1, 9, 0}, xi = 49, xs = "com/android/server/permission/jarjar/kotlin/NumbersKt")
class NumbersKt__NumbersKt extends com.android.server.permission.jarjar.kotlin.NumbersKt__NumbersJVMKt {
    private static final int countOneBits(byte $this$countOneBits) {
        return java.lang.Integer.bitCount($this$countOneBits & 255);
    }

    private static final int countLeadingZeroBits(byte $this$countLeadingZeroBits) {
        return java.lang.Integer.numberOfLeadingZeros($this$countLeadingZeroBits & 255) - 24;
    }

    private static final int countTrailingZeroBits(byte $this$countTrailingZeroBits) {
        return java.lang.Integer.numberOfTrailingZeros($this$countTrailingZeroBits | 256);
    }

    private static final byte takeHighestOneBit(byte $this$takeHighestOneBit) {
        return (byte) java.lang.Integer.highestOneBit($this$takeHighestOneBit & 255);
    }

    private static final byte takeLowestOneBit(byte $this$takeLowestOneBit) {
        return (byte) java.lang.Integer.lowestOneBit($this$takeLowestOneBit);
    }
    ...
    private static final int countOneBits(short $this$countOneBits) {
        return java.lang.Integer.bitCount(65535 & $this$countOneBits);
    }

    private static final int countLeadingZeroBits(short $this$countLeadingZeroBits) {
        return java.lang.Integer.numberOfLeadingZeros(65535 & $this$countLeadingZeroBits) - 16;
    }

    private static final int countTrailingZeroBits(short $this$countTrailingZeroBits) {
        return java.lang.Integer.numberOfTrailingZeros(65536 | $this$countTrailingZeroBits);
    }

    private static final short takeHighestOneBit(short $this$takeHighestOneBit) {
        return (short) java.lang.Integer.highestOneBit(65535 & $this$takeHighestOneBit);
    }

    private static final short takeLowestOneBit(short $this$takeLowestOneBit) {
        return (short) java.lang.Integer.lowestOneBit($this$takeLowestOneBit);
    }
