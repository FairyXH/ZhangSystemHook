...
public class SequencesKt__SequenceBuilderKt {
    ...
    public static final <T> java.util.Iterator<T> iterator(kotlin.jvm.functions.Function2<? super kotlin.sequences.SequenceScope<? super T>, ? super kotlin.coroutines.Continuation<? super kotlin.Unit>, ? extends java.lang.Object> block) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(block, "block");
        kotlin.sequences.SequenceBuilderIterator iterator = new kotlin.sequences.SequenceBuilderIterator();
        iterator.setNextStep(kotlin.coroutines.intrinsics.IntrinsicsKt.createCoroutineUnintercepted(block, iterator, iterator));
        return iterator;
    }
}
