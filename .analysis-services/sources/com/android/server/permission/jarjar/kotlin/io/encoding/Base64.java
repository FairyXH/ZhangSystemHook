...
public class Base64 {
    ...
    public static final com.android.server.permission.jarjar.kotlin.io.encoding.Base64.Default Default = new com.android.server.permission.jarjar.kotlin.io.encoding.Base64.Default(null);
    private static final byte[] mimeLineSeparatorSymbols = {13, 10};
    private static final com.android.server.permission.jarjar.kotlin.io.encoding.Base64 UrlSafe = new com.android.server.permission.jarjar.kotlin.io.encoding.Base64(true, false);
    private static final com.android.server.permission.jarjar.kotlin.io.encoding.Base64 Mime = new com.android.server.permission.jarjar.kotlin.io.encoding.Base64(false, true);

    public /* synthetic */ Base64(boolean z, boolean z2, com.android.server.permission.jarjar.kotlin.jvm.internal.DefaultConstructorMarker defaultConstructorMarker) {
        this(z, z2);
    }
    ...
    public static /* synthetic */ byte[] encodeToByteArray$default(com.android.server.permission.jarjar.kotlin.io.encoding.Base64 base64, byte[] bArr, int i, int i2, int i3, java.lang.Object obj) {
        if (obj != null) {
    ...
    public static /* synthetic */ int encodeIntoByteArray$default(com.android.server.permission.jarjar.kotlin.io.encoding.Base64 base64, byte[] bArr, byte[] bArr2, int i, int i2, int i3, int i4, java.lang.Object obj) {
        if (obj == null) {
    ...
    public final int encodeIntoByteArray(byte[] source, byte[] destination, int destinationOffset, int startIndex, int endIndex) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(source, "source");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(destination, "destination");
        return encodeIntoByteArrayImpl$kotlin_stdlib(source, destination, destinationOffset, startIndex, endIndex);
    }

    public static /* synthetic */ java.lang.String encode$default(com.android.server.permission.jarjar.kotlin.io.encoding.Base64 base64, byte[] bArr, int i, int i2, int i3, java.lang.Object obj) {
        if (obj != null) {
    ...
    public final java.lang.String encode(byte[] source, int startIndex, int endIndex) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(source, "source");
        return new java.lang.String(encodeToByteArrayImpl$kotlin_stdlib(source, startIndex, endIndex), com.android.server.permission.jarjar.kotlin.text.Charsets.ISO_8859_1);
    }

    public static /* synthetic */ java.lang.Appendable encodeToAppendable$default(com.android.server.permission.jarjar.kotlin.io.encoding.Base64 base64, byte[] bArr, java.lang.Appendable appendable, int i, int i2, int i3, java.lang.Object obj) {
        if (obj != null) {
    ...
    public final <A extends java.lang.Appendable> A encodeToAppendable(byte[] source, A a, int startIndex, int endIndex) throws java.io.IOException {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(source, "source");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(a, "destination");
        java.lang.String stringResult = new java.lang.String(encodeToByteArrayImpl$kotlin_stdlib(source, startIndex, endIndex), com.android.server.permission.jarjar.kotlin.text.Charsets.ISO_8859_1);
        a.append(stringResult);
        return a;
    }

    public static /* synthetic */ byte[] decode$default(com.android.server.permission.jarjar.kotlin.io.encoding.Base64 base64, byte[] bArr, int i, int i2, int i3, java.lang.Object obj) {
        if (obj != null) {
    ...
    public static /* synthetic */ int decodeIntoByteArray$default(com.android.server.permission.jarjar.kotlin.io.encoding.Base64 base64, byte[] bArr, byte[] bArr2, int i, int i2, int i3, int i4, java.lang.Object obj) {
        if (obj == null) {
    ...
    public static /* synthetic */ byte[] decode$default(com.android.server.permission.jarjar.kotlin.io.encoding.Base64 base64, java.lang.CharSequence charSequence, int i, int i2, int i3, java.lang.Object obj) {
        if (obj != null) {
            throw new java.lang.UnsupportedOperationException("Super calls with default arguments not supported in this target, function: decode");
        }
        if ((i3 & 2) != 0) {
    ...
    public final byte[] decode(java.lang.CharSequence source, int startIndex, int endIndex) {
        ...
        if (source instanceof java.lang.String) {
            ...
            java.nio.charset.Charset charset = com.android.server.permission.jarjar.kotlin.text.Charsets.ISO_8859_1;
            ...
            com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(bArrCharsToBytesImpl$kotlin_stdlib, "getBytes(...)");
        } else {
        ...
        return decode$default(this, byteSource, 0, 0, 6, (java.lang.Object) null);
    }

    public static /* synthetic */ int decodeIntoByteArray$default(com.android.server.permission.jarjar.kotlin.io.encoding.Base64 base64, java.lang.CharSequence charSequence, byte[] bArr, int i, int i2, int i3, int i4, java.lang.Object obj) {
        if (obj == null) {
    ...
    public final int decodeIntoByteArray(java.lang.CharSequence source, byte[] destination, int destinationOffset, int startIndex, int endIndex) {
        ...
        byte[] byteSource = bArrCharsToBytesImpl$kotlin_stdlib;
        return decodeIntoByteArray$default(this, byteSource, destination, destinationOffset, 0, 0, 24, (java.lang.Object) null);
    }
    ...
    public final int encodeIntoByteArrayImpl$kotlin_stdlib(byte[] source, byte[] destination, int destinationOffset, int startIndex, int endIndex) {
        ...
        byte[] encodeMap = this.isUrlSafe ? com.android.server.permission.jarjar.kotlin.io.encoding.Base64Kt.base64UrlEncodeMap : com.android.server.permission.jarjar.kotlin.io.encoding.Base64Kt.base64EncodeMap;
        ...
        while (true) {
            ...
            int groups = java.lang.Math.min((endIndex - sourceIndex) / 3, groupsPerLine);
            int i = 0;
            while (i < groups) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:34:0x00e9, code lost:
        ...
        r13 = java.lang.Integer.toString(r11, com.android.server.permission.jarjar.kotlin.text.CharsKt.checkRadix(8));
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r13, "toString(...)");
     */
    ...
    */
    private final int decodeImpl(byte[] r20, byte[] r21, int r22, int r23, int r24) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.permission.jarjar.kotlin.io.encoding.Base64.decodeImpl(byte[], byte[], int, int, int):int");
    }
    ...
    private final int decodeSize(byte[] source, int startIndex, int endIndex) {
        ...
        if (this.isMimeScheme) {
            ...
            while (true) {
                ...
                int symbolBits = com.android.server.permission.jarjar.kotlin.io.encoding.Base64Kt.base64DecodeMap[symbol];
                if (symbolBits < 0) {
                    if (symbolBits == -2) {
    ...
    public final java.lang.String bytesToStringImpl$kotlin_stdlib(byte[] source) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(source, "source");
        java.lang.StringBuilder stringBuilder = new java.lang.StringBuilder(source.length);
        for (byte b : source) {
            stringBuilder.append((char) b);
        }
        java.lang.String string = stringBuilder.toString();
        ...
        switch (byteStart) {
            ...
            case -4:
                ...
                if (secondPadIndex == endIndex || source[secondPadIndex] != 61) {
                    throw new java.lang.IllegalArgumentException("Missing one pad character at index " + secondPadIndex);
                }
    ...
    private final int skipIllegalSymbolsIfMime(byte[] source, int startIndex, int endIndex) {
        ...
        while (sourceIndex < endIndex) {
            ...
            if (com.android.server.permission.jarjar.kotlin.io.encoding.Base64Kt.base64DecodeMap[symbol] != -1) {
                return sourceIndex;
            }
            sourceIndex++;
        }
    ...
    public final void checkSourceBounds$kotlin_stdlib(int sourceSize, int startIndex, int endIndex) {
        com.android.server.permission.jarjar.kotlin.collections.AbstractList.Companion.checkBoundsIndexes$kotlin_stdlib(startIndex, endIndex, sourceSize);
    }
    ...
    public static final class Default extends com.android.server.permission.jarjar.kotlin.io.encoding.Base64 {
        ...
        public final byte[] getMimeLineSeparatorSymbols$kotlin_stdlib() {
            return com.android.server.permission.jarjar.kotlin.io.encoding.Base64.mimeLineSeparatorSymbols;
        }

        public final com.android.server.permission.jarjar.kotlin.io.encoding.Base64 getUrlSafe() {
            return com.android.server.permission.jarjar.kotlin.io.encoding.Base64.UrlSafe;
        }

        public final com.android.server.permission.jarjar.kotlin.io.encoding.Base64 getMime() {
            return com.android.server.permission.jarjar.kotlin.io.encoding.Base64.Mime;
        }
    }
}
