...
public final class ProgramIdentifier {
    ...
    public final boolean equals(java.lang.Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != android.hardware.broadcastradio.V2_0.ProgramIdentifier.class) {
            return false;
        }
    ...
    public static final java.util.ArrayList<android.hardware.broadcastradio.V2_0.ProgramIdentifier> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<android.hardware.broadcastradio.V2_0.ProgramIdentifier> _hidl_vec = new java.util.ArrayList<>();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel parcel, java.util.ArrayList<android.hardware.broadcastradio.V2_0.ProgramIdentifier> _hidl_vec) {
        android.os.HwBlob _hidl_blob = new android.os.HwBlob(16);
