...
class StringsKt__StringNumberConversionsJVMKt extends kotlin.text.StringsKt__StringBuilderKt {
    private static final java.lang.String toString(byte $this$toString, int radix) {
        java.lang.String string = java.lang.Integer.toString($this$toString, kotlin.text.CharsKt.checkRadix(radix));
    ...
    private static final java.lang.String toString(long $this$toString, int radix) {
        java.lang.String string = java.lang.Long.toString($this$toString, kotlin.text.CharsKt.checkRadix(radix));
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(string, "toString(...)");
        return string;
    }
    ...
    public static final java.lang.Float toFloatOrNull(java.lang.String $this$toFloatOrNull) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$toFloatOrNull, "<this>");
        try {
            if (kotlin.text.ScreenFloatValueRegEx.value.matches($this$toFloatOrNull)) {
    ...
    public static final java.lang.Double toDoubleOrNull(java.lang.String $this$toDoubleOrNull) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$toDoubleOrNull, "<this>");
        try {
            if (kotlin.text.ScreenFloatValueRegEx.value.matches($this$toDoubleOrNull)) {
    ...
    private static final java.math.BigInteger toBigInteger(java.lang.String $this$toBigInteger) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$toBigInteger, "<this>");
    ...
    private static final java.math.BigInteger toBigInteger(java.lang.String $this$toBigInteger, int radix) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$toBigInteger, "<this>");
        return new java.math.BigInteger($this$toBigInteger, kotlin.text.CharsKt.checkRadix(radix));
    }

    public static final java.math.BigInteger toBigIntegerOrNull(java.lang.String $this$toBigIntegerOrNull) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$toBigIntegerOrNull, "<this>");
        return kotlin.text.StringsKt.toBigIntegerOrNull($this$toBigIntegerOrNull, 10);
    }
    ...
    public static final java.math.BigInteger toBigIntegerOrNull(java.lang.String $this$toBigIntegerOrNull, int radix) {
        ...
        switch (length) {
            case 0:
                return null;
            case 1:
                if (kotlin.text.CharsKt.digitOf($this$toBigIntegerOrNull.charAt(0), radix) < 0) {
                    return null;
                }
                break;
            default:
                ...
                for (int index = start; index < length; index++) {
                    if (kotlin.text.CharsKt.digitOf($this$toBigIntegerOrNull.charAt(index), radix) < 0) {
                        return null;
                    }
                }
                break;
        }
        return new java.math.BigInteger($this$toBigIntegerOrNull, kotlin.text.CharsKt.checkRadix(radix));
    }

    private static final java.math.BigDecimal toBigDecimal(java.lang.String $this$toBigDecimal) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$toBigDecimal, "<this>");
    ...
    public static final java.math.BigDecimal toBigDecimalOrNull(java.lang.String $this$toBigDecimalOrNull) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$toBigDecimalOrNull, "<this>");
        try {
            if (kotlin.text.ScreenFloatValueRegEx.value.matches($this$toBigDecimalOrNull)) {
