...
public interface IServiceManager extends android.hidl.base.V1_0.IBase {
    ...
    static android.hidl.manager.V1_0.IServiceManager asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        android.os.IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof android.hidl.manager.V1_0.IServiceManager)) {
            return (android.hidl.manager.V1_0.IServiceManager) iface;
        }
        android.hidl.manager.V1_0.IServiceManager proxy = new android.hidl.manager.V1_0.IServiceManager.Proxy(binder);
        try {
    ...
    static android.hidl.manager.V1_0.IServiceManager castFrom(android.os.IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static android.hidl.manager.V1_0.IServiceManager getService(java.lang.String serviceName, boolean retry) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static android.hidl.manager.V1_0.IServiceManager getService(boolean retry) throws android.os.RemoteException {
        return getService("default", retry);
    }

    @java.lang.Deprecated
    static android.hidl.manager.V1_0.IServiceManager getService(java.lang.String serviceName) throws android.os.RemoteException {
    ...
    public static final class InstanceDebugInfo {
        ...
        public final boolean equals(java.lang.Object otherObject) {
            ...
            if (otherObject == null || otherObject.getClass() != android.hidl.manager.V1_0.IServiceManager.InstanceDebugInfo.class) {
                return false;
            }
            ...
            if (android.os.HidlSupport.deepEquals(this.interfaceName, other.interfaceName) && android.os.HidlSupport.deepEquals(this.instanceName, other.instanceName) && this.pid == other.pid && android.os.HidlSupport.deepEquals(this.clientPids, other.clientPids) && this.arch == other.arch) {
                return true;
            }
            return false;
        }
        ...
        public static final java.util.ArrayList<android.hidl.manager.V1_0.IServiceManager.InstanceDebugInfo> readVectorFromParcel(android.os.HwParcel parcel) {
            java.util.ArrayList<android.hidl.manager.V1_0.IServiceManager.InstanceDebugInfo> _hidl_vec = new java.util.ArrayList<>();
        ...
        public final void readEmbeddedFromParcel(android.os.HwParcel parcel, android.os.HwBlob _hidl_blob, long _hidl_offset) {
            ...
            android.os.HwBlob childBlob = parcel.readEmbeddedBuffer(_hidl_vec_size * 4, _hidl_blob.handle(), _hidl_offset + 40 + 0, true);
            this.clientPids.clear();
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
                int _hidl_vec_element = childBlob.getInt32(_hidl_index_0 * 4);
                this.clientPids.add(java.lang.Integer.valueOf(_hidl_vec_element));
            }
        ...
        public static final void writeVectorToParcel(android.os.HwParcel parcel, java.util.ArrayList<android.hidl.manager.V1_0.IServiceManager.InstanceDebugInfo> _hidl_vec) {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hidl.manager.V1_0.IServiceManager {
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String descriptor) {
            if (android.hidl.manager.V1_0.IServiceManager.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
