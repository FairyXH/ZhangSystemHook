...
class NumbersKt__FloorDivModKt extends com.android.server.permission.jarjar.kotlin.NumbersKt__BigIntegersKt {
    ...
    private static final float mod(float $this$mod, float other) {
        ...
        if (!(r == 0.0f)) {
            if (!(java.lang.Math.signum(r) == java.lang.Math.signum(other))) {
                return r + other;
            }
        }
        return r;
    ...
    private static final double mod(float $this$mod, double other) {
        ...
        return !(java.lang.Math.signum(d) == java.lang.Math.signum(other)) ? d + other : d;
    }
