...
public interface MatchResult {
    com.android.server.permission.jarjar.kotlin.text.MatchResult.Destructured getDestructured();

    java.util.List<java.lang.String> getGroupValues();

    com.android.server.permission.jarjar.kotlin.text.MatchGroupCollection getGroups();

    com.android.server.permission.jarjar.kotlin.ranges.IntRange getRange();

    java.lang.String getValue();

    com.android.server.permission.jarjar.kotlin.text.MatchResult next();

    /* JADX INFO: compiled from: MatchResult.kt */
    @com.android.server.permission.jarjar.kotlin.Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    public static final class DefaultImpls {
        public static com.android.server.permission.jarjar.kotlin.text.MatchResult.Destructured getDestructured(com.android.server.permission.jarjar.kotlin.text.MatchResult $this) {
            return new com.android.server.permission.jarjar.kotlin.text.MatchResult.Destructured($this);
        }
    }
    ...
    public static final class Destructured {
        private final com.android.server.permission.jarjar.kotlin.text.MatchResult match;

        public Destructured(com.android.server.permission.jarjar.kotlin.text.MatchResult match) {
            com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(match, "match");
            this.match = match;
        }

        public final com.android.server.permission.jarjar.kotlin.text.MatchResult getMatch() {
            return this.match;
        }
