...
public interface IBiometricsFingerprint extends android.hardware.biometrics.fingerprint.V2_3.IBiometricsFingerprint {
    public static final java.lang.String kInterfaceName = "vendor.oplus.hardware.biometrics.fingerprint@2.1::IBiometricsFingerprint";
    ...
    int sendFingerprintCmd(int i, java.util.ArrayList<java.lang.Byte> arrayList) throws android.os.RemoteException;

    @Override // android.hardware.biometrics.fingerprint.V2_3.IBiometricsFingerprint, android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprint, android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint, android.hidl.base.V1_0.IBase
    void setHALInstrumentation() throws android.os.RemoteException;

    long setHalCallback(vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprintClientCallbackEx iBiometricsFingerprintClientCallbackEx) throws android.os.RemoteException;

    @Override // android.hardware.biometrics.fingerprint.V2_3.IBiometricsFingerprint, android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprint, android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint, android.hidl.base.V1_0.IBase
    boolean unlinkToDeath(android.os.IHwBinder.DeathRecipient deathRecipient) throws android.os.RemoteException;

    static vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        android.os.IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint)) {
            return (vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint) iface;
        }
        vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint proxy = new vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint.Proxy(binder);
        try {
    ...
    static vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint castFrom(android.os.IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint getService(java.lang.String serviceName, boolean retry) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint getService(boolean retry) throws android.os.RemoteException {
        return getService("default", retry);
    }

    @java.lang.Deprecated
    static vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint getService(java.lang.String serviceName) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName));
    }

    @java.lang.Deprecated
    static vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint {
        ...
        @Override // vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint, android.hardware.biometrics.fingerprint.V2_3.IBiometricsFingerprint, android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprint, android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint, android.hidl.base.V1_0.IBase
        ...
        public long setHalCallback(vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprintClientCallbackEx clientCallback) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
        ...
        @Override // vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint
        public int sendFingerprintCmd(int cmdId, java.util.ArrayList<java.lang.Byte> in_buf) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint.kInterfaceName);
    ...
    public static abstract class Stub extends android.os.HwBinder implements vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint {
        @Override // vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint, android.hardware.biometrics.fingerprint.V2_3.IBiometricsFingerprint, android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprint, android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint, android.hidl.base.V1_0.IBase
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint.kInterfaceName, android.hardware.biometrics.fingerprint.V2_3.IBiometricsFingerprint.kInterfaceName, android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprint.kInterfaceName, android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint.kInterfaceName, android.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String descriptor) {
            if (vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, android.os.HwParcel _hidl_reply, int _hidl_flags) throws android.os.RemoteException {
            switch (_hidl_code) {
                ...
                case 14:
                    ...
                    vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprintClientCallbackEx clientCallback2 = vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprintClientCallbackEx.asInterface(_hidl_request.readStrongBinder());
                    long _hidl_out_deviceId2 = setHalCallback(clientCallback2);
                    _hidl_reply.writeStatus(0);
                    _hidl_reply.writeInt64(_hidl_out_deviceId2);
                    _hidl_reply.send();
                    return;
                case 15:
                    _hidl_request.enforceInterface(vendor.oplus.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint.kInterfaceName);
                    int cmdId = _hidl_request.readInt32();
                    java.util.ArrayList<java.lang.Byte> in_buf = _hidl_request.readInt8Vector();
                    int _hidl_out_result = sendFingerprintCmd(cmdId, in_buf);
                    _hidl_reply.writeStatus(0);
