...
public class AvbPublicKey implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.gsi.AvbPublicKey> CREATOR = new android.os.Parcelable.Creator<android.gsi.AvbPublicKey>() { // from class: android.gsi.AvbPublicKey.1
        ...
        public android.gsi.AvbPublicKey createFromParcel(android.os.Parcel _aidl_source) {
            android.gsi.AvbPublicKey _aidl_out = new android.gsi.AvbPublicKey();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.gsi.AvbPublicKey[] newArray(int _aidl_size) {
            return new android.gsi.AvbPublicKey[_aidl_size];
        }
    };
    public byte[] bytes;
    public byte[] sha1;
