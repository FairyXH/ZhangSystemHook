...
public class ReconcileSdkDataArgs implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.os.ReconcileSdkDataArgs> CREATOR = new android.os.Parcelable.Creator<android.os.ReconcileSdkDataArgs>() { // from class: android.os.ReconcileSdkDataArgs.1
        ...
        public android.os.ReconcileSdkDataArgs createFromParcel(android.os.Parcel _aidl_source) {
            android.os.ReconcileSdkDataArgs _aidl_out = new android.os.ReconcileSdkDataArgs();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.os.ReconcileSdkDataArgs[] newArray(int _aidl_size) {
            return new android.os.ReconcileSdkDataArgs[_aidl_size];
        }
    };
