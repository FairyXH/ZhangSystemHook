...
public class HwLight implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.hardware.light.HwLight> CREATOR = new android.os.Parcelable.Creator<android.hardware.light.HwLight>() { // from class: android.hardware.light.HwLight.1
        ...
        public android.hardware.light.HwLight createFromParcel(android.os.Parcel _aidl_source) {
            android.hardware.light.HwLight _aidl_out = new android.hardware.light.HwLight();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.light.HwLight[] newArray(int _aidl_size) {
            return new android.hardware.light.HwLight[_aidl_size];
        }
    };
    public int id = 0;
