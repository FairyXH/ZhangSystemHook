...
public interface ICwbCallback extends android.hidl.base.V1_0.IBase {
    public static final java.lang.String kInterfaceName = "vendor.oplus.hardware.cwb@1.0::ICwbCallback";
    ...
    void onAvailableStatusChanged(boolean z) throws android.os.RemoteException;
    ...
    static vendor.oplus.hardware.cwb.V1_0.ICwbCallback asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        android.os.IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof vendor.oplus.hardware.cwb.V1_0.ICwbCallback)) {
            return (vendor.oplus.hardware.cwb.V1_0.ICwbCallback) iface;
        }
        vendor.oplus.hardware.cwb.V1_0.ICwbCallback proxy = new vendor.oplus.hardware.cwb.V1_0.ICwbCallback.Proxy(binder);
        try {
    ...
    static vendor.oplus.hardware.cwb.V1_0.ICwbCallback castFrom(android.os.IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static vendor.oplus.hardware.cwb.V1_0.ICwbCallback getService(java.lang.String serviceName, boolean retry) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static vendor.oplus.hardware.cwb.V1_0.ICwbCallback getService(boolean retry) throws android.os.RemoteException {
        return getService("default", retry);
    }

    @java.lang.Deprecated
    static vendor.oplus.hardware.cwb.V1_0.ICwbCallback getService(java.lang.String serviceName) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName));
    }

    @java.lang.Deprecated
    static vendor.oplus.hardware.cwb.V1_0.ICwbCallback getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements vendor.oplus.hardware.cwb.V1_0.ICwbCallback {
        ...
        @Override // vendor.oplus.hardware.cwb.V1_0.ICwbCallback, android.hidl.base.V1_0.IBase
        ...
        public void onAvailableStatusChanged(boolean available) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(vendor.oplus.hardware.cwb.V1_0.ICwbCallback.kInterfaceName);
    ...
    public static abstract class Stub extends android.os.HwBinder implements vendor.oplus.hardware.cwb.V1_0.ICwbCallback {
        @Override // vendor.oplus.hardware.cwb.V1_0.ICwbCallback, android.hidl.base.V1_0.IBase
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(vendor.oplus.hardware.cwb.V1_0.ICwbCallback.kInterfaceName, android.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String descriptor) {
            if (vendor.oplus.hardware.cwb.V1_0.ICwbCallback.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, android.os.HwParcel _hidl_reply, int _hidl_flags) throws android.os.RemoteException {
            switch (_hidl_code) {
                case 1:
                    _hidl_request.enforceInterface(vendor.oplus.hardware.cwb.V1_0.ICwbCallback.kInterfaceName);
                    boolean available = _hidl_request.readBool();
                    onAvailableStatusChanged(available);
                    return;
                case 256067662:
