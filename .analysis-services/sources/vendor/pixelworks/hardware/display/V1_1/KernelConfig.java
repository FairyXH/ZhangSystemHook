...
public final class KernelConfig {
    ...
    public static final java.lang.String dumpBitfield(int o) {
        ...
        if ((o & 88) == 88) {
            list.add("CLEAR_TRIGGER");
            flipped |= 88;
        }
        if ((o & 139) == 139) {
            list.add("DPP_DEMO_WINDOW");
            flipped |= 139;
        }
        if ((o & 140) == 140) {
            list.add("FINGER_DISPLAY");
            flipped |= 140;
        }
        if ((o & 141) == 141) {
            list.add("DPP_FADE_INOUT");
            flipped |= 141;
        }
        if ((o & 142) == 142) {
            list.add("DPP_PATH_MUX");
            flipped |= 142;
        }
        if ((o & 143) == 143) {
            list.add("GAMMA_MODE");
        ...
        if ((o & 144) == 144) {
            list.add("PARAM_VALID");
            flipped |= 144;
        }
        if ((o & 159) == 159) {
            list.add("DPORT_DISABLE");
            flipped |= 159;
        }
        if ((o & 160) == 160) {
            list.add("DPORT_DIS_DEBUG");
            flipped |= 160;
        }
        if ((o & 161) == 161) {
            list.add("HDR10PLUS");
        ...
        if ((o & 163) == 163) {
            list.add("DPP_3DLUT_GAIN");
            flipped |= 163;
        }
        if ((o & 162) == 162) {
            list.add("SDR2HDR_AI_SWITCH");
            flipped |= 162;
        }
        if ((o & 165) == 165) {
            list.add("SDR2HDR_AI_SWITCH_PRE");
            flipped |= 165;
        }
        if ((o & 167) == 167) {
            list.add("SET_DSI_MODE_INFO");
            flipped |= 167;
        }
        if ((o & 168) == 168) {
            list.add("OSD_LAYER_EMPTY");
            flipped |= 168;
        }
        if ((o & 169) == 169) {
            list.add("SET_METADATA");
            flipped |= 169;
        }
        if ((o & 170) == 170) {
            list.add("SET_METADATA_LOCK");
            flipped |= 170;
        }
        if ((o & 171) == 171) {
            list.add("GET_METADATA");
            flipped |= 171;
        }
        if ((o & 172) == 172) {
            list.add("DUAL_CH_CTRL");
            flipped |= 172;
        }
        if ((o & 173) == 173) {
            list.add("MEMC_CTRL");
        ...
        if ((o & 177) == 177) {
            list.add("KERNEL_STATUS_GET");
            flipped |= 177;
        }
        if ((o & 178) == 178) {
            list.add("SET_MVD_META");
            flipped |= 178;
        }
        if ((o & 189) == 189) {
            list.add("PWIL_DPORT_DISABLE");
            flipped |= 189;
        }
        if ((o & 190) == 190) {
            list.add("HDR_DATA_PATH");
            flipped |= 190;
        }
        if ((o & 191) == 191) {
            list.add("DPP_CSC_SET");
            flipped |= 191;
        }
        if ((o & 192) == 192) {
            list.add("PT_SR_SET");
        ...
        if ((o & 193) == 193) {
            list.add("DEMURA_LUT_SET");
            flipped |= 193;
        }
        if ((o & 194) == 194) {
            list.add("DEMURA_ENABLE");
            flipped |= 194;
        }
        if ((o & 195) == 195) {
            list.add("DEMURA_XY_LUT_SET");
            flipped |= 195;
        }
        if ((o & 210) == 210) {
