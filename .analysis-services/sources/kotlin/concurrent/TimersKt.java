...
public final class TimersKt {
    private static final java.util.TimerTask schedule(java.util.Timer $this$schedule, long delay, kotlin.jvm.functions.Function1<? super java.util.TimerTask, kotlin.Unit> action) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$schedule, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(action, "action");
        java.util.TimerTask task = new kotlin.concurrent.TimersKt.AnonymousClass1(action);
        $this$schedule.schedule(task, delay);
        return task;
    }

    private static final java.util.TimerTask schedule(java.util.Timer $this$schedule, java.util.Date time, kotlin.jvm.functions.Function1<? super java.util.TimerTask, kotlin.Unit> action) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$schedule, "<this>");
    ...
    private static final java.util.TimerTask schedule(java.util.Timer $this$schedule, long delay, long period, kotlin.jvm.functions.Function1<? super java.util.TimerTask, kotlin.Unit> action) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$schedule, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(action, "action");
        java.util.TimerTask task = new kotlin.concurrent.TimersKt.AnonymousClass1(action);
    ...
    private static final java.util.TimerTask schedule(java.util.Timer $this$schedule, java.util.Date time, long period, kotlin.jvm.functions.Function1<? super java.util.TimerTask, kotlin.Unit> action) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$schedule, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(time, "time");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(action, "action");
        java.util.TimerTask task = new kotlin.concurrent.TimersKt.AnonymousClass1(action);
    ...
    private static final java.util.TimerTask scheduleAtFixedRate(java.util.Timer $this$scheduleAtFixedRate, long delay, long period, kotlin.jvm.functions.Function1<? super java.util.TimerTask, kotlin.Unit> action) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$scheduleAtFixedRate, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(action, "action");
        java.util.TimerTask task = new kotlin.concurrent.TimersKt.AnonymousClass1(action);
    ...
    private static final java.util.TimerTask scheduleAtFixedRate(java.util.Timer $this$scheduleAtFixedRate, java.util.Date time, long period, kotlin.jvm.functions.Function1<? super java.util.TimerTask, kotlin.Unit> action) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$scheduleAtFixedRate, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(time, "time");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(action, "action");
        java.util.TimerTask task = new kotlin.concurrent.TimersKt.AnonymousClass1(action);
    ...
    static /* synthetic */ java.util.Timer timer$default(java.lang.String name, boolean daemon, long initialDelay, long period, kotlin.jvm.functions.Function1 action, int i, java.lang.Object obj) {
        if ((i & 1) != 0) {
            name = null;
        }
        if ((i & 2) != 0) {
        ...
        timer.schedule(new kotlin.concurrent.TimersKt.AnonymousClass1(action), initialDelay, period);
        return timer;
    }
    ...
    static /* synthetic */ java.util.Timer timer$default(java.lang.String name, boolean daemon, java.util.Date startAt, long period, kotlin.jvm.functions.Function1 action, int i, java.lang.Object obj) {
        if ((i & 1) != 0) {
            name = null;
        }
        if ((i & 2) != 0) {
        ...
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(action, "action");
        java.util.Timer timer = timer(name, daemon);
        timer.schedule(new kotlin.concurrent.TimersKt.AnonymousClass1(action), startAt, period);
        return timer;
    }
    ...
    static /* synthetic */ java.util.Timer fixedRateTimer$default(java.lang.String name, boolean daemon, long initialDelay, long period, kotlin.jvm.functions.Function1 action, int i, java.lang.Object obj) {
        if ((i & 1) != 0) {
            name = null;
        }
        if ((i & 2) != 0) {
        ...
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(action, "action");
        java.util.Timer timer = timer(name, daemon);
        timer.scheduleAtFixedRate(new kotlin.concurrent.TimersKt.AnonymousClass1(action), initialDelay, period);
        return timer;
    }
    ...
    static /* synthetic */ java.util.Timer fixedRateTimer$default(java.lang.String name, boolean daemon, java.util.Date startAt, long period, kotlin.jvm.functions.Function1 action, int i, java.lang.Object obj) {
        if ((i & 1) != 0) {
            name = null;
        }
        if ((i & 2) != 0) {
        ...
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(action, "action");
        java.util.Timer timer = timer(name, daemon);
        timer.scheduleAtFixedRate(new kotlin.concurrent.TimersKt.AnonymousClass1(action), startAt, period);
        return timer;
    }
