...
public final class DabTableEntry {
    ...
    public final boolean equals(java.lang.Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != android.hardware.broadcastradio.V2_0.DabTableEntry.class) {
            return false;
        }
        android.hardware.broadcastradio.V2_0.DabTableEntry other = (android.hardware.broadcastradio.V2_0.DabTableEntry) otherObject;
        if (android.os.HidlSupport.deepEquals(this.label, other.label) && this.frequency == other.frequency) {
            return true;
        }
        return false;
    }
    ...
    public static final java.util.ArrayList<android.hardware.broadcastradio.V2_0.DabTableEntry> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<android.hardware.broadcastradio.V2_0.DabTableEntry> _hidl_vec = new java.util.ArrayList<>();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel parcel, java.util.ArrayList<android.hardware.broadcastradio.V2_0.DabTableEntry> _hidl_vec) {
