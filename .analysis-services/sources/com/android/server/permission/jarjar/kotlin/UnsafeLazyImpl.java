...
public final class UnsafeLazyImpl<T> implements com.android.server.permission.jarjar.kotlin.Lazy<T>, java.io.Serializable {
    private java.lang.Object _value;
    private com.android.server.permission.jarjar.kotlin.jvm.functions.Function0<? extends T> initializer;

    public UnsafeLazyImpl(com.android.server.permission.jarjar.kotlin.jvm.functions.Function0<? extends T> function0) {
    ...
    public T getValue() {
        if (this._value == com.android.server.permission.jarjar.kotlin.UNINITIALIZED_VALUE.INSTANCE) {
