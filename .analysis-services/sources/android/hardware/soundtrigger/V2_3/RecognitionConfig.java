...
public final class RecognitionConfig {
    ...
    public static final java.util.ArrayList<android.hardware.soundtrigger.V2_3.RecognitionConfig> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<android.hardware.soundtrigger.V2_3.RecognitionConfig> _hidl_vec = new java.util.ArrayList<>();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel parcel, java.util.ArrayList<android.hardware.soundtrigger.V2_3.RecognitionConfig> _hidl_vec) {
