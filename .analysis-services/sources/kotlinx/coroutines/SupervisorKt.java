...
public final class SupervisorKt {
    public static final kotlinx.coroutines.CompletableJob SupervisorJob(kotlinx.coroutines.Job parent) {
        return new kotlinx.coroutines.SupervisorJobImpl(parent);
    }
    ...
    public static final /* synthetic */ kotlinx.coroutines.Job m12805SupervisorJob(kotlinx.coroutines.Job parent) {
        return SupervisorJob(parent);
    }

    /* JADX INFO: renamed from: SupervisorJob$default, reason: collision with other method in class */
    public static /* synthetic */ kotlinx.coroutines.Job m12806SupervisorJob$default(kotlinx.coroutines.Job job, int i, java.lang.Object obj) {
        if ((i & 1) != 0) {
            job = null;
        }
        return m12805SupervisorJob(job);
    }
    ...
    public static final <R> java.lang.Object supervisorScope(kotlin.jvm.functions.Function2<? super kotlinx.coroutines.CoroutineScope, ? super kotlin.coroutines.Continuation<? super R>, ? extends java.lang.Object> function2, kotlin.coroutines.Continuation<? super R> continuation) {
        kotlinx.coroutines.SupervisorCoroutine coroutine = new kotlinx.coroutines.SupervisorCoroutine(continuation.getContext(), continuation);
