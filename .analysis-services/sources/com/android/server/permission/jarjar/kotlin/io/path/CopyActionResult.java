...
public enum CopyActionResult {
    ...
    public static com.android.server.permission.jarjar.kotlin.enums.EnumEntries<com.android.server.permission.jarjar.kotlin.io.path.CopyActionResult> getEntries() {
        return $ENTRIES;
    }
}
