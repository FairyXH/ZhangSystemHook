...
final class ThreadState {
    ...
    public ThreadState(kotlin.coroutines.CoroutineContext context, int n) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(context, "context");
        this.context = context;
        this.values = new java.lang.Object[n];
        this.elements = new kotlinx.coroutines.ThreadContextElement[n];
    }
    ...
    public final void restore(kotlin.coroutines.CoroutineContext context) {
        ...
        if (length >= 0) {
            do {
                int i = length;
                length--;
                kotlinx.coroutines.ThreadContextElement<java.lang.Object> threadContextElement = this.elements[i];
