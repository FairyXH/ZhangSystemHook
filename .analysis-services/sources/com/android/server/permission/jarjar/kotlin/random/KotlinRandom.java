...
final class KotlinRandom extends java.util.Random {
    private static final com.android.server.permission.jarjar.kotlin.random.KotlinRandom.Companion Companion = new com.android.server.permission.jarjar.kotlin.random.KotlinRandom.Companion(null);
    private static final long serialVersionUID = 0;
    private final com.android.server.permission.jarjar.kotlin.random.Random impl;
    private boolean seedInitialized;

    public KotlinRandom(com.android.server.permission.jarjar.kotlin.random.Random impl) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(impl, "impl");
        this.impl = impl;
    }

    public final com.android.server.permission.jarjar.kotlin.random.Random getImpl() {
        return this.impl;
    }
