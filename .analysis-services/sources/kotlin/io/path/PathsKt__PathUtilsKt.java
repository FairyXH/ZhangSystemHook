...
class PathsKt__PathUtilsKt extends kotlin.io.path.PathsKt__PathRecursiveFunctionsKt {
    ...
    public static final java.lang.String getName(java.nio.file.Path $this$name) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$name, "<this>");
    ...
    private static final java.lang.String getPathString(java.nio.file.Path $this$pathString) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$pathString, "<this>");
    ...
    public static final java.lang.String getInvariantSeparatorsPathString(java.nio.file.Path $this$invariantSeparatorsPathString) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$invariantSeparatorsPathString, "<this>");
        java.lang.String separator = $this$invariantSeparatorsPathString.getFileSystem().getSeparator();
        if (kotlin.jvm.internal.Intrinsics.areEqual(separator, com.android.server.slice.SliceClientPermissions.SliceAuthority.DELIMITER)) {
        ...
        return kotlin.text.StringsKt.replace$default(string, separator, com.android.server.slice.SliceClientPermissions.SliceAuthority.DELIMITER, false, 4, (java.lang.Object) null);
    }
    ...
    private static final java.lang.String getInvariantSeparatorsPath(java.nio.file.Path $this$invariantSeparatorsPath) {
        ...
        return kotlin.io.path.PathsKt.getInvariantSeparatorsPathString($this$invariantSeparatorsPath);
    }

    private static final java.nio.file.Path absolute(java.nio.file.Path $this$absolute) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$absolute, "<this>");
    ...
    private static final java.lang.String absolutePathString(java.nio.file.Path $this$absolutePathString) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$absolutePathString, "<this>");
    ...
    public static final java.nio.file.Path relativeTo(java.nio.file.Path $this$relativeTo, java.nio.file.Path base) {
        ...
        try {
            return kotlin.io.path.PathRelativizer.INSTANCE.tryRelativeTo($this$relativeTo, base);
    ...
    public static final java.nio.file.Path relativeToOrSelf(java.nio.file.Path $this$relativeToOrSelf, java.nio.file.Path base) {
        ...
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(base, "base");
        java.nio.file.Path pathRelativeToOrNull = kotlin.io.path.PathsKt.relativeToOrNull($this$relativeToOrSelf, base);
    ...
    public static final java.nio.file.Path relativeToOrNull(java.nio.file.Path $this$relativeToOrNull, java.nio.file.Path base) {
        ...
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(base, "base");
        try {
            return kotlin.io.path.PathRelativizer.INSTANCE.tryRelativeTo($this$relativeToOrNull, base);
        } catch (java.lang.IllegalArgumentException e) {
            return null;
        }
    }
    ...
    static /* synthetic */ java.nio.file.Path copyTo$default(java.nio.file.Path $this$copyTo_u24default, java.nio.file.Path target, boolean overwrite, int i, java.lang.Object obj) throws java.io.IOException {
        ...
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$copyTo_u24default, "<this>");
    ...
    private static final boolean exists(java.nio.file.Path $this$exists, java.nio.file.LinkOption... options) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$exists, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(options, "options");
    ...
    private static final boolean notExists(java.nio.file.Path $this$notExists, java.nio.file.LinkOption... options) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$notExists, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(options, "options");
    ...
    private static final boolean isRegularFile(java.nio.file.Path $this$isRegularFile, java.nio.file.LinkOption... options) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$isRegularFile, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(options, "options");
    ...
    private static final boolean isDirectory(java.nio.file.Path $this$isDirectory, java.nio.file.LinkOption... options) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$isDirectory, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(options, "options");
    ...
    private static final boolean isSymbolicLink(java.nio.file.Path $this$isSymbolicLink) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$isSymbolicLink, "<this>");
    ...
    private static final boolean isExecutable(java.nio.file.Path $this$isExecutable) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$isExecutable, "<this>");
    ...
    private static final boolean isHidden(java.nio.file.Path $this$isHidden) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$isHidden, "<this>");
    ...
    private static final boolean isReadable(java.nio.file.Path $this$isReadable) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$isReadable, "<this>");
    ...
    private static final boolean isWritable(java.nio.file.Path $this$isWritable) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$isWritable, "<this>");
    ...
    private static final boolean isSameFileAs(java.nio.file.Path $this$isSameFileAs, java.nio.file.Path other) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$isSameFileAs, "<this>");
    ...
    public static final java.util.List<java.nio.file.Path> listDirectoryEntries(java.nio.file.Path $this$listDirectoryEntries, java.lang.String glob) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$listDirectoryEntries, "<this>");
    ...
    static /* synthetic */ java.lang.Object useDirectoryEntries$default(java.nio.file.Path $this$useDirectoryEntries_u24default, java.lang.String glob, kotlin.jvm.functions.Function1 block, int i, java.lang.Object obj) throws java.io.IOException {
        if ((i & 1) != 0) {
            glob = com.android.server.am.SettingsToPropertiesMapper.NAMESPACE_REBOOT_STAGING_DELIMITER;
        }
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$useDirectoryEntries_u24default, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(glob, "glob");
    ...
    private static final <T> T useDirectoryEntries(java.nio.file.Path $this$useDirectoryEntries, java.lang.String glob, kotlin.jvm.functions.Function1<? super kotlin.sequences.Sequence<? extends java.nio.file.Path>, ? extends T> block) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$useDirectoryEntries, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(glob, "glob");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(block, "block");
    ...
    static /* synthetic */ void forEachDirectoryEntry$default(java.nio.file.Path $this$forEachDirectoryEntry_u24default, java.lang.String glob, kotlin.jvm.functions.Function1 action, int i, java.lang.Object obj) throws java.io.IOException {
        if ((i & 1) != 0) {
            glob = com.android.server.am.SettingsToPropertiesMapper.NAMESPACE_REBOOT_STAGING_DELIMITER;
        }
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$forEachDirectoryEntry_u24default, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(glob, "glob");
    ...
    private static final void forEachDirectoryEntry(java.nio.file.Path $this$forEachDirectoryEntry, java.lang.String glob, kotlin.jvm.functions.Function1<? super java.nio.file.Path, kotlin.Unit> action) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$forEachDirectoryEntry, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(glob, "glob");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(action, "action");
    ...
    private static final long fileSize(java.nio.file.Path $this$fileSize) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$fileSize, "<this>");
    ...
    private static final void deleteExisting(java.nio.file.Path $this$deleteExisting) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$deleteExisting, "<this>");
    ...
    private static final boolean deleteIfExists(java.nio.file.Path $this$deleteIfExists) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$deleteIfExists, "<this>");
        return java.nio.file.Files.deleteIfExists($this$deleteIfExists);
    }

    private static final java.nio.file.Path createDirectory(java.nio.file.Path $this$createDirectory, java.nio.file.attribute.FileAttribute<?>... attributes) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$createDirectory, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(attributes, "attributes");
        java.nio.file.Path pathCreateDirectory = java.nio.file.Files.createDirectory($this$createDirectory, (java.nio.file.attribute.FileAttribute[]) java.util.Arrays.copyOf(attributes, attributes.length));
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(pathCreateDirectory, "createDirectory(...)");
        return pathCreateDirectory;
    }

    private static final java.nio.file.Path createDirectories(java.nio.file.Path $this$createDirectories, java.nio.file.attribute.FileAttribute<?>... attributes) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$createDirectories, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(attributes, "attributes");
        java.nio.file.Path pathCreateDirectories = java.nio.file.Files.createDirectories($this$createDirectories, (java.nio.file.attribute.FileAttribute[]) java.util.Arrays.copyOf(attributes, attributes.length));
    ...
    public static final java.nio.file.Path createParentDirectories(java.nio.file.Path $this$createParentDirectories, java.nio.file.attribute.FileAttribute<?>... attributes) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$createParentDirectories, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(attributes, "attributes");
    ...
    private static final java.nio.file.Path moveTo(java.nio.file.Path $this$moveTo, java.nio.file.Path target, java.nio.file.CopyOption... options) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$moveTo, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(target, "target");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(options, "options");
    ...
    static /* synthetic */ java.nio.file.Path moveTo$default(java.nio.file.Path $this$moveTo_u24default, java.nio.file.Path target, boolean overwrite, int i, java.lang.Object obj) throws java.io.IOException {
        ...
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$moveTo_u24default, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(target, "target");
        java.nio.file.CopyOption[] options = overwrite ? new java.nio.file.CopyOption[]{java.nio.file.StandardCopyOption.REPLACE_EXISTING} : new java.nio.file.CopyOption[0];
    ...
    private static final java.nio.file.FileStore fileStore(java.nio.file.Path $this$fileStore) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$fileStore, "<this>");
    ...
    private static final java.lang.Object getAttribute(java.nio.file.Path $this$getAttribute, java.lang.String attribute, java.nio.file.LinkOption... options) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$getAttribute, "<this>");
    ...
    private static final java.nio.file.Path setAttribute(java.nio.file.Path $this$setAttribute, java.lang.String attribute, java.lang.Object value, java.nio.file.LinkOption... options) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$setAttribute, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(attribute, "attribute");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(options, "options");
    ...
    private static final /* synthetic */ <V extends java.nio.file.attribute.FileAttributeView> V fileAttributesViewOrNull(java.nio.file.Path path, java.nio.file.LinkOption... options) {
        ...
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(options, "options");
        kotlin.jvm.internal.Intrinsics.reifiedOperationMarker(4, com.android.server.integrity.parser.RuleMetadataParser.VERSION_TAG);
    ...
    private static final java.util.Map<java.lang.String, java.lang.Object> readAttributes(java.nio.file.Path $this$readAttributes, java.lang.String attributes, java.nio.file.LinkOption... options) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$readAttributes, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(attributes, "attributes");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(options, "options");
    ...
    private static final java.nio.file.attribute.FileTime getLastModifiedTime(java.nio.file.Path $this$getLastModifiedTime, java.nio.file.LinkOption... options) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$getLastModifiedTime, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(options, "options");
    ...
    private static final java.nio.file.Path setLastModifiedTime(java.nio.file.Path $this$setLastModifiedTime, java.nio.file.attribute.FileTime value) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$setLastModifiedTime, "<this>");
    ...
    private static final java.nio.file.attribute.UserPrincipal getOwner(java.nio.file.Path $this$getOwner, java.nio.file.LinkOption... options) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$getOwner, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(options, "options");
    ...
    private static final java.nio.file.Path setOwner(java.nio.file.Path $this$setOwner, java.nio.file.attribute.UserPrincipal value) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$setOwner, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(value, "value");
    ...
    private static final java.util.Set<java.nio.file.attribute.PosixFilePermission> getPosixFilePermissions(java.nio.file.Path $this$getPosixFilePermissions, java.nio.file.LinkOption... options) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$getPosixFilePermissions, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(options, "options");
    ...
    private static final java.nio.file.Path setPosixFilePermissions(java.nio.file.Path $this$setPosixFilePermissions, java.util.Set<? extends java.nio.file.attribute.PosixFilePermission> value) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$setPosixFilePermissions, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(value, "value");
        java.nio.file.Path posixFilePermissions = java.nio.file.Files.setPosixFilePermissions($this$setPosixFilePermissions, value);
    ...
    private static final java.nio.file.Path createLinkPointingTo(java.nio.file.Path $this$createLinkPointingTo, java.nio.file.Path target) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$createLinkPointingTo, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(target, "target");
    ...
    private static final java.nio.file.Path createSymbolicLinkPointingTo(java.nio.file.Path $this$createSymbolicLinkPointingTo, java.nio.file.Path target, java.nio.file.attribute.FileAttribute<?>... attributes) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$createSymbolicLinkPointingTo, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(target, "target");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(attributes, "attributes");
        java.nio.file.Path pathCreateSymbolicLink = java.nio.file.Files.createSymbolicLink($this$createSymbolicLinkPointingTo, target, (java.nio.file.attribute.FileAttribute[]) java.util.Arrays.copyOf(attributes, attributes.length));
    ...
    private static final java.nio.file.Path readSymbolicLink(java.nio.file.Path $this$readSymbolicLink) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$readSymbolicLink, "<this>");
    ...
    private static final java.nio.file.Path createFile(java.nio.file.Path $this$createFile, java.nio.file.attribute.FileAttribute<?>... attributes) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$createFile, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(attributes, "attributes");
        java.nio.file.Path pathCreateFile = java.nio.file.Files.createFile($this$createFile, (java.nio.file.attribute.FileAttribute[]) java.util.Arrays.copyOf(attributes, attributes.length));
    ...
    private static final java.nio.file.Path createTempFile(java.lang.String prefix, java.lang.String suffix, java.nio.file.attribute.FileAttribute<?>... attributes) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(attributes, "attributes");
        java.nio.file.Path pathCreateTempFile = java.nio.file.Files.createTempFile(prefix, suffix, (java.nio.file.attribute.FileAttribute[]) java.util.Arrays.copyOf(attributes, attributes.length));
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(pathCreateTempFile, "createTempFile(...)");
        return pathCreateTempFile;
    ...
    public static final java.nio.file.Path createTempFile(java.nio.file.Path directory, java.lang.String prefix, java.lang.String suffix, java.nio.file.attribute.FileAttribute<?>... attributes) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(attributes, "attributes");
        if (directory != null) {
            java.nio.file.Path pathCreateTempFile = java.nio.file.Files.createTempFile(directory, prefix, suffix, (java.nio.file.attribute.FileAttribute[]) java.util.Arrays.copyOf(attributes, attributes.length));
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(pathCreateTempFile, "createTempFile(...)");
            return pathCreateTempFile;
        }
        java.nio.file.Path pathCreateTempFile2 = java.nio.file.Files.createTempFile(prefix, suffix, (java.nio.file.attribute.FileAttribute[]) java.util.Arrays.copyOf(attributes, attributes.length));
    ...
    private static final java.nio.file.Path createTempDirectory(java.lang.String prefix, java.nio.file.attribute.FileAttribute<?>... attributes) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(attributes, "attributes");
        java.nio.file.Path pathCreateTempDirectory = java.nio.file.Files.createTempDirectory(prefix, (java.nio.file.attribute.FileAttribute[]) java.util.Arrays.copyOf(attributes, attributes.length));
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(pathCreateTempDirectory, "createTempDirectory(...)");
        return pathCreateTempDirectory;
    ...
    public static final java.nio.file.Path createTempDirectory(java.nio.file.Path directory, java.lang.String prefix, java.nio.file.attribute.FileAttribute<?>... attributes) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(attributes, "attributes");
        if (directory != null) {
            java.nio.file.Path pathCreateTempDirectory = java.nio.file.Files.createTempDirectory(directory, prefix, (java.nio.file.attribute.FileAttribute[]) java.util.Arrays.copyOf(attributes, attributes.length));
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(pathCreateTempDirectory, "createTempDirectory(...)");
            return pathCreateTempDirectory;
        }
        java.nio.file.Path pathCreateTempDirectory2 = java.nio.file.Files.createTempDirectory(prefix, (java.nio.file.attribute.FileAttribute[]) java.util.Arrays.copyOf(attributes, attributes.length));
    ...
    private static final java.nio.file.Path div(java.nio.file.Path $this$div, java.nio.file.Path other) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$div, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(other, "other");
    ...
    private static final java.nio.file.Path toPath(java.net.URI $this$toPath) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$toPath, "<this>");
        java.nio.file.Path path = java.nio.file.Paths.get($this$toPath);
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(path, "get(...)");
        return path;
    }

    public static final kotlin.sequences.Sequence<java.nio.file.Path> walk(java.nio.file.Path $this$walk, kotlin.io.path.PathWalkOption... options) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$walk, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(options, "options");
        return new kotlin.io.path.PathTreeWalk($this$walk, options);
    }
    ...
    public static final void visitFileTree(java.nio.file.Path $this$visitFileTree, java.nio.file.FileVisitor<java.nio.file.Path> visitor, int maxDepth, boolean followLinks) throws java.io.IOException {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$visitFileTree, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(visitor, "visitor");
        java.util.Set options = followLinks ? kotlin.collections.SetsKt.setOf(java.nio.file.FileVisitOption.FOLLOW_LINKS) : kotlin.collections.SetsKt.emptySet();
        java.nio.file.Files.walkFileTree($this$visitFileTree, options, maxDepth, visitor);
    }
    ...
    public static final void visitFileTree(java.nio.file.Path $this$visitFileTree, int maxDepth, boolean followLinks, kotlin.jvm.functions.Function1<? super kotlin.io.path.FileVisitorBuilder, kotlin.Unit> builderAction) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$visitFileTree, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(builderAction, "builderAction");
        kotlin.io.path.PathsKt.visitFileTree($this$visitFileTree, kotlin.io.path.PathsKt.fileVisitor(builderAction), maxDepth, followLinks);
    }
