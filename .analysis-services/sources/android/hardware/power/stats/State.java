...
public class State implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.hardware.power.stats.State> CREATOR = new android.os.Parcelable.Creator<android.hardware.power.stats.State>() { // from class: android.hardware.power.stats.State.1
        ...
        public android.hardware.power.stats.State createFromParcel(android.os.Parcel _aidl_source) {
            android.hardware.power.stats.State _aidl_out = new android.hardware.power.stats.State();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.power.stats.State[] newArray(int _aidl_size) {
            return new android.hardware.power.stats.State[_aidl_size];
        }
    };
    public int id = 0;
