...
public interface IBiometricsFingerprint extends android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint {
    ...
    static android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprint asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        android.os.IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprint)) {
            return (android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprint) iface;
        }
        android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprint proxy = new android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprint.Proxy(binder);
        try {
    ...
    static android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprint castFrom(android.os.IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprint getService(java.lang.String serviceName, boolean retry) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprint getService(boolean retry) throws android.os.RemoteException {
        return getService("default", retry);
    }

    @java.lang.Deprecated
    static android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprint getService(java.lang.String serviceName) throws android.os.RemoteException {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprint {
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String descriptor) {
            if (android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprint.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
