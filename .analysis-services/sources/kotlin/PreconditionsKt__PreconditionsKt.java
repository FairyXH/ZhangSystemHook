...
class PreconditionsKt__PreconditionsKt extends kotlin.PreconditionsKt__AssertionsJVMKt {
    ...
    private static final void require(boolean value, kotlin.jvm.functions.Function0<? extends java.lang.Object> lazyMessage) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(lazyMessage, "lazyMessage");
        if (!value) {
            java.lang.Object message = lazyMessage.invoke();
    ...
    private static final void check(boolean value, kotlin.jvm.functions.Function0<? extends java.lang.Object> lazyMessage) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(lazyMessage, "lazyMessage");
        if (!value) {
            java.lang.Object message = lazyMessage.invoke();
