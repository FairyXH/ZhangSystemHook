...
public class DhcpOption implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.net.networkstack.aidl.dhcp.DhcpOption> CREATOR = new android.os.Parcelable.Creator<android.net.networkstack.aidl.dhcp.DhcpOption>() { // from class: android.net.networkstack.aidl.dhcp.DhcpOption.1
        ...
        public android.net.networkstack.aidl.dhcp.DhcpOption createFromParcel(android.os.Parcel _aidl_source) {
            android.net.networkstack.aidl.dhcp.DhcpOption _aidl_out = new android.net.networkstack.aidl.dhcp.DhcpOption();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.net.networkstack.aidl.dhcp.DhcpOption[] newArray(int _aidl_size) {
            return new android.net.networkstack.aidl.dhcp.DhcpOption[_aidl_size];
        }
    };
    public byte type = 0;
    public byte[] value;
    ...
    public java.lang.String toString() {
        ...
        _aidl_sj.add("value: " + java.util.Arrays.toString(this.value));
        return "DhcpOption" + _aidl_sj.toString();
    }
