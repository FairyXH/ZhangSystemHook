...
public final class HwcRect {
    ...
    public final boolean equals(java.lang.Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != vendor.pixelworks.hardware.display.V1_1.HwcRect.class) {
            return false;
        }
        vendor.pixelworks.hardware.display.V1_1.HwcRect other = (vendor.pixelworks.hardware.display.V1_1.HwcRect) otherObject;
    ...
    public static final java.util.ArrayList<vendor.pixelworks.hardware.display.V1_1.HwcRect> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<vendor.pixelworks.hardware.display.V1_1.HwcRect> _hidl_vec = new java.util.ArrayList<>();
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            vendor.pixelworks.hardware.display.V1_1.HwcRect _hidl_vec_element = new vendor.pixelworks.hardware.display.V1_1.HwcRect();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel parcel, java.util.ArrayList<vendor.pixelworks.hardware.display.V1_1.HwcRect> _hidl_vec) {
        android.os.HwBlob _hidl_blob = new android.os.HwBlob(16);
