...
public class CharsKt__CharJVMKt {
    ...
    @com.android.server.permission.jarjar.kotlin.DeprecatedSinceKotlin(warningSince = "1.5")
    @com.android.server.permission.jarjar.kotlin.Deprecated(message = "Use uppercaseChar() instead.", replaceWith = @com.android.server.permission.jarjar.kotlin.ReplaceWith(expression = "uppercaseChar()", imports = {}))
    ...
    public static final java.lang.String uppercase(char $this$uppercase, java.util.Locale locale) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(locale, com.android.server.voiceinteraction.DatabaseHelper.SoundModelContract.KEY_LOCALE);
        java.lang.String strValueOf = java.lang.String.valueOf($this$uppercase);
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNull(strValueOf, "null cannot be cast to non-null type java.lang.String");
    ...
    @com.android.server.permission.jarjar.kotlin.DeprecatedSinceKotlin(warningSince = "1.5")
    @com.android.server.permission.jarjar.kotlin.Deprecated(message = "Use lowercaseChar() instead.", replaceWith = @com.android.server.permission.jarjar.kotlin.ReplaceWith(expression = "lowercaseChar()", imports = {}))
    ...
    @com.android.server.permission.jarjar.kotlin.DeprecatedSinceKotlin(warningSince = "1.5")
    @com.android.server.permission.jarjar.kotlin.Deprecated(message = "Use titlecaseChar() instead.", replaceWith = @com.android.server.permission.jarjar.kotlin.ReplaceWith(expression = "titlecaseChar()", imports = {}))
    ...
    public static final java.lang.String titlecase(char $this$titlecase, java.util.Locale locale) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(locale, com.android.server.voiceinteraction.DatabaseHelper.SoundModelContract.KEY_LOCALE);
        java.lang.String localizedUppercase = com.android.server.permission.jarjar.kotlin.text.CharsKt.uppercase($this$titlecase, locale);
        if (localizedUppercase.length() > 1) {
            if ($this$titlecase == 329) {
                return localizedUppercase;
            }
            char cCharAt = localizedUppercase.charAt(0);
            com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNull(localizedUppercase, "null cannot be cast to non-null type java.lang.String");
        ...
        java.lang.String upperCase = strValueOf.toUpperCase(java.util.Locale.ROOT);
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(upperCase, "toUpperCase(...)");
        if (!com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.areEqual(localizedUppercase, upperCase)) {
            return localizedUppercase;
        }
        return java.lang.String.valueOf(java.lang.Character.toTitleCase($this$titlecase));
    }

    public static final com.android.server.permission.jarjar.kotlin.text.CharDirectionality getDirectionality(char $this$directionality) {
        return com.android.server.permission.jarjar.kotlin.text.CharDirectionality.Companion.valueOf(java.lang.Character.getDirectionality($this$directionality));
    }
