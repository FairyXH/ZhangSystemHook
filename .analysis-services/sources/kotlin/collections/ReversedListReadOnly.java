...
class ReversedListReadOnly<T> extends kotlin.collections.AbstractList<T> {
    ...
    public static final class AnonymousClass1 implements java.util.ListIterator<T>, kotlin.jvm.internal.markers.KMappedMarker {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        AnonymousClass1(kotlin.collections.ReversedListReadOnly<? extends T> reversedListReadOnly, int $index) {
            this.this$0 = reversedListReadOnly;
            this.delegateIterator = ((kotlin.collections.ReversedListReadOnly) reversedListReadOnly).delegate.listIterator(kotlin.collections.CollectionsKt__ReversedViewsKt.reversePositionIndex$CollectionsKt__ReversedViewsKt(reversedListReadOnly, $index));
        }
