...
class DurationUnitKt__DurationUnitKt extends kotlin.time.DurationUnitKt__DurationUnitJvmKt {
    ...
    public static final java.lang.String shortName(kotlin.time.DurationUnit $this$shortName) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$shortName, "<this>");
        switch (kotlin.time.DurationUnitKt__DurationUnitKt.WhenMappings.$EnumSwitchMapping$0[$this$shortName.ordinal()]) {
            case 1:
                return "ns";
            case 2:
                return "us";
