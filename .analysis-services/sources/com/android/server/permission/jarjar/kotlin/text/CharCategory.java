...
public enum CharCategory {
    ...
    public static final com.android.server.permission.jarjar.kotlin.text.CharCategory.Companion Companion = new com.android.server.permission.jarjar.kotlin.text.CharCategory.Companion(null);

    public static com.android.server.permission.jarjar.kotlin.enums.EnumEntries<com.android.server.permission.jarjar.kotlin.text.CharCategory> getEntries() {
        return $ENTRIES;
    }

    CharCategory(int value, java.lang.String code) {
        this.value = value;
        this.code = code;
    }
    ...
    public static final class Companion {
        ...
        public final com.android.server.permission.jarjar.kotlin.text.CharCategory valueOf(int category) {
            if (new com.android.server.permission.jarjar.kotlin.ranges.IntRange(0, 16).contains(category)) {
                return com.android.server.permission.jarjar.kotlin.text.CharCategory.getEntries().get(category);
            }
            if (new com.android.server.permission.jarjar.kotlin.ranges.IntRange(18, 30).contains(category)) {
                return com.android.server.permission.jarjar.kotlin.text.CharCategory.getEntries().get(category - 1);
            }
