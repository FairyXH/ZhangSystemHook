...
public final class ChannelLimitedFlowMerge<T> extends kotlinx.coroutines.flow.internal.ChannelFlow<T> {
    ...
    public ChannelLimitedFlowMerge(java.lang.Iterable<? extends kotlinx.coroutines.flow.Flow<? extends T>> flows, kotlin.coroutines.CoroutineContext context, int capacity, kotlinx.coroutines.channels.BufferOverflow onBufferOverflow) {
    ...
    protected java.lang.Object collectTo(kotlinx.coroutines.channels.ProducerScope<? super T> producerScope, kotlin.coroutines.Continuation<? super kotlin.Unit> continuation) {
        ...
        for (java.lang.Object element$iv : this.flows) {
            kotlinx.coroutines.BuildersKt__Builders_commonKt.launch$default(producerScope, null, null, new kotlinx.coroutines.flow.internal.ChannelLimitedFlowMerge$collectTo$2$1((kotlinx.coroutines.flow.Flow) element$iv, collector, null), 3, null);
        }
