...
public final class ModelParameterRange {
    ...
    public final boolean equals(java.lang.Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != android.hardware.soundtrigger.V2_3.ModelParameterRange.class) {
            return false;
        }
    ...
    public static final java.util.ArrayList<android.hardware.soundtrigger.V2_3.ModelParameterRange> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<android.hardware.soundtrigger.V2_3.ModelParameterRange> _hidl_vec = new java.util.ArrayList<>();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel parcel, java.util.ArrayList<android.hardware.soundtrigger.V2_3.ModelParameterRange> _hidl_vec) {
