...
public class XmlParser {
    public static com.android.server.compat.config.Config read(java.io.InputStream in) throws org.xmlpull.v1.XmlPullParserException, javax.xml.datatype.DatatypeConfigurationException, java.io.IOException {
        ...
        if (!_tagName.equals("config")) {
            return null;
        }
        com.android.server.compat.config.Config _value = com.android.server.compat.config.Config.read(_parser);
        return _value;
    }
