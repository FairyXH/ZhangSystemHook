...
public interface IBootControl extends android.hardware.boot.V1_1.IBootControl {
    ...
    static android.hardware.boot.V1_2.IBootControl asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        android.os.IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof android.hardware.boot.V1_2.IBootControl)) {
            return (android.hardware.boot.V1_2.IBootControl) iface;
        }
        android.hardware.boot.V1_2.IBootControl proxy = new android.hardware.boot.V1_2.IBootControl.Proxy(binder);
        try {
    ...
    static android.hardware.boot.V1_2.IBootControl castFrom(android.os.IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static android.hardware.boot.V1_2.IBootControl getService(java.lang.String serviceName, boolean retry) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static android.hardware.boot.V1_2.IBootControl getService(boolean retry) throws android.os.RemoteException {
        return getService("default", retry);
    }

    @java.lang.Deprecated
    static android.hardware.boot.V1_2.IBootControl getService(java.lang.String serviceName) throws android.os.RemoteException {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.boot.V1_2.IBootControl {
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String descriptor) {
            if (android.hardware.boot.V1_2.IBootControl.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
