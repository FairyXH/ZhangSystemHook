...
public abstract class PrimitiveSpreadBuilder<T> {
    ...
    protected final T toArray(T values, T result) {
        ...
        while (it.hasNext()) {
            ...
            if (t != null) {
                if (copyValuesFrom < i) {
                    java.lang.System.arraycopy(values, copyValuesFrom, result, dstIndex, i - copyValuesFrom);
                    dstIndex += i - copyValuesFrom;
                }
                int spreadSize = getSize(t);
                java.lang.System.arraycopy(t, 0, result, dstIndex, spreadSize);
                dstIndex += spreadSize;
                copyValuesFrom = i + 1;
            }
        }
        if (copyValuesFrom < this.size) {
            java.lang.System.arraycopy(values, copyValuesFrom, result, dstIndex, this.size - copyValuesFrom);
        }
        return result;
    }
}
