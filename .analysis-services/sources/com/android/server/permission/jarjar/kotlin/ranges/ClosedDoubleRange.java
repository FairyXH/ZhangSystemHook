...
final class ClosedDoubleRange implements com.android.server.permission.jarjar.kotlin.ranges.ClosedFloatingPointRange<java.lang.Double> {
    ...
    public boolean equals(java.lang.Object other) {
        if (!(other instanceof com.android.server.permission.jarjar.kotlin.ranges.ClosedDoubleRange)) {
            return false;
        }
        if (!isEmpty() || !((com.android.server.permission.jarjar.kotlin.ranges.ClosedDoubleRange) other).isEmpty()) {
            if (!(this._start == ((com.android.server.permission.jarjar.kotlin.ranges.ClosedDoubleRange) other)._start)) {
                return false;
            }
            if (!(this._endInclusive == ((com.android.server.permission.jarjar.kotlin.ranges.ClosedDoubleRange) other)._endInclusive)) {
                return false;
            }
        }
        return true;
