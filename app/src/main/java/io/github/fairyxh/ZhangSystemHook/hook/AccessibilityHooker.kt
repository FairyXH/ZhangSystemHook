    ...
    private fun hookAccessibility() {
        ...
        "com.android.server.accessibility.AccessibilityManagerService".toClass().apply {
            method {
                ...
                before {
                    if ((ConfigData.blockApps.contains(pkgName()) || isSystemApp(pkgName())) && !(pkgName() == BuildConfig.APPLICATION_ID)) return@before
            ...
            method {
                ...
                after {
                    ...
                    secureKeys[args(3).string()]?.also { method ->
                        if ((ConfigData.blockApps.contains(pkgName()) || isSystemApp(pkgName())) && !(pkgName() == BuildConfig.APPLICATION_ID)) return@after
