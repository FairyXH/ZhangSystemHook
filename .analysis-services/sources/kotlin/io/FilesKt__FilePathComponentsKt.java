...
class FilesKt__FilePathComponentsKt {
    private static final int getRootLength$FilesKt__FilePathComponentsKt(java.lang.String $this$getRootLength) {
        int first;
        int first2 = kotlin.text.StringsKt.indexOf$default((java.lang.CharSequence) $this$getRootLength, java.io.File.separatorChar, 0, false, 4, (java.lang.Object) null);
        if (first2 == 0) {
            if ($this$getRootLength.length() <= 1 || $this$getRootLength.charAt(1) != java.io.File.separatorChar || (first = kotlin.text.StringsKt.indexOf$default((java.lang.CharSequence) $this$getRootLength, java.io.File.separatorChar, 2, false, 4, (java.lang.Object) null)) < 0) {
                return 1;
            }
            int first3 = kotlin.text.StringsKt.indexOf$default((java.lang.CharSequence) $this$getRootLength, java.io.File.separatorChar, first + 1, false, 4, (java.lang.Object) null);
            if (first3 >= 0) {
                return first3 + 1;
            }
        ...
        if (first2 == -1 && kotlin.text.StringsKt.endsWith$default((java.lang.CharSequence) $this$getRootLength, ':', false, 2, (java.lang.Object) null)) {
            return $this$getRootLength.length();
        }
        return 0;
    }
    ...
    public static final java.lang.String getRootName(java.io.File $this$rootName) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$rootName, "<this>");
    ...
    public static final java.io.File getRoot(java.io.File $this$root) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$root, "<this>");
        return new java.io.File(kotlin.io.FilesKt.getRootName($this$root));
    }

    public static final boolean isRooted(java.io.File $this$isRooted) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$isRooted, "<this>");
        java.lang.String path = $this$isRooted.getPath();
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(path, "getPath(...)");
        return getRootLength$FilesKt__FilePathComponentsKt(path) > 0;
    }

    public static final kotlin.io.FilePathComponents toComponents(java.io.File $this$toComponents) {
        java.util.List list;
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$toComponents, "<this>");
        ...
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(rootName, "substring(...)");
        java.lang.String subPath = path.substring(rootLength);
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(subPath, "substring(...)");
        if (subPath.length() == 0) {
            list = kotlin.collections.CollectionsKt.emptyList();
        } else {
            java.lang.Iterable $this$map$iv = kotlin.text.StringsKt.split$default((java.lang.CharSequence) subPath, new char[]{java.io.File.separatorChar}, false, 0, 6, (java.lang.Object) null);
    ...
    public static final java.io.File subPath(java.io.File $this$subPath, int beginIndex, int endIndex) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$subPath, "<this>");
        return kotlin.io.FilesKt.toComponents($this$subPath).subPath(beginIndex, endIndex);
    }
}
