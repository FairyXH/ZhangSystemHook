...
public class LidSwitchCondition {
    ...
    static com.android.server.policy.devicestate.config.LidSwitchCondition read(org.xmlpull.v1.XmlPullParser _parser) throws org.xmlpull.v1.XmlPullParserException, javax.xml.datatype.DatatypeConfigurationException, java.io.IOException {
        int type;
        com.android.server.policy.devicestate.config.LidSwitchCondition _instance = new com.android.server.policy.devicestate.config.LidSwitchCondition();
        _parser.getDepth();
        while (true) {
            type = _parser.next();
            if (type == 1 || type == 3) {
