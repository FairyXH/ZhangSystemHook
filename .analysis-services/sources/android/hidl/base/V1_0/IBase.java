...
public interface IBase extends android.os.IHwInterface {
    ...
    static android.hidl.base.V1_0.IBase asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        android.os.IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof android.hidl.base.V1_0.IBase)) {
            return (android.hidl.base.V1_0.IBase) iface;
        }
        android.hidl.base.V1_0.IBase proxy = new android.hidl.base.V1_0.IBase.Proxy(binder);
        try {
    ...
    static android.hidl.base.V1_0.IBase castFrom(android.os.IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static android.hidl.base.V1_0.IBase getService(java.lang.String serviceName, boolean retry) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static android.hidl.base.V1_0.IBase getService(boolean retry) throws android.os.RemoteException {
        return getService("default", retry);
    }

    @java.lang.Deprecated
    static android.hidl.base.V1_0.IBase getService(java.lang.String serviceName) throws android.os.RemoteException {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hidl.base.V1_0.IBase {
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String descriptor) {
            if (android.hidl.base.V1_0.IBase.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
