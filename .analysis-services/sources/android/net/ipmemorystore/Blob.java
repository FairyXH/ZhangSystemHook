...
public class Blob implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.net.ipmemorystore.Blob> CREATOR = new android.os.Parcelable.Creator<android.net.ipmemorystore.Blob>() { // from class: android.net.ipmemorystore.Blob.1
        ...
        public android.net.ipmemorystore.Blob createFromParcel(android.os.Parcel _aidl_source) {
            android.net.ipmemorystore.Blob _aidl_out = new android.net.ipmemorystore.Blob();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.net.ipmemorystore.Blob[] newArray(int _aidl_size) {
            return new android.net.ipmemorystore.Blob[_aidl_size];
        }
    };
    public byte[] data;
