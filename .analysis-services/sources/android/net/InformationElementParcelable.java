...
public class InformationElementParcelable implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.net.InformationElementParcelable> CREATOR = new android.os.Parcelable.Creator<android.net.InformationElementParcelable>() { // from class: android.net.InformationElementParcelable.1
        ...
        public android.net.InformationElementParcelable createFromParcel(android.os.Parcel _aidl_source) {
            android.net.InformationElementParcelable _aidl_out = new android.net.InformationElementParcelable();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.net.InformationElementParcelable[] newArray(int _aidl_size) {
            return new android.net.InformationElementParcelable[_aidl_size];
        }
    };
    public int id = 0;
    public byte[] payload;
    ...
    public java.lang.String toString() {
        ...
        return "InformationElementParcelable" + _aidl_sj.toString();
    }
