...
public class SessionIdSignature implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.hardware.security.authgraph.SessionIdSignature> CREATOR = new android.os.Parcelable.Creator<android.hardware.security.authgraph.SessionIdSignature>() { // from class: android.hardware.security.authgraph.SessionIdSignature.1
        ...
        public android.hardware.security.authgraph.SessionIdSignature createFromParcel(android.os.Parcel _aidl_source) {
            android.hardware.security.authgraph.SessionIdSignature _aidl_out = new android.hardware.security.authgraph.SessionIdSignature();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.security.authgraph.SessionIdSignature[] newArray(int _aidl_size) {
            return new android.hardware.security.authgraph.SessionIdSignature[_aidl_size];
        }
    };
