...
public interface ISurfaceFlingerConfigs extends android.hidl.base.V1_0.IBase {
    ...
    static android.hardware.configstore.V1_0.ISurfaceFlingerConfigs asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        android.os.IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof android.hardware.configstore.V1_0.ISurfaceFlingerConfigs)) {
            return (android.hardware.configstore.V1_0.ISurfaceFlingerConfigs) iface;
        }
        android.hardware.configstore.V1_0.ISurfaceFlingerConfigs proxy = new android.hardware.configstore.V1_0.ISurfaceFlingerConfigs.Proxy(binder);
        try {
    ...
    static android.hardware.configstore.V1_0.ISurfaceFlingerConfigs castFrom(android.os.IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static android.hardware.configstore.V1_0.ISurfaceFlingerConfigs getService(java.lang.String serviceName, boolean retry) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static android.hardware.configstore.V1_0.ISurfaceFlingerConfigs getService(boolean retry) throws android.os.RemoteException {
        return getService("default", retry);
    }

    @java.lang.Deprecated
    static android.hardware.configstore.V1_0.ISurfaceFlingerConfigs getService(java.lang.String serviceName) throws android.os.RemoteException {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.configstore.V1_0.ISurfaceFlingerConfigs {
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String descriptor) {
            if (android.hardware.configstore.V1_0.ISurfaceFlingerConfigs.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
