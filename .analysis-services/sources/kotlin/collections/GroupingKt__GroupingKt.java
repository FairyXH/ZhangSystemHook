...
class GroupingKt__GroupingKt extends kotlin.collections.GroupingKt__GroupingJVMKt {
    public static final <T, K, R> java.util.Map<K, R> aggregate(kotlin.collections.Grouping<T, ? extends K> grouping, kotlin.jvm.functions.Function4<? super K, ? super R, ? super T, ? super java.lang.Boolean, ? extends R> operation) {
        ...
        while (itSourceIterator.hasNext()) {
            ...
            linkedHashMap.put(key$iv, operation.invoke(key$iv, accumulator$iv, next, java.lang.Boolean.valueOf(accumulator$iv == null && !linkedHashMap.containsKey(key$iv))));
        }
    ...
    public static final <T, K, R, M extends java.util.Map<? super K, R>> M aggregateTo(kotlin.collections.Grouping<T, ? extends K> grouping, M destination, kotlin.jvm.functions.Function4<? super K, ? super R, ? super T, ? super java.lang.Boolean, ? extends R> operation) {
        ...
        while (itSourceIterator.hasNext()) {
            ...
            destination.put(key, operation.invoke(key, accumulator, next, java.lang.Boolean.valueOf(accumulator == null && !destination.containsKey(key))));
        }
        return destination;
    }

    public static final <T, K, R> java.util.Map<K, R> fold(kotlin.collections.Grouping<T, ? extends K> grouping, kotlin.jvm.functions.Function2<? super K, ? super T, ? extends R> function2, kotlin.jvm.functions.Function3<? super K, ? super R, ? super T, ? extends R> operation) {
        int $i$f$fold;
        java.lang.Object key;
        java.lang.Object objInvoke;
        kotlin.jvm.functions.Function2<? super K, ? super T, ? extends R> initialValueSelector = function2;
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(grouping, "<this>");
    ...
    public static final <T, K, R, M extends java.util.Map<? super K, R>> M foldTo(kotlin.collections.Grouping<T, ? extends K> grouping, M destination, kotlin.jvm.functions.Function2<? super K, ? super T, ? extends R> function2, kotlin.jvm.functions.Function3<? super K, ? super R, ? super T, ? extends R> operation) {
        kotlin.jvm.functions.Function2<? super K, ? super T, ? extends R> initialValueSelector = function2;
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(grouping, "<this>");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(destination, "destination");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(initialValueSelector, "initialValueSelector");
    ...
    public static final <T, K, R, M extends java.util.Map<? super K, R>> M foldTo(kotlin.collections.Grouping<T, ? extends K> grouping, M destination, R r, kotlin.jvm.functions.Function2<? super R, ? super T, ? extends R> operation) {
        ...
        while (itSourceIterator.hasNext()) {
            T next = itSourceIterator.next();
            K kKeyOf = grouping.keyOf(next);
            java.lang.Object accumulator$iv = destination.get(kKeyOf);
    ...
    public static final <T, K, M extends java.util.Map<? super K, java.lang.Integer>> M eachCountTo(kotlin.collections.Grouping<T, ? extends K> grouping, M destination) {
        ...
        while (itSourceIterator.hasNext()) {
            ...
            java.lang.Object accumulator$iv$iv = destination.get(kKeyOf);
            ...
            destination.put(kKeyOf, java.lang.Integer.valueOf(acc + 1));
        }
        return destination;
    }
}
