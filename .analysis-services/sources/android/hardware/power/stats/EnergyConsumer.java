...
public class EnergyConsumer implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.hardware.power.stats.EnergyConsumer> CREATOR = new android.os.Parcelable.Creator<android.hardware.power.stats.EnergyConsumer>() { // from class: android.hardware.power.stats.EnergyConsumer.1
        ...
        public android.hardware.power.stats.EnergyConsumer createFromParcel(android.os.Parcel _aidl_source) {
            android.hardware.power.stats.EnergyConsumer _aidl_out = new android.hardware.power.stats.EnergyConsumer();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.power.stats.EnergyConsumer[] newArray(int _aidl_size) {
            return new android.hardware.power.stats.EnergyConsumer[_aidl_size];
        }
    };
