...
public final class FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1<R> implements kotlinx.coroutines.flow.Flow<R> {
    ...
    public static final class AnonymousClass2<T> implements kotlinx.coroutines.flow.FlowCollector {
        ...
        @kotlin.coroutines.jvm.internal.DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1$2", f = "Transform.kt", i = {0}, l = {com.android.internal.util.FrameworkStatsLog.EXCLUSION_RECT_STATE_CHANGED, com.android.server.usb.descriptors.UsbDescriptor.CLASSID_WIRELESS}, m = "emit", n = {"$this$mapNotNull_u24lambda_u246"}, s = {"L$0"})
        ...
        */
        ...
        public final java.lang.Object emit$$forInline(java.lang.Object value, kotlin.coroutines.Continuation $completion) {
            ...
            new kotlinx.coroutines.flow.FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1.AnonymousClass2.AnonymousClass1($completion);
            kotlin.jvm.internal.InlineMarker.mark(5);
            kotlinx.coroutines.flow.FlowCollector flowCollector = this.$this_unsafeFlow;
            java.lang.Object transformed = this.$transform$inlined.invoke(value, $completion);
            if (transformed != null) {
    ...
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector collector, kotlin.coroutines.Continuation $completion) {
        java.lang.Object objCollect = this.$this_unsafeTransform$inlined.collect(new kotlinx.coroutines.flow.FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1.AnonymousClass2(collector, this.$transform$inlined$1), $completion);
    ...
    public java.lang.Object collect$$forInline(kotlinx.coroutines.flow.FlowCollector collector, kotlin.coroutines.Continuation $completion) {
        kotlin.jvm.internal.InlineMarker.mark(4);
        new kotlin.coroutines.jvm.internal.ContinuationImpl($completion) { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1.1
            int label;
            /* synthetic */ java.lang.Object result;
        ...
        kotlinx.coroutines.flow.FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1.AnonymousClass2 anonymousClass2 = new kotlinx.coroutines.flow.FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1.AnonymousClass2(collector, this.$transform$inlined$1);
        kotlin.jvm.internal.InlineMarker.mark(0);
