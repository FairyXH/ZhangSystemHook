...
public interface CopyActionContext {
    com.android.server.permission.jarjar.kotlin.io.path.CopyActionResult copyToIgnoringExistingDirectory(java.nio.file.Path path, java.nio.file.Path path2, boolean z);
}
