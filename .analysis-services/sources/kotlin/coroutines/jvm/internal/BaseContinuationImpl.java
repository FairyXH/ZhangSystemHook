...
public abstract class BaseContinuationImpl implements kotlin.coroutines.Continuation<java.lang.Object>, kotlin.coroutines.jvm.internal.CoroutineStackFrame, java.io.Serializable {
    ...
    public final void resumeWith(java.lang.Object result) {
        ...
        while (true) {
            kotlin.coroutines.jvm.internal.DebugProbesKt.probeCoroutineResumed((kotlin.coroutines.Continuation) current);
            kotlin.coroutines.jvm.internal.BaseContinuationImpl $this$resumeWith_u24lambda_u240 = (kotlin.coroutines.jvm.internal.BaseContinuationImpl) current;
            kotlin.coroutines.Continuation<java.lang.Object> continuation = $this$resumeWith_u24lambda_u240.completion;
            ...
            try {
                ...
                objM11307constructorimpl = kotlin.Result.m11307constructorimpl(kotlin.ResultKt.createFailure(exception));
            }
            if (outcome == kotlin.coroutines.intrinsics.IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                return;
            }
            kotlin.Result.Companion companion2 = kotlin.Result.INSTANCE;
            objM11307constructorimpl = kotlin.Result.m11307constructorimpl(outcome);
            java.lang.Object outcome2 = objM11307constructorimpl;
            $this$resumeWith_u24lambda_u240.releaseIntercepted();
            if (continuation instanceof kotlin.coroutines.jvm.internal.BaseContinuationImpl) {
