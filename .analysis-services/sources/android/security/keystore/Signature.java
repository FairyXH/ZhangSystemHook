...
public class Signature implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.security.keystore.Signature> CREATOR = new android.os.Parcelable.Creator<android.security.keystore.Signature>() { // from class: android.security.keystore.Signature.1
        ...
        public android.security.keystore.Signature createFromParcel(android.os.Parcel _aidl_source) {
            android.security.keystore.Signature _aidl_out = new android.security.keystore.Signature();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.security.keystore.Signature[] newArray(int _aidl_size) {
            return new android.security.keystore.Signature[_aidl_size];
        }
    };
    public byte[] data;
