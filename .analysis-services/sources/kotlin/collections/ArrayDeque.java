...
public final class ArrayDeque<E> extends kotlin.collections.AbstractMutableList<E> {
    ...
    public ArrayDeque(java.util.Collection<? extends E> elements) {
        ...
        this.elementData = elements.toArray(new java.lang.Object[0]);
    ...
    private final void ensureCapacity(int minCapacity) {
        ...
        if (this.elementData == emptyElementData) {
            ...
            int newCapacity = kotlin.collections.AbstractList.INSTANCE.newCapacity$kotlin_stdlib(this.elementData.length, minCapacity);
    ...
    private final void copyElements(int newCapacity) {
        ...
        kotlin.collections.ArraysKt.copyInto(this.elementData, newElements, 0, this.head, this.elementData.length);
        kotlin.collections.ArraysKt.copyInto(this.elementData, newElements, this.elementData.length - this.head, 0, this.head);
        this.head = 0;
    ...
    public void add(int index, E element) {
        ...
        if (index < ((size() + 1) >> 1)) {
            ...
            if (decrementedInternalIndex >= this.head) {
                ...
                kotlin.collections.ArraysKt.copyInto(this.elementData, this.elementData, this.head, this.head + 1, decrementedInternalIndex + 1);
            } else {
                kotlin.collections.ArraysKt.copyInto(this.elementData, this.elementData, this.head - 1, this.head, this.elementData.length);
                this.elementData[this.elementData.length - 1] = this.elementData[0];
                kotlin.collections.ArraysKt.copyInto(this.elementData, this.elementData, 0, 1, decrementedInternalIndex + 1);
            }
            ...
            if (internalIndex < tail) {
                kotlin.collections.ArraysKt.copyInto(this.elementData, this.elementData, internalIndex + 1, internalIndex, tail);
            } else {
                kotlin.collections.ArraysKt.copyInto(this.elementData, this.elementData, 1, 0, tail);
                this.elementData[0] = this.elementData[this.elementData.length - 1];
                kotlin.collections.ArraysKt.copyInto(this.elementData, this.elementData, internalIndex + 1, internalIndex, this.elementData.length - 1);
            }
    ...
    public boolean addAll(int index, java.util.Collection<? extends E> elements) {
        ...
        if (index < ((size() + 1) >> 1)) {
            ...
            if (internalIndex >= this.head) {
                if (shiftedHead >= 0) {
                    kotlin.collections.ArraysKt.copyInto(this.elementData, this.elementData, shiftedHead, this.head, internalIndex);
                } else {
                    ...
                    if (shiftToBack >= elementsToShift) {
                        ...
                        kotlin.collections.ArraysKt.copyInto(this.elementData, this.elementData, shiftedHead, this.head, this.head + shiftToBack);
                        kotlin.collections.ArraysKt.copyInto(this.elementData, this.elementData, 0, this.head + shiftToBack, internalIndex);
                    }
                }
            } else {
                kotlin.collections.ArraysKt.copyInto(this.elementData, this.elementData, shiftedHead, this.head, this.elementData.length);
                if (elementsSize >= internalIndex) {
                    kotlin.collections.ArraysKt.copyInto(this.elementData, this.elementData, this.elementData.length - elementsSize, 0, internalIndex);
                } else {
                    kotlin.collections.ArraysKt.copyInto(this.elementData, this.elementData, this.elementData.length - elementsSize, 0, elementsSize);
                    kotlin.collections.ArraysKt.copyInto(this.elementData, this.elementData, 0, elementsSize, internalIndex);
                }
            }
            ...
            if (internalIndex < tail) {
                if (tail + elementsSize <= this.elementData.length) {
                    kotlin.collections.ArraysKt.copyInto(this.elementData, this.elementData, shiftedInternalIndex, internalIndex, tail);
                } else if (shiftedInternalIndex >= this.elementData.length) {
                    kotlin.collections.ArraysKt.copyInto(this.elementData, this.elementData, shiftedInternalIndex - this.elementData.length, internalIndex, tail);
                } else {
                    int shiftToFront = (tail + elementsSize) - this.elementData.length;
                    kotlin.collections.ArraysKt.copyInto(this.elementData, this.elementData, 0, tail - shiftToFront, tail);
                    kotlin.collections.ArraysKt.copyInto(this.elementData, this.elementData, shiftedInternalIndex, internalIndex, tail - shiftToFront);
                }
            } else {
                kotlin.collections.ArraysKt.copyInto(this.elementData, this.elementData, elementsSize, 0, tail);
                if (shiftedInternalIndex >= this.elementData.length) {
                    kotlin.collections.ArraysKt.copyInto(this.elementData, this.elementData, shiftedInternalIndex - this.elementData.length, internalIndex, this.elementData.length);
                } else {
                    kotlin.collections.ArraysKt.copyInto(this.elementData, this.elementData, 0, this.elementData.length - elementsSize, this.elementData.length);
                    kotlin.collections.ArraysKt.copyInto(this.elementData, this.elementData, shiftedInternalIndex, internalIndex, this.elementData.length - elementsSize);
                }
            }
    ...
    public int indexOf(java.lang.Object element) {
        ...
        if (this.head < tail) {
            for (int index = this.head; index < tail; index++) {
                if (kotlin.jvm.internal.Intrinsics.areEqual(element, this.elementData[index])) {
        ...
        if (index2 >= tail) {
            ...
            for (int index3 = this.head; index3 < length; index3++) {
                if (kotlin.jvm.internal.Intrinsics.areEqual(element, this.elementData[index3])) {
                    return index3 - this.head;
                }
            }
            for (int index4 = 0; index4 < tail; index4++) {
                if (kotlin.jvm.internal.Intrinsics.areEqual(element, this.elementData[index4])) {
    ...
    public int lastIndexOf(java.lang.Object element) {
        ...
        if (this.head < tail) {
            ...
            int i = this.head;
            if (i <= index) {
                while (!kotlin.jvm.internal.Intrinsics.areEqual(element, this.elementData[index])) {
                    if (index != i) {
                        index--;
                    }
                }
            ...
            if (index2 > tail) {
                ...
                int index4 = kotlin.collections.ArraysKt.getLastIndex(this.elementData);
                int i2 = this.head;
                if (i2 <= index4) {
                    while (!kotlin.jvm.internal.Intrinsics.areEqual(element, this.elementData[index4])) {
                        if (index4 != i2) {
                            index4--;
                        }
                    }
    ...
    public E removeAt(int index) {
        ...
        if (index < (size() >> 1)) {
            if (iPositiveMod >= this.head) {
                kotlin.collections.ArraysKt.copyInto(this.elementData, this.elementData, this.head + 1, this.head, iPositiveMod);
            } else {
                kotlin.collections.ArraysKt.copyInto(this.elementData, this.elementData, 1, 0, iPositiveMod);
                this.elementData[0] = this.elementData[this.elementData.length - 1];
                kotlin.collections.ArraysKt.copyInto(this.elementData, this.elementData, this.head + 1, this.head, this.elementData.length - 1);
            }
            this.elementData[this.head] = null;
            this.head = incremented(this.head);
        } else {
            ...
            if (iPositiveMod <= iPositiveMod2) {
                kotlin.collections.ArraysKt.copyInto(this.elementData, this.elementData, iPositiveMod, iPositiveMod + 1, iPositiveMod2 + 1);
            } else {
                kotlin.collections.ArraysKt.copyInto(this.elementData, this.elementData, iPositiveMod, iPositiveMod + 1, this.elementData.length);
                this.elementData[this.elementData.length - 1] = this.elementData[0];
                kotlin.collections.ArraysKt.copyInto(this.elementData, this.elementData, 0, 1, iPositiveMod2 + 1);
            }
        ...
        if (!isEmpty()) {
            if (!(this.elementData.length == 0)) {
                ...
                if (this.head < tail$iv) {
                    ...
                    kotlin.collections.ArraysKt.fill(this.elementData, (java.lang.Object) null, newTail$iv2, tail$iv);
        ...
        if (!isEmpty()) {
            if (!(this.elementData.length == 0)) {
                ...
                if (this.head < tail) {
                    ...
                    kotlin.collections.ArraysKt.fill(this.elementData, (java.lang.Object) null, newTail, tail);
                } else {
                    int length = this.elementData.length;
    ...
    public void clear() {
        int tail = positiveMod(this.head + size());
        if (this.head < tail) {
            kotlin.collections.ArraysKt.fill(this.elementData, (java.lang.Object) null, this.head, tail);
        } else if (!isEmpty()) {
            kotlin.collections.ArraysKt.fill(this.elementData, (java.lang.Object) null, this.head, this.elementData.length);
            kotlin.collections.ArraysKt.fill(this.elementData, (java.lang.Object) null, 0, tail);
        }
        this.head = 0;
        this.size = 0;
    }
    ...
    public <T> T[] toArray(T[] array) {
        ...
        java.lang.Object[] objArrArrayOfNulls = array.length >= size() ? array : kotlin.collections.ArraysKt.arrayOfNulls(array, size());
        int iPositiveMod = positiveMod(this.head + size());
        if (this.head < iPositiveMod) {
            kotlin.collections.ArraysKt.copyInto$default(this.elementData, objArrArrayOfNulls, 0, this.head, iPositiveMod, 2, (java.lang.Object) null);
        } else if (!isEmpty()) {
            kotlin.collections.ArraysKt.copyInto(this.elementData, objArrArrayOfNulls, 0, this.head, this.elementData.length);
            kotlin.collections.ArraysKt.copyInto(this.elementData, objArrArrayOfNulls, this.elementData.length - this.head, 0, iPositiveMod);
        }
        return (T[]) kotlin.collections.CollectionsKt.terminateCollectionToArray(size(), objArrArrayOfNulls);
    }
    ...
    public final void internalStructure$kotlin_stdlib(kotlin.jvm.functions.Function2<? super java.lang.Integer, ? super java.lang.Object[], kotlin.Unit> structure) {
        ...
        structure.invoke(java.lang.Integer.valueOf(head), toArray());
    }
}
