...
public class ResolverParamsParcel implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.net.ResolverParamsParcel> CREATOR = new android.os.Parcelable.Creator<android.net.ResolverParamsParcel>() { // from class: android.net.ResolverParamsParcel.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.net.ResolverParamsParcel createFromParcel(android.os.Parcel _aidl_source) {
            android.net.ResolverParamsParcel _aidl_out = new android.net.ResolverParamsParcel();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.net.ResolverParamsParcel[] newArray(int _aidl_size) {
            return new android.net.ResolverParamsParcel[_aidl_size];
        }
    };
    ...
    public java.lang.String[] tlsFingerprints = new java.lang.String[0];
    ...
    public final void writeToParcel(android.os.Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeTypedObject(this.resolverOptions, _aidl_flag);
    ...
    public final void readFromParcel(android.os.Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.resolverOptions = (android.net.ResolverOptionsParcel) _aidl_parcel.readTypedObject(android.net.ResolverOptionsParcel.CREATOR);
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new android.os.BadParcelableException("Overflow in the size of parcelable");
                }
    ...
    public int describeContents() {
        int _mask = 0 | describeContents(this.resolverOptions);
        return _mask;
    }
