...
final class ModuleNameRetriever {
    ...
    private final kotlin.coroutines.jvm.internal.ModuleNameRetriever.Cache buildCache(kotlin.coroutines.jvm.internal.BaseContinuationImpl continuation) {
        try {
            ...
            kotlin.coroutines.jvm.internal.ModuleNameRetriever.Cache it = new kotlin.coroutines.jvm.internal.ModuleNameRetriever.Cache(getModuleMethod, getDescriptorMethod, nameMethod);
            cache = it;
            return it;
        } catch (java.lang.Exception e) {
            kotlin.coroutines.jvm.internal.ModuleNameRetriever.Cache it2 = notOnJava9;
            cache = it2;
            return it2;
        }
    }
