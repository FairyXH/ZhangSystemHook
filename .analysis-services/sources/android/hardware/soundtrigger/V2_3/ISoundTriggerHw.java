...
public interface ISoundTriggerHw extends android.hardware.soundtrigger.V2_2.ISoundTriggerHw {
    ...
    static android.hardware.soundtrigger.V2_3.ISoundTriggerHw asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        android.os.IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof android.hardware.soundtrigger.V2_3.ISoundTriggerHw)) {
            return (android.hardware.soundtrigger.V2_3.ISoundTriggerHw) iface;
        }
        android.hardware.soundtrigger.V2_3.ISoundTriggerHw proxy = new android.hardware.soundtrigger.V2_3.ISoundTriggerHw.Proxy(binder);
        try {
    ...
    static android.hardware.soundtrigger.V2_3.ISoundTriggerHw castFrom(android.os.IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static android.hardware.soundtrigger.V2_3.ISoundTriggerHw getService(java.lang.String serviceName, boolean retry) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static android.hardware.soundtrigger.V2_3.ISoundTriggerHw getService(boolean retry) throws android.os.RemoteException {
        return getService("default", retry);
    }

    @java.lang.Deprecated
    static android.hardware.soundtrigger.V2_3.ISoundTriggerHw getService(java.lang.String serviceName) throws android.os.RemoteException {
    ...
    public static final class Proxy implements android.hardware.soundtrigger.V2_3.ISoundTriggerHw {
        ...
        public int getModelState(int modelHandle) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
        ...
        public void getProperties_2_3(android.hardware.soundtrigger.V2_3.ISoundTriggerHw.getProperties_2_3Callback _hidl_cb) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
        ...
        @Override // android.hardware.soundtrigger.V2_3.ISoundTriggerHw
        public int startRecognition_2_3(int modelHandle, android.hardware.soundtrigger.V2_3.RecognitionConfig config) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.soundtrigger.V2_3.ISoundTriggerHw.kInterfaceName);
            _hidl_request.writeInt32(modelHandle);
            config.writeToParcel(_hidl_request);
        ...
        @Override // android.hardware.soundtrigger.V2_3.ISoundTriggerHw
        public int setParameter(int modelHandle, int modelParam, int value) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.soundtrigger.V2_3.ISoundTriggerHw.kInterfaceName);
            _hidl_request.writeInt32(modelHandle);
        ...
        @Override // android.hardware.soundtrigger.V2_3.ISoundTriggerHw
        public void getParameter(int modelHandle, int modelParam, android.hardware.soundtrigger.V2_3.ISoundTriggerHw.getParameterCallback _hidl_cb) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.soundtrigger.V2_3.ISoundTriggerHw.kInterfaceName);
            _hidl_request.writeInt32(modelHandle);
            _hidl_request.writeInt32(modelParam);
        ...
        @Override // android.hardware.soundtrigger.V2_3.ISoundTriggerHw
        public void queryParameter(int modelHandle, int modelParam, android.hardware.soundtrigger.V2_3.ISoundTriggerHw.queryParameterCallback _hidl_cb) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.soundtrigger.V2_3.ISoundTriggerHw.kInterfaceName);
            _hidl_request.writeInt32(modelHandle);
            _hidl_request.writeInt32(modelParam);
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.soundtrigger.V2_3.ISoundTriggerHw {
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String descriptor) {
            if (android.hardware.soundtrigger.V2_3.ISoundTriggerHw.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags) throws android.os.RemoteException {
            switch (_hidl_code) {
                ...
                case 2:
                    ...
                    loadSoundModel(soundModel, callback, cookie, new android.hardware.soundtrigger.V2_0.ISoundTriggerHw.loadSoundModelCallback() { // from class: android.hardware.soundtrigger.V2_3.ISoundTriggerHw.Stub.2
                ...
                case 3:
                    ...
                    loadPhraseSoundModel(soundModel2, callback2, cookie2, new android.hardware.soundtrigger.V2_0.ISoundTriggerHw.loadPhraseSoundModelCallback() { // from class: android.hardware.soundtrigger.V2_3.ISoundTriggerHw.Stub.3
                ...
                case 8:
                    ...
                    loadSoundModel_2_1(soundModel3, callback4, cookie4, new android.hardware.soundtrigger.V2_1.ISoundTriggerHw.loadSoundModel_2_1Callback() { // from class: android.hardware.soundtrigger.V2_3.ISoundTriggerHw.Stub.4
                ...
                case 9:
                    ...
                    loadPhraseSoundModel_2_1(soundModel4, callback5, cookie5, new android.hardware.soundtrigger.V2_1.ISoundTriggerHw.loadPhraseSoundModel_2_1Callback() { // from class: android.hardware.soundtrigger.V2_3.ISoundTriggerHw.Stub.5
                ...
                case 13:
                    ...
                    android.hardware.soundtrigger.V2_3.RecognitionConfig config3 = new android.hardware.soundtrigger.V2_3.RecognitionConfig();
                ...
                case 15:
                    ...
                    getParameter(modelHandle8, modelParam2, new android.hardware.soundtrigger.V2_3.ISoundTriggerHw.getParameterCallback() { // from class: android.hardware.soundtrigger.V2_3.ISoundTriggerHw.Stub.7
                ...
                case 16:
                    ...
                    queryParameter(modelHandle9, modelParam3, new android.hardware.soundtrigger.V2_3.ISoundTriggerHw.queryParameterCallback() { // from class: android.hardware.soundtrigger.V2_3.ISoundTriggerHw.Stub.8
