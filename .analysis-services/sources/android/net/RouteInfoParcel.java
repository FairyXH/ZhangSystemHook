...
public class RouteInfoParcel implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.net.RouteInfoParcel> CREATOR = new android.os.Parcelable.Creator<android.net.RouteInfoParcel>() { // from class: android.net.RouteInfoParcel.1
        ...
        public android.net.RouteInfoParcel createFromParcel(android.os.Parcel _aidl_source) {
            android.net.RouteInfoParcel _aidl_out = new android.net.RouteInfoParcel();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.net.RouteInfoParcel[] newArray(int _aidl_size) {
            return new android.net.RouteInfoParcel[_aidl_size];
        }
    };
