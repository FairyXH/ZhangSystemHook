...
public final class ByteStreamsKt {
    public static final com.android.server.permission.jarjar.kotlin.collections.ByteIterator iterator(final java.io.BufferedInputStream $this$iterator) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$iterator, "<this>");
        return new com.android.server.permission.jarjar.kotlin.collections.ByteIterator() { // from class: com.android.server.permission.jarjar.kotlin.io.ByteStreamsKt.iterator.1
            ...
            @Override // com.android.server.permission.jarjar.kotlin.collections.ByteIterator
    ...
    private static final java.io.ByteArrayInputStream byteInputStream(java.lang.String $this$byteInputStream, java.nio.charset.Charset charset) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$byteInputStream, "<this>");
    ...
    static /* synthetic */ java.io.ByteArrayInputStream byteInputStream$default(java.lang.String $this$byteInputStream_u24default, java.nio.charset.Charset charset, int i, java.lang.Object obj) {
        ...
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$byteInputStream_u24default, "<this>");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(charset, "charset");
    ...
    @com.android.server.permission.jarjar.kotlin.DeprecatedSinceKotlin(errorSince = "1.5", warningSince = "1.3")
    @com.android.server.permission.jarjar.kotlin.Deprecated(message = "Use readBytes() overload without estimatedSize parameter", replaceWith = @com.android.server.permission.jarjar.kotlin.ReplaceWith(expression = "readBytes()", imports = {}))
    public static final byte[] readBytes(java.io.InputStream $this$readBytes, int estimatedSize) {
        ...
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(byteArray, "toByteArray(...)");
        return byteArray;
    }
