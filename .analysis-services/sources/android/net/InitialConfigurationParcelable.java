...
public class InitialConfigurationParcelable implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.net.InitialConfigurationParcelable> CREATOR = new android.os.Parcelable.Creator<android.net.InitialConfigurationParcelable>() { // from class: android.net.InitialConfigurationParcelable.1
        ...
        public android.net.InitialConfigurationParcelable createFromParcel(android.os.Parcel _aidl_source) {
            android.net.InitialConfigurationParcelable _aidl_out = new android.net.InitialConfigurationParcelable();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.net.InitialConfigurationParcelable[] newArray(int _aidl_size) {
            return new android.net.InitialConfigurationParcelable[_aidl_size];
        }
    };
    ...
    public final void readFromParcel(android.os.Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.ipAddresses = (android.net.LinkAddress[]) _aidl_parcel.createTypedArray(android.net.LinkAddress.CREATOR);
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new android.os.BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.directlyConnectedRoutes = (android.net.IpPrefix[]) _aidl_parcel.createTypedArray(android.net.IpPrefix.CREATOR);
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new android.os.BadParcelableException("Overflow in the size of parcelable");
                }
    ...
    public java.lang.String toString() {
        ...
        _aidl_sj.add("ipAddresses: " + java.util.Arrays.toString(this.ipAddresses));
        _aidl_sj.add("directlyConnectedRoutes: " + java.util.Arrays.toString(this.directlyConnectedRoutes));
        _aidl_sj.add("dnsServers: " + java.util.Arrays.toString(this.dnsServers));
        _aidl_sj.add("gateway: " + java.util.Objects.toString(this.gateway));
        return "InitialConfigurationParcelable" + _aidl_sj.toString();
    }
