...
public class MapsKt__MapsJVMKt extends kotlin.collections.MapsKt__MapWithDefaultKt {
    ...
    private static final <K, V> java.util.Map<K, V> buildMapInternal(int capacity, kotlin.jvm.functions.Function1<? super java.util.Map<K, V>, kotlin.Unit> builderAction) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(builderAction, "builderAction");
    ...
    public static final <K, V> java.util.Map<K, V> createMapBuilder(int capacity) {
        return new kotlin.collections.builders.MapBuilder(capacity);
    }
    ...
    public static final <K extends java.lang.Comparable<? super K>, V> java.util.SortedMap<K, V> sortedMapOf(kotlin.Pair<? extends K, ? extends V>... pairs) {
        ...
        kotlin.collections.MapsKt.putAll($this$sortedMapOf_u24lambda_u242, pairs);
    ...
    public static final <K, V> java.util.SortedMap<K, V> sortedMapOf(java.util.Comparator<? super K> comparator, kotlin.Pair<? extends K, ? extends V>... pairs) {
        ...
        kotlin.collections.MapsKt.putAll($this$sortedMapOf_u24lambda_u243, pairs);
