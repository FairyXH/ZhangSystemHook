...
public interface IUsbCallback extends android.hidl.base.V1_0.IBase {
    ...
    static android.hardware.usb.V1_0.IUsbCallback asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        android.os.IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof android.hardware.usb.V1_0.IUsbCallback)) {
            return (android.hardware.usb.V1_0.IUsbCallback) iface;
        }
        android.hardware.usb.V1_0.IUsbCallback proxy = new android.hardware.usb.V1_0.IUsbCallback.Proxy(binder);
        try {
    ...
    static android.hardware.usb.V1_0.IUsbCallback castFrom(android.os.IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static android.hardware.usb.V1_0.IUsbCallback getService(java.lang.String serviceName, boolean retry) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static android.hardware.usb.V1_0.IUsbCallback getService(boolean retry) throws android.os.RemoteException {
        return getService("default", retry);
    }

    @java.lang.Deprecated
    static android.hardware.usb.V1_0.IUsbCallback getService(java.lang.String serviceName) throws android.os.RemoteException {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.usb.V1_0.IUsbCallback {
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String descriptor) {
            if (android.hardware.usb.V1_0.IUsbCallback.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
