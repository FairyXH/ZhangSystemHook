...
public class Channel implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.hardware.power.stats.Channel> CREATOR = new android.os.Parcelable.Creator<android.hardware.power.stats.Channel>() { // from class: android.hardware.power.stats.Channel.1
        ...
        public android.hardware.power.stats.Channel createFromParcel(android.os.Parcel _aidl_source) {
            android.hardware.power.stats.Channel _aidl_out = new android.hardware.power.stats.Channel();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.power.stats.Channel[] newArray(int _aidl_size) {
            return new android.hardware.power.stats.Channel[_aidl_size];
        }
    };
    public int id = 0;
