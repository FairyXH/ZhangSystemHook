...
public final class UShortArrayKt {
    private static final short[] UShortArray(int size, kotlin.jvm.functions.Function1<? super java.lang.Integer, kotlin.UShort> init) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(init, "init");
        short[] sArr = new short[size];
        for (int i = 0; i < size; i++) {
            sArr[i] = init.invoke(java.lang.Integer.valueOf(i)).getData();
        }
        return kotlin.UShortArray.m11641constructorimpl(sArr);
    }

    /* JADX INFO: renamed from: ushortArrayOf-rL5Bavg, reason: not valid java name */
    private static final short[] m11657ushortArrayOfrL5Bavg(short... elements) {
