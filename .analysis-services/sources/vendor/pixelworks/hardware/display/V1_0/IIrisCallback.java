...
public interface IIrisCallback extends android.hidl.base.V1_0.IBase {
    public static final java.lang.String kInterfaceName = "vendor.pixelworks.hardware.display@1.0::IIrisCallback";
    ...
    void onFeatureChanged(int i, java.util.ArrayList<java.lang.Integer> arrayList) throws android.os.RemoteException;
    ...
    static vendor.pixelworks.hardware.display.V1_0.IIrisCallback asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        android.os.IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof vendor.pixelworks.hardware.display.V1_0.IIrisCallback)) {
            return (vendor.pixelworks.hardware.display.V1_0.IIrisCallback) iface;
        }
        vendor.pixelworks.hardware.display.V1_0.IIrisCallback proxy = new vendor.pixelworks.hardware.display.V1_0.IIrisCallback.Proxy(binder);
        try {
    ...
    static vendor.pixelworks.hardware.display.V1_0.IIrisCallback castFrom(android.os.IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static vendor.pixelworks.hardware.display.V1_0.IIrisCallback getService(java.lang.String serviceName, boolean retry) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static vendor.pixelworks.hardware.display.V1_0.IIrisCallback getService(boolean retry) throws android.os.RemoteException {
        return getService("default", retry);
    }

    @java.lang.Deprecated
    static vendor.pixelworks.hardware.display.V1_0.IIrisCallback getService(java.lang.String serviceName) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName));
    }

    @java.lang.Deprecated
    static vendor.pixelworks.hardware.display.V1_0.IIrisCallback getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements vendor.pixelworks.hardware.display.V1_0.IIrisCallback {
    ...
    public static abstract class Stub extends android.os.HwBinder implements vendor.pixelworks.hardware.display.V1_0.IIrisCallback {
        @Override // vendor.pixelworks.hardware.display.V1_0.IIrisCallback, android.hidl.base.V1_0.IBase
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(vendor.pixelworks.hardware.display.V1_0.IIrisCallback.kInterfaceName, android.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public final java.lang.String interfaceDescriptor() {
            return vendor.pixelworks.hardware.display.V1_0.IIrisCallback.kInterfaceName;
        }

        @Override // vendor.pixelworks.hardware.display.V1_0.IIrisCallback, android.hidl.base.V1_0.IBase
        public final java.util.ArrayList<byte[]> getHashChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(new byte[]{40, -119, 3, -47, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_SUPERSPEED_HUB, -27, 10, -12, -27, -37, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_HUB, 108, 68, 88, 93, -47, -107, -54, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_REPORT, -39, -49, -62, 74, 104, 25, -63, 26, -108, 81, 26, 90, -71}, new byte[]{-20, 127, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_PHYSICAL, -17, 5, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_INTERFACE, -13, -51, 105, 87, 19, -109, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_INTERFACE, -72, 59, 24, -54, 76}));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String descriptor) {
            if (vendor.pixelworks.hardware.display.V1_0.IIrisCallback.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
