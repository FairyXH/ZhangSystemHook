...
public class MathKt__MathJVMKt extends kotlin.math.MathKt__MathHKt {
    ...
    public static final double asinh(double x) {
        if (x < kotlin.math.Constants.taylor_n_bound) {
            if (x <= (-kotlin.math.Constants.taylor_n_bound)) {
                double result = -kotlin.math.MathKt.asinh(-x);
                return result;
            }
            if (java.lang.Math.abs(x) >= kotlin.math.Constants.taylor_2_bound) {
                double result2 = x - (((x * x) * x) / ((double) 6));
                return result2;
            }
            return x;
        }
        if (x <= kotlin.math.Constants.upper_taylor_n_bound) {
            double result3 = java.lang.Math.log(java.lang.Math.sqrt((x * x) + ((double) 1)) + x);
            return result3;
        }
        if (x > kotlin.math.Constants.upper_taylor_2_bound) {
            double result4 = java.lang.Math.log(x) + kotlin.math.Constants.LN2;
            return result4;
        }
        double d = 2;
    ...
    public static final double acosh(double x) {
        ...
        if (x > kotlin.math.Constants.upper_taylor_2_bound) {
            return java.lang.Math.log(x) + kotlin.math.Constants.LN2;
        }
        double d = 1;
        if (x - d >= kotlin.math.Constants.taylor_n_bound) {
            return java.lang.Math.log(java.lang.Math.sqrt((x * x) - d) + x);
        }
        double y = java.lang.Math.sqrt(x - d);
        double result = y;
        if (y >= kotlin.math.Constants.taylor_2_bound) {
    ...
    public static final double atanh(double x) {
        if (java.lang.Math.abs(x) >= kotlin.math.Constants.taylor_n_bound) {
            double d = 1;
    ...
    private static final float asinh(float x) {
        return (float) kotlin.math.MathKt.asinh(x);
    }

    private static final float acosh(float x) {
        return (float) kotlin.math.MathKt.acosh(x);
    }

    private static final float atanh(float x) {
        return (float) kotlin.math.MathKt.atanh(x);
    }
    ...
    public static final float log2(float x) {
        return (float) (java.lang.Math.log(x) / kotlin.math.Constants.LN2);
    }
    ...
    public static final long roundToLong(float $this$roundToLong) {
        return kotlin.math.MathKt.roundToLong($this$roundToLong);
    }
