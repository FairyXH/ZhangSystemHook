...
public final class AudioPortDeviceExt {
    ...
    public final boolean equals(java.lang.Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != android.hardware.audio.common.V2_0.AudioPortDeviceExt.class) {
            return false;
        }
    ...
    public static final java.util.ArrayList<android.hardware.audio.common.V2_0.AudioPortDeviceExt> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<android.hardware.audio.common.V2_0.AudioPortDeviceExt> _hidl_vec = new java.util.ArrayList<>();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel parcel, java.util.ArrayList<android.hardware.audio.common.V2_0.AudioPortDeviceExt> _hidl_vec) {
