...
public interface IHdmiCec extends android.hardware.tv.cec.V1_0.IHdmiCec {
    ...
    static android.hardware.tv.cec.V1_1.IHdmiCec asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        android.os.IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof android.hardware.tv.cec.V1_1.IHdmiCec)) {
            return (android.hardware.tv.cec.V1_1.IHdmiCec) iface;
        }
        android.hardware.tv.cec.V1_1.IHdmiCec proxy = new android.hardware.tv.cec.V1_1.IHdmiCec.Proxy(binder);
        try {
    ...
    static android.hardware.tv.cec.V1_1.IHdmiCec castFrom(android.os.IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static android.hardware.tv.cec.V1_1.IHdmiCec getService(java.lang.String serviceName, boolean retry) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static android.hardware.tv.cec.V1_1.IHdmiCec getService(boolean retry) throws android.os.RemoteException {
        return getService("default", retry);
    }

    @java.lang.Deprecated
    static android.hardware.tv.cec.V1_1.IHdmiCec getService(java.lang.String serviceName) throws android.os.RemoteException {
    ...
    public static final class Proxy implements android.hardware.tv.cec.V1_1.IHdmiCec {
        ...
        public int addLogicalAddress(int addr) throws android.os.RemoteException {
        ...
        @Override // android.hardware.tv.cec.V1_0.IHdmiCec
        public void getPhysicalAddress(android.hardware.tv.cec.V1_0.IHdmiCec.getPhysicalAddressCallback _hidl_cb) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.tv.cec.V1_0.IHdmiCec.kInterfaceName);
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
        ...
        @Override // android.hardware.tv.cec.V1_0.IHdmiCec
        public int sendMessage(android.hardware.tv.cec.V1_0.CecMessage message) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.tv.cec.V1_0.IHdmiCec.kInterfaceName);
        ...
        @Override // android.hardware.tv.cec.V1_0.IHdmiCec
        public void setCallback(android.hardware.tv.cec.V1_0.IHdmiCecCallback callback) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.tv.cec.V1_0.IHdmiCec.kInterfaceName);
        ...
        @Override // android.hardware.tv.cec.V1_0.IHdmiCec
        public void setOption(int key, boolean value) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.tv.cec.V1_0.IHdmiCec.kInterfaceName);
        ...
        public int addLogicalAddress_1_1(int addr) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
        ...
        @Override // android.hardware.tv.cec.V1_1.IHdmiCec
        public int sendMessage_1_1(android.hardware.tv.cec.V1_1.CecMessage message) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.tv.cec.V1_1.IHdmiCec.kInterfaceName);
            message.writeToParcel(_hidl_request);
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
        ...
        @Override // android.hardware.tv.cec.V1_1.IHdmiCec
        public void setCallback_1_1(android.hardware.tv.cec.V1_1.IHdmiCecCallback callback) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.tv.cec.V1_1.IHdmiCec.kInterfaceName);
            _hidl_request.writeStrongBinder(callback == null ? null : callback.asBinder());
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.tv.cec.V1_1.IHdmiCec {
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String descriptor) {
            if (android.hardware.tv.cec.V1_1.IHdmiCec.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags) throws android.os.RemoteException {
            switch (_hidl_code) {
                ...
                case 10:
                    _hidl_request.enforceInterface(android.hardware.tv.cec.V1_0.IHdmiCec.kInterfaceName);
                    java.lang.String language = _hidl_request.readString();
                ...
                case 14:
                    _hidl_request.enforceInterface(android.hardware.tv.cec.V1_1.IHdmiCec.kInterfaceName);
                    android.hardware.tv.cec.V1_1.CecMessage message2 = new android.hardware.tv.cec.V1_1.CecMessage();
                ...
                case 15:
                    _hidl_request.enforceInterface(android.hardware.tv.cec.V1_1.IHdmiCec.kInterfaceName);
                    android.hardware.tv.cec.V1_1.IHdmiCecCallback callback2 = android.hardware.tv.cec.V1_1.IHdmiCecCallback.asInterface(_hidl_request.readStrongBinder());
