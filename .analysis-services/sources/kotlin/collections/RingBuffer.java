...
final class RingBuffer<T> extends kotlin.collections.AbstractList<T> implements java.util.RandomAccess {
        ...
        return new kotlin.collections.AbstractIterator<T>(this) { // from class: kotlin.collections.RingBuffer.iterator.1
            ...
            protected void computeNext() {
                if (this.count != 0) {
                    ...
                    kotlin.collections.RingBuffer<T> ringBuffer = this.this$0;
                    int $this$forward$iv = this.index;
                    this.index = ($this$forward$iv + 1) % ((kotlin.collections.RingBuffer) ringBuffer).capacity;
                    this.count--;
                    return;
                }
                done();
    ...
    public <T> T[] toArray(T[] array) {
        ...
        if (array.length < size()) {
            objArrCopyOf = java.util.Arrays.copyOf(array, size());
        ...
        return (T[]) kotlin.collections.CollectionsKt.terminateCollectionToArray(size, objArrCopyOf);
    }
    ...
    public final kotlin.collections.RingBuffer<T> expanded(int maxCapacity) {
        ...
        int newCapacity = kotlin.ranges.RangesKt.coerceAtMost(this.capacity + (this.capacity >> 1) + 1, maxCapacity);
        if (this.startIndex == 0) {
            newBuffer = java.util.Arrays.copyOf(this.buffer, newCapacity);
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(newBuffer, "copyOf(...)");
        } else {
            newBuffer = toArray(new java.lang.Object[newCapacity]);
        }
        return new kotlin.collections.RingBuffer<>(newBuffer, size());
    }
    ...
    public final void removeFirst(int n) {
        ...
        if (n > 0) {
            ...
            if (start <= end) {
                kotlin.collections.ArraysKt.fill(this.buffer, (java.lang.Object) null, start, end);
            } else {
                kotlin.collections.ArraysKt.fill(this.buffer, (java.lang.Object) null, start, this.capacity);
                kotlin.collections.ArraysKt.fill(this.buffer, (java.lang.Object) null, 0, end);
            }
            this.startIndex = end;
            this.size = size() - n;
        }
