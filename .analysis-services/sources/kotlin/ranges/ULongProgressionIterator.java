...
final class ULongProgressionIterator implements java.util.Iterator<kotlin.ULong>, kotlin.jvm.internal.markers.KMappedMarker {
    ...
    private ULongProgressionIterator(long first, long last, long step) {
        ...
        this.hasNext = z;
        this.step = kotlin.ULong.m11481constructorimpl(step);
        this.next = this.hasNext ? first : this.finalElement;
    }

    @Override // java.util.Iterator
    public /* bridge */ /* synthetic */ kotlin.ULong next() {
        return kotlin.ULong.m11475boximpl(m12542nextsVKNKU());
    }
    ...
    public long m12542nextsVKNKU() {
        ...
        if (value == this.finalElement) {
            ...
            this.next = kotlin.ULong.m11481constructorimpl(this.next + this.step);
        }
        return value;
    }
}
