...
public final class Typography {
    public static final com.android.server.permission.jarjar.kotlin.text.Typography INSTANCE = new com.android.server.permission.jarjar.kotlin.text.Typography();
    ...
    @com.android.server.permission.jarjar.kotlin.DeprecatedSinceKotlin(warningSince = "1.6")
    @com.android.server.permission.jarjar.kotlin.Deprecated(message = "This constant has a typo in the name. Use leftGuillemet instead.", replaceWith = @com.android.server.permission.jarjar.kotlin.ReplaceWith(expression = "Typography.leftGuillemet", imports = {}))
    ...
    @com.android.server.permission.jarjar.kotlin.DeprecatedSinceKotlin(warningSince = "1.6")
    @com.android.server.permission.jarjar.kotlin.Deprecated(message = "This constant has a typo in the name. Use rightGuillemet instead.", replaceWith = @com.android.server.permission.jarjar.kotlin.ReplaceWith(expression = "Typography.rightGuillemet", imports = {}))
