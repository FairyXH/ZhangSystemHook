...
@com.android.server.permission.jarjar.kotlin.Metadata(d1 = {"\u0000.\n\u0000\n\u0002\u0010\u0001\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0005\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\t\n\u0002\b\u0003\n\u0002\u0010\n\n\u0002\b\u0003\u001a\u0010\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\u0000\u001a\u0013\u0010\u0004\u001a\u0004\u0018\u00010\u0005*\u00020\u0003H\u0007¢\u0006\u0002\u0010\u0006\u001a\u001b\u0010\u0004\u001a\u0004\u0018\u00010\u0005*\u00020\u00032\u0006\u0010\u0007\u001a\u00020\bH\u0007¢\u0006\u0002\u0010\t\u001a\u0013\u0010\n\u001a\u0004\u0018\u00010\b*\u00020\u0003H\u0007¢\u0006\u0002\u0010\u000b\u001a\u001b\u0010\n\u001a\u0004\u0018\u00010\b*\u00020\u00032\u0006\u0010\u0007\u001a\u00020\bH\u0007¢\u0006\u0002\u0010\f\u001a\u0013\u0010\r\u001a\u0004\u0018\u00010\u000e*\u00020\u0003H\u0007¢\u0006\u0002\u0010\u000f\u001a\u001b\u0010\r\u001a\u0004\u0018\u00010\u000e*\u00020\u00032\u0006\u0010\u0007\u001a\u00020\bH\u0007¢\u0006\u0002\u0010\u0010\u001a\u0013\u0010\u0011\u001a\u0004\u0018\u00010\u0012*\u00020\u0003H\u0007¢\u0006\u0002\u0010\u0013\u001a\u001b\u0010\u0011\u001a\u0004\u0018\u00010\u0012*\u00020\u00032\u0006\u0010\u0007\u001a\u00020\bH\u0007¢\u0006\u0002\u0010\u0014¨\u0006\u0015"}, d2 = {"numberFormatError", "", com.android.server.am.IOplusSceneManager.APP_SCENE_DEFAULT_INPUT, "", "toByteOrNull", "", "(Ljava/lang/String;)Ljava/lang/Byte;", "radix", "", "(Ljava/lang/String;I)Ljava/lang/Byte;", "toIntOrNull", "(Ljava/lang/String;)Ljava/lang/Integer;", "(Ljava/lang/String;I)Ljava/lang/Integer;", "toLongOrNull", "", "(Ljava/lang/String;)Ljava/lang/Long;", "(Ljava/lang/String;I)Ljava/lang/Long;", "toShortOrNull", "", "(Ljava/lang/String;)Ljava/lang/Short;", "(Ljava/lang/String;I)Ljava/lang/Short;", "kotlin-stdlib"}, k = 5, mv = {1, 9, 0}, xi = 49, xs = "com/android/server/permission/jarjar/kotlin/text/StringsKt")
class StringsKt__StringNumberConversionsKt extends com.android.server.permission.jarjar.kotlin.text.StringsKt__StringNumberConversionsJVMKt {
    public static final java.lang.Byte toByteOrNull(java.lang.String $this$toByteOrNull) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$toByteOrNull, "<this>");
        return com.android.server.permission.jarjar.kotlin.text.StringsKt.toByteOrNull($this$toByteOrNull, 10);
    }

    public static final java.lang.Byte toByteOrNull(java.lang.String $this$toByteOrNull, int radix) {
        int iIntValue;
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$toByteOrNull, "<this>");
        java.lang.Integer intOrNull = com.android.server.permission.jarjar.kotlin.text.StringsKt.toIntOrNull($this$toByteOrNull, radix);
    ...
    public static final java.lang.Short toShortOrNull(java.lang.String $this$toShortOrNull) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$toShortOrNull, "<this>");
        return com.android.server.permission.jarjar.kotlin.text.StringsKt.toShortOrNull($this$toShortOrNull, 10);
    }

    public static final java.lang.Short toShortOrNull(java.lang.String $this$toShortOrNull, int radix) {
        int iIntValue;
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$toShortOrNull, "<this>");
        java.lang.Integer intOrNull = com.android.server.permission.jarjar.kotlin.text.StringsKt.toIntOrNull($this$toShortOrNull, radix);
    ...
    public static final java.lang.Integer toIntOrNull(java.lang.String $this$toIntOrNull) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$toIntOrNull, "<this>");
        return com.android.server.permission.jarjar.kotlin.text.StringsKt.toIntOrNull($this$toIntOrNull, 10);
    }
    ...
    public static final java.lang.Integer toIntOrNull(java.lang.String $this$toIntOrNull, int radix) {
        ...
        if (com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.compare((int) firstChar, 48) < 0) {
            if (length == 1) {
                return null;
            }
            start = 1;
        ...
        for (int i = start; i < length; i++) {
            int digit = com.android.server.permission.jarjar.kotlin.text.CharsKt.digitOf($this$toIntOrNull.charAt(i), radix);
            if (digit < 0) {
                return null;
            }
    ...
    public static final java.lang.Long toLongOrNull(java.lang.String $this$toLongOrNull) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$toLongOrNull, "<this>");
        return com.android.server.permission.jarjar.kotlin.text.StringsKt.toLongOrNull($this$toLongOrNull, 10);
    }
    ...
    public static final java.lang.Long toLongOrNull(java.lang.String $this$toLongOrNull, int radix) {
        ...
        if (com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.compare((int) firstChar2, 48) < 0) {
            if (length == 1) {
                return null;
            }
            start = 1;
        ...
        int i = start;
        while (i < length) {
            int digit = com.android.server.permission.jarjar.kotlin.text.CharsKt.digitOf($this$toLongOrNull.charAt(i), radix);
            if (digit < 0) {
                return null;
            }
