...
public class JDK7PlatformImplementations extends com.android.server.permission.jarjar.kotlin.internal.PlatformImplementations {
    ...
    public java.util.List<java.lang.Throwable> getSuppressed(java.lang.Throwable exception) {
        ...
        if (sdkIsNullOrAtLeast(19)) {
            ...
            com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(suppressed, "getSuppressed(...)");
            return com.android.server.permission.jarjar.kotlin.collections.ArraysKt.asList(suppressed);
        }
