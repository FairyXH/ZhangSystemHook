...
public class FakeFeatureFlagsImpl extends com.android.server.job.CustomFeatureFlags {
    private final com.android.server.job.FeatureFlags mDefaults;
    ...
    public FakeFeatureFlagsImpl(com.android.server.job.FeatureFlags defaults) {
        super(null);
    ...
    @Override // com.android.server.job.CustomFeatureFlags
