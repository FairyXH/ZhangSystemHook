...
public final class VendorKeyValue {
    ...
    public final boolean equals(java.lang.Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != android.hardware.broadcastradio.V2_0.VendorKeyValue.class) {
            return false;
        }
        ...
        if (android.os.HidlSupport.deepEquals(this.key, other.key) && android.os.HidlSupport.deepEquals(this.value, other.value)) {
            return true;
        }
        return false;
    }
    ...
    public static final java.util.ArrayList<android.hardware.broadcastradio.V2_0.VendorKeyValue> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<android.hardware.broadcastradio.V2_0.VendorKeyValue> _hidl_vec = new java.util.ArrayList<>();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel parcel, java.util.ArrayList<android.hardware.broadcastradio.V2_0.VendorKeyValue> _hidl_vec) {
