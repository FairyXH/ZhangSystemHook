...
public interface IHealth extends android.hidl.base.V1_0.IBase {
    ...
    static android.hardware.health.V2_0.IHealth asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        android.os.IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof android.hardware.health.V2_0.IHealth)) {
            return (android.hardware.health.V2_0.IHealth) iface;
        }
        android.hardware.health.V2_0.IHealth proxy = new android.hardware.health.V2_0.IHealth.Proxy(binder);
        try {
    ...
    static android.hardware.health.V2_0.IHealth castFrom(android.os.IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static android.hardware.health.V2_0.IHealth getService(java.lang.String serviceName, boolean retry) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static android.hardware.health.V2_0.IHealth getService(boolean retry) throws android.os.RemoteException {
        return getService("default", retry);
    }

    @java.lang.Deprecated
    static android.hardware.health.V2_0.IHealth getService(java.lang.String serviceName) throws android.os.RemoteException {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.health.V2_0.IHealth {
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String descriptor) {
            if (android.hardware.health.V2_0.IHealth.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
