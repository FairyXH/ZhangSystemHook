...
class CollectionsKt__ReversedViewsKt extends kotlin.collections.CollectionsKt__MutableCollectionsKt {
    ...
    public static final int reverseElementIndex$CollectionsKt__ReversedViewsKt(java.util.List<?> list, int index) {
        if (new kotlin.ranges.IntRange(0, kotlin.collections.CollectionsKt.getLastIndex(list)).contains(index)) {
            return kotlin.collections.CollectionsKt.getLastIndex(list) - index;
        }
        throw new java.lang.IndexOutOfBoundsException("Element index " + index + " must be in range [" + new kotlin.ranges.IntRange(0, kotlin.collections.CollectionsKt.getLastIndex(list)) + "].");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final int reversePositionIndex$CollectionsKt__ReversedViewsKt(java.util.List<?> list, int index) {
        if (new kotlin.ranges.IntRange(0, list.size()).contains(index)) {
            return list.size() - index;
        }
        throw new java.lang.IndexOutOfBoundsException("Position index " + index + " must be in range [" + new kotlin.ranges.IntRange(0, list.size()) + "].");
    }
