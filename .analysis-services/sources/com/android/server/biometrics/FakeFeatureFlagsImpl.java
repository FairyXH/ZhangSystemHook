...
public class FakeFeatureFlagsImpl extends com.android.server.biometrics.CustomFeatureFlags {
    private final com.android.server.biometrics.FeatureFlags mDefaults;
    ...
    public FakeFeatureFlagsImpl(com.android.server.biometrics.FeatureFlags defaults) {
        super(null);
    ...
    @Override // com.android.server.biometrics.CustomFeatureFlags
