...
public class XmlParser {
    public static com.android.server.display.config.DisplayConfiguration read(java.io.InputStream in) throws org.xmlpull.v1.XmlPullParserException, javax.xml.datatype.DatatypeConfigurationException, java.io.IOException {
        ...
        if (!_tagName.equals("displayConfiguration")) {
            return null;
        }
        com.android.server.display.config.DisplayConfiguration _value = com.android.server.display.config.DisplayConfiguration.read(_parser);
        return _value;
    }
