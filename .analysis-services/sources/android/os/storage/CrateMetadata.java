...
public class CrateMetadata implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.os.storage.CrateMetadata> CREATOR = new android.os.Parcelable.Creator<android.os.storage.CrateMetadata>() { // from class: android.os.storage.CrateMetadata.1
        ...
        public android.os.storage.CrateMetadata createFromParcel(android.os.Parcel _aidl_source) {
            android.os.storage.CrateMetadata _aidl_out = new android.os.storage.CrateMetadata();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.os.storage.CrateMetadata[] newArray(int _aidl_size) {
            return new android.os.storage.CrateMetadata[_aidl_size];
        }
    };
