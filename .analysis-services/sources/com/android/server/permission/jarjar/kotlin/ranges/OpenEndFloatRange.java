...
final class OpenEndFloatRange implements com.android.server.permission.jarjar.kotlin.ranges.OpenEndRange<java.lang.Float> {
    ...
    public boolean equals(java.lang.Object other) {
        if (!(other instanceof com.android.server.permission.jarjar.kotlin.ranges.OpenEndFloatRange)) {
            return false;
        }
        if (!isEmpty() || !((com.android.server.permission.jarjar.kotlin.ranges.OpenEndFloatRange) other).isEmpty()) {
            if (!(this._start == ((com.android.server.permission.jarjar.kotlin.ranges.OpenEndFloatRange) other)._start)) {
                return false;
            }
            if (!(this._endExclusive == ((com.android.server.permission.jarjar.kotlin.ranges.OpenEndFloatRange) other)._endExclusive)) {
                return false;
            }
        }
        return true;
