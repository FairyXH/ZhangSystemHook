...
public class IntProgression implements java.lang.Iterable<java.lang.Integer>, kotlin.jvm.internal.markers.KMappedMarker {
    ...
    public IntProgression(int start, int endInclusive, int step) {
        ...
        this.first = start;
        this.last = kotlin.internal.ProgressionUtilKt.getProgressionLastElement(start, endInclusive, step);
        this.step = step;
    }
    ...
    public boolean equals(java.lang.Object other) {
        return (other instanceof kotlin.ranges.IntProgression) && ((isEmpty() && ((kotlin.ranges.IntProgression) other).isEmpty()) || (this.first == ((kotlin.ranges.IntProgression) other).first && this.last == ((kotlin.ranges.IntProgression) other).last && this.step == ((kotlin.ranges.IntProgression) other).step));
    }
