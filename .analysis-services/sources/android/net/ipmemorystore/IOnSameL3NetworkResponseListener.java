        ...
        public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    android.net.ipmemorystore.SameL3NetworkResponseParcelable _arg1 = (android.net.ipmemorystore.SameL3NetworkResponseParcelable) data.readTypedObject(android.net.ipmemorystore.SameL3NetworkResponseParcelable.CREATOR);
        ...
        private static class Proxy implements android.net.ipmemorystore.IOnSameL3NetworkResponseListener {
            ...
            public synchronized java.lang.String getInterfaceHash() throws android.os.RemoteException {
                if ("-1".equals(this.mCachedHash)) {
                    ...
                    try {
                        data.writeInterfaceToken(DESCRIPTOR);
                        this.mRemote.transact(android.net.ipmemorystore.IOnSameL3NetworkResponseListener.Stub.TRANSACTION_getInterfaceHash, data, reply, 0);
                        reply.readException();
