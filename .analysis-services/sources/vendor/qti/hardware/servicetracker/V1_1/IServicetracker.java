package vendor.qti.hardware.servicetracker.V1_1;

/* JADX INFO: loaded from: classes4.dex */
public interface IServicetracker extends vendor.qti.hardware.servicetracker.V1_0.IServicetracker {
    public static final java.lang.String kInterfaceName = "vendor.qti.hardware.servicetracker@1.1::IServicetracker";

    @java.lang.FunctionalInterface
    public interface getRunningServicePidCallback {
    ...
    void getRunningServicePid(vendor.qti.hardware.servicetracker.V1_1.IServicetracker.getRunningServicePidCallback getrunningservicepidcallback) throws android.os.RemoteException;
    ...
    static vendor.qti.hardware.servicetracker.V1_1.IServicetracker asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        android.os.IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof vendor.qti.hardware.servicetracker.V1_1.IServicetracker)) {
            return (vendor.qti.hardware.servicetracker.V1_1.IServicetracker) iface;
        }
        vendor.qti.hardware.servicetracker.V1_1.IServicetracker proxy = new vendor.qti.hardware.servicetracker.V1_1.IServicetracker.Proxy(binder);
        try {
    ...
    static vendor.qti.hardware.servicetracker.V1_1.IServicetracker castFrom(android.os.IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static vendor.qti.hardware.servicetracker.V1_1.IServicetracker getService(java.lang.String serviceName, boolean retry) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static vendor.qti.hardware.servicetracker.V1_1.IServicetracker getService(boolean retry) throws android.os.RemoteException {
        return getService("default", retry);
    }

    @java.lang.Deprecated
    static vendor.qti.hardware.servicetracker.V1_1.IServicetracker getService(java.lang.String serviceName) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName));
    }

    @java.lang.Deprecated
    static vendor.qti.hardware.servicetracker.V1_1.IServicetracker getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements vendor.qti.hardware.servicetracker.V1_1.IServicetracker {
        ...
        public java.lang.String toString() {
            try {
                ...
                return "[class or subclass of vendor.qti.hardware.servicetracker@1.1::IServicetracker]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends android.os.HwBinder implements vendor.qti.hardware.servicetracker.V1_1.IServicetracker {
        @Override // vendor.qti.hardware.servicetracker.V1_1.IServicetracker, vendor.qti.hardware.servicetracker.V1_0.IServicetracker, android.hidl.base.V1_0.IBase
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(vendor.qti.hardware.servicetracker.V1_1.IServicetracker.kInterfaceName, vendor.qti.hardware.servicetracker.V1_0.IServicetracker.kInterfaceName, android.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String descriptor) {
            if (vendor.qti.hardware.servicetracker.V1_1.IServicetracker.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags) throws android.os.RemoteException {
            switch (_hidl_code) {
                ...
                case 6:
                    ...
                    getclientInfo(clientName, new vendor.qti.hardware.servicetracker.V1_0.IServicetracker.getclientInfoCallback() { // from class: vendor.qti.hardware.servicetracker.V1_1.IServicetracker.Stub.1
                ...
                case 7:
                    ...
                    getserviceInfo(serviceName, new vendor.qti.hardware.servicetracker.V1_0.IServicetracker.getserviceInfoCallback() { // from class: vendor.qti.hardware.servicetracker.V1_1.IServicetracker.Stub.2
                ...
                case 8:
                    ...
                    getServiceConnections(serviceName2, new vendor.qti.hardware.servicetracker.V1_0.IServicetracker.getServiceConnectionsCallback() { // from class: vendor.qti.hardware.servicetracker.V1_1.IServicetracker.Stub.3
                ...
                case 9:
                    ...
                    getClientConnections(clientName2, new vendor.qti.hardware.servicetracker.V1_0.IServicetracker.getClientConnectionsCallback() { // from class: vendor.qti.hardware.servicetracker.V1_1.IServicetracker.Stub.4
                ...
                case 10:
                    ...
                    getPid(processName, new vendor.qti.hardware.servicetracker.V1_0.IServicetracker.getPidCallback() { // from class: vendor.qti.hardware.servicetracker.V1_1.IServicetracker.Stub.5
                ...
                case 11:
                    ...
                    getPids(serviceList, new vendor.qti.hardware.servicetracker.V1_0.IServicetracker.getPidsCallback() { // from class: vendor.qti.hardware.servicetracker.V1_1.IServicetracker.Stub.6
                ...
                case 12:
                    ...
                    isServiceB(serviceName3, new vendor.qti.hardware.servicetracker.V1_0.IServicetracker.isServiceBCallback() { // from class: vendor.qti.hardware.servicetracker.V1_1.IServicetracker.Stub.7
                ...
                case 13:
                    _hidl_request.enforceInterface(vendor.qti.hardware.servicetracker.V1_0.IServicetracker.kInterfaceName);
                    getServiceBCount(new vendor.qti.hardware.servicetracker.V1_0.IServicetracker.getServiceBCountCallback() { // from class: vendor.qti.hardware.servicetracker.V1_1.IServicetracker.Stub.8
                ...
                case 14:
                    ...
                    getRunningServicePid(new vendor.qti.hardware.servicetracker.V1_1.IServicetracker.getRunningServicePidCallback() { // from class: vendor.qti.hardware.servicetracker.V1_1.IServicetracker.Stub.9
