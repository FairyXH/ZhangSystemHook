package com.android.server.permission.jarjar.kotlin.coroutines.cancellation;
...
public final class CancellationExceptionKt {
    ...
    private static final java.util.concurrent.CancellationException CancellationException(java.lang.String message, java.lang.Throwable cause) {
        java.util.concurrent.CancellationException it = new java.util.concurrent.CancellationException(message);
        it.initCause(cause);
        return it;
    }

    private static final java.util.concurrent.CancellationException CancellationException(java.lang.Throwable cause) {
