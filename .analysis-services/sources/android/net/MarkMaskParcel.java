...
public class MarkMaskParcel implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.net.MarkMaskParcel> CREATOR = new android.os.Parcelable.Creator<android.net.MarkMaskParcel>() { // from class: android.net.MarkMaskParcel.1
        ...
        public android.net.MarkMaskParcel createFromParcel(android.os.Parcel _aidl_source) {
            android.net.MarkMaskParcel _aidl_out = new android.net.MarkMaskParcel();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.net.MarkMaskParcel[] newArray(int _aidl_size) {
            return new android.net.MarkMaskParcel[_aidl_size];
        }
    };
    public int mark = 0;
    public int mask = 0;
