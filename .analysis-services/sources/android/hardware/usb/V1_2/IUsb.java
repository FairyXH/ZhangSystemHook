...
public interface IUsb extends android.hardware.usb.V1_1.IUsb {
    ...
    static android.hardware.usb.V1_2.IUsb asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        android.os.IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof android.hardware.usb.V1_2.IUsb)) {
            return (android.hardware.usb.V1_2.IUsb) iface;
        }
        android.hardware.usb.V1_2.IUsb proxy = new android.hardware.usb.V1_2.IUsb.Proxy(binder);
        try {
    ...
    static android.hardware.usb.V1_2.IUsb castFrom(android.os.IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static android.hardware.usb.V1_2.IUsb getService(java.lang.String serviceName, boolean retry) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static android.hardware.usb.V1_2.IUsb getService(boolean retry) throws android.os.RemoteException {
        return getService("default", retry);
    }

    @java.lang.Deprecated
    static android.hardware.usb.V1_2.IUsb getService(java.lang.String serviceName) throws android.os.RemoteException {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.usb.V1_2.IUsb {
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String descriptor) {
            if (android.hardware.usb.V1_2.IUsb.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
