...
public interface CopyableThreadContextElement<S> extends kotlinx.coroutines.ThreadContextElement<S> {
    ...
    public static final class DefaultImpls {
        public static <S, R> R fold(kotlinx.coroutines.CopyableThreadContextElement<S> copyableThreadContextElement, R r, kotlin.jvm.functions.Function2<? super R, ? super kotlin.coroutines.CoroutineContext.Element, ? extends R> operation) {
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(operation, "operation");
            return (R) kotlinx.coroutines.ThreadContextElement.DefaultImpls.fold(copyableThreadContextElement, r, operation);
        }
        ...
        public static <S> kotlin.coroutines.CoroutineContext plus(kotlinx.coroutines.CopyableThreadContextElement<S> copyableThreadContextElement, kotlin.coroutines.CoroutineContext context) {
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(context, "context");
            return kotlinx.coroutines.ThreadContextElement.DefaultImpls.plus(copyableThreadContextElement, context);
        }
    }
}
