...
public class XmlParser {
    public static com.android.server.display.config.layout.Layouts read(java.io.InputStream in) throws org.xmlpull.v1.XmlPullParserException, javax.xml.datatype.DatatypeConfigurationException, java.io.IOException {
        ...
        if (!_tagName.equals("layouts")) {
            return null;
        }
        com.android.server.display.config.layout.Layouts _value = com.android.server.display.config.layout.Layouts.read(_parser);
        return _value;
    }
