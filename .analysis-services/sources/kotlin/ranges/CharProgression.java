...
public class CharProgression implements java.lang.Iterable<java.lang.Character>, kotlin.jvm.internal.markers.KMappedMarker {
    ...
    public CharProgression(char start, char endInclusive, int step) {
        ...
        this.first = start;
        this.last = (char) kotlin.internal.ProgressionUtilKt.getProgressionLastElement((int) start, (int) endInclusive, step);
        this.step = step;
    }
    ...
    public boolean equals(java.lang.Object other) {
        return (other instanceof kotlin.ranges.CharProgression) && ((isEmpty() && ((kotlin.ranges.CharProgression) other).isEmpty()) || (this.first == ((kotlin.ranges.CharProgression) other).first && this.last == ((kotlin.ranges.CharProgression) other).last && this.step == ((kotlin.ranges.CharProgression) other).step));
    }
