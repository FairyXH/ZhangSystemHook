...
public interface IServiceManager extends android.hidl.manager.V1_0.IServiceManager {
    ...
    static android.hidl.manager.V1_1.IServiceManager asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        android.os.IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof android.hidl.manager.V1_1.IServiceManager)) {
            return (android.hidl.manager.V1_1.IServiceManager) iface;
        }
        android.hidl.manager.V1_1.IServiceManager proxy = new android.hidl.manager.V1_1.IServiceManager.Proxy(binder);
        try {
    ...
    static android.hidl.manager.V1_1.IServiceManager castFrom(android.os.IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static android.hidl.manager.V1_1.IServiceManager getService(java.lang.String serviceName, boolean retry) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static android.hidl.manager.V1_1.IServiceManager getService(boolean retry) throws android.os.RemoteException {
        return getService("default", retry);
    }

    @java.lang.Deprecated
    static android.hidl.manager.V1_1.IServiceManager getService(java.lang.String serviceName) throws android.os.RemoteException {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hidl.manager.V1_1.IServiceManager {
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String descriptor) {
            if (android.hidl.manager.V1_1.IServiceManager.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
