...
public final class CommandResult {
    ...
    public final boolean equals(java.lang.Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != android.hardware.boot.V1_0.CommandResult.class) {
            return false;
        }
        android.hardware.boot.V1_0.CommandResult other = (android.hardware.boot.V1_0.CommandResult) otherObject;
        if (this.success == other.success && android.os.HidlSupport.deepEquals(this.errMsg, other.errMsg)) {
            return true;
        }
        return false;
    }
    ...
    public static final java.util.ArrayList<android.hardware.boot.V1_0.CommandResult> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<android.hardware.boot.V1_0.CommandResult> _hidl_vec = new java.util.ArrayList<>();
    ...
    public final void readEmbeddedFromParcel(android.os.HwParcel parcel, android.os.HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.errMsg = _hidl_blob.getString(_hidl_offset + 8);
        parcel.readEmbeddedBuffer(this.errMsg.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 8 + 0, false);
    }
    ...
    public static final void writeVectorToParcel(android.os.HwParcel parcel, java.util.ArrayList<android.hardware.boot.V1_0.CommandResult> _hidl_vec) {
