...
public final class ULongArrayKt {
    private static final long[] ULongArray(int size, kotlin.jvm.functions.Function1<? super java.lang.Integer, kotlin.ULong> init) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(init, "init");
        long[] jArr = new long[size];
        for (int i = 0; i < size; i++) {
            jArr[i] = init.invoke(java.lang.Integer.valueOf(i)).getData();
        }
        return kotlin.ULongArray.m11536constructorimpl(jArr);
    }

    /* JADX INFO: renamed from: ulongArrayOf-QwZRm1k, reason: not valid java name */
    private static final long[] m11552ulongArrayOfQwZRm1k(long... elements) {
