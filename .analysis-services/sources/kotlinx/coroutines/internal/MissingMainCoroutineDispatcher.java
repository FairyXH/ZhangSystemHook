...
final class MissingMainCoroutineDispatcher extends kotlinx.coroutines.MainCoroutineDispatcher implements kotlinx.coroutines.Delay {
    ...
    public /* bridge */ /* synthetic */ void mo12865scheduleResumeAfterDelay(long timeMillis, kotlinx.coroutines.CancellableContinuation continuation) {
        scheduleResumeAfterDelay(timeMillis, (kotlinx.coroutines.CancellableContinuation<? super kotlin.Unit>) continuation);
    }

    public MissingMainCoroutineDispatcher(java.lang.Throwable cause, java.lang.String errorHint) {
        this.cause = cause;
    ...
    public java.lang.Void mo12864dispatch(kotlin.coroutines.CoroutineContext context, java.lang.Runnable block) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(context, "context");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(block, "block");
        missing();
        throw new kotlin.KotlinNothingValueException();
    ...
    private final java.lang.Void missing() {
        ...
        java.lang.String it2 = this.errorHint;
        if (it2 == null || (it = ". " + it2) == null) {
            it = "";
        }
        java.lang.String message = "Module with the Main dispatcher had failed to initialize" + it;
        throw new java.lang.IllegalStateException(message, this.cause);
    }
