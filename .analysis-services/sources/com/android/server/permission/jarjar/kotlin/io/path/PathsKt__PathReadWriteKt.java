...
class PathsKt__PathReadWriteKt {
    ...
    private static final byte[] readBytes(java.nio.file.Path $this$readBytes) throws java.io.IOException {
        ...
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(allBytes, "readAllBytes(...)");
        return allBytes;
    }
    ...
    public static /* synthetic */ java.lang.String readText$default(java.nio.file.Path path, java.nio.charset.Charset charset, int i, java.lang.Object obj) throws java.io.IOException {
        ...
        return com.android.server.permission.jarjar.kotlin.io.path.PathsKt.readText(path, charset);
    }
    ...
    public static /* synthetic */ void writeText$default(java.nio.file.Path path, java.lang.CharSequence charSequence, java.nio.charset.Charset charset, java.nio.file.OpenOption[] openOptionArr, int i, java.lang.Object obj) throws java.io.IOException {
        ...
        com.android.server.permission.jarjar.kotlin.io.path.PathsKt.writeText(path, charSequence, charset, openOptionArr);
    }
    ...
    public static final void writeText(java.nio.file.Path $this$writeText, java.lang.CharSequence text, java.nio.charset.Charset charset, java.nio.file.OpenOption... options) throws java.io.IOException {
        ...
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(outputStreamNewOutputStream, "newOutputStream(...)");
        ...
        try {
            ...
            it.append(text);
            com.android.server.permission.jarjar.kotlin.io.CloseableKt.closeFinally(outputStreamWriter, null);
        } finally {
        }
    }
    ...
    public static /* synthetic */ void appendText$default(java.nio.file.Path path, java.lang.CharSequence charSequence, java.nio.charset.Charset charset, int i, java.lang.Object obj) throws java.io.IOException {
        ...
        com.android.server.permission.jarjar.kotlin.io.path.PathsKt.appendText(path, charSequence, charset);
    }
    ...
    static /* synthetic */ void forEachLine$default(java.nio.file.Path $this$forEachLine_u24default, java.nio.charset.Charset charset, com.android.server.permission.jarjar.kotlin.jvm.functions.Function1 action, int i, java.lang.Object obj) throws java.io.IOException {
        if ((i & 1) != 0) {
            charset = com.android.server.permission.jarjar.kotlin.text.Charsets.UTF_8;
        }
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$forEachLine_u24default, "<this>");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(charset, "charset");
        ...
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(readerNewBufferedReader, "newBufferedReader(...)");
        ...
        try {
            ...
            java.util.Iterator<java.lang.String> it = com.android.server.permission.jarjar.kotlin.io.TextStreamsKt.lineSequence(it$iv).iterator();
            while (it.hasNext()) {
    ...
    private static final void forEachLine(java.nio.file.Path $this$forEachLine, java.nio.charset.Charset charset, com.android.server.permission.jarjar.kotlin.jvm.functions.Function1<? super java.lang.String, com.android.server.permission.jarjar.kotlin.Unit> function1) throws java.io.IOException {
        ...
        try {
            java.io.BufferedReader it$iv = bufferedReader;
            for (java.lang.Object element$iv : com.android.server.permission.jarjar.kotlin.io.TextStreamsKt.lineSequence(it$iv)) {
    ...
    private static final java.io.InputStream inputStream(java.nio.file.Path $this$inputStream, java.nio.file.OpenOption... options) throws java.io.IOException {
        ...
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(inputStreamNewInputStream, "newInputStream(...)");
    ...
    static /* synthetic */ java.util.List readLines$default(java.nio.file.Path $this$readLines_u24default, java.nio.charset.Charset charset, int i, java.lang.Object obj) throws java.io.IOException {
        ...
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$readLines_u24default, "<this>");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(charset, "charset");
        java.util.List<java.lang.String> allLines = java.nio.file.Files.readAllLines($this$readLines_u24default, charset);
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(allLines, "readAllLines(...)");
        return allLines;
    }
    ...
    static /* synthetic */ java.lang.Object useLines$default(java.nio.file.Path $this$useLines_u24default, java.nio.charset.Charset charset, com.android.server.permission.jarjar.kotlin.jvm.functions.Function1 block, int i, java.lang.Object obj) throws java.io.IOException {
        if ((i & 1) != 0) {
            charset = com.android.server.permission.jarjar.kotlin.text.Charsets.UTF_8;
        }
        ...
        try {
            ...
            com.android.server.permission.jarjar.kotlin.jvm.internal.InlineMarker.finallyStart(1);
            if (com.android.server.permission.jarjar.kotlin.internal.PlatformImplementationsKt.apiVersionIsAtLeast(1, 1, 0)) {
                com.android.server.permission.jarjar.kotlin.io.CloseableKt.closeFinally(bufferedReaderNewBufferedReader, null);
            ...
            try {
                ...
                com.android.server.permission.jarjar.kotlin.jvm.internal.InlineMarker.finallyStart(1);
                if (com.android.server.permission.jarjar.kotlin.internal.PlatformImplementationsKt.apiVersionIsAtLeast(1, 1, 0)) {
                    com.android.server.permission.jarjar.kotlin.io.CloseableKt.closeFinally(bufferedReaderNewBufferedReader, th);
                } else if (bufferedReaderNewBufferedReader != null) {
                    try {
                        bufferedReaderNewBufferedReader.close();
                    } catch (java.lang.Throwable th3) {
    ...
    private static final <T> T useLines(java.nio.file.Path $this$useLines, java.nio.charset.Charset charset, com.android.server.permission.jarjar.kotlin.jvm.functions.Function1<? super com.android.server.permission.jarjar.kotlin.sequences.Sequence<java.lang.String>, ? extends T> function1) throws java.io.IOException {
    ...
    static /* synthetic */ java.nio.file.Path writeLines$default(java.nio.file.Path $this$writeLines_u24default, java.lang.Iterable lines, java.nio.charset.Charset charset, java.nio.file.OpenOption[] options, int i, java.lang.Object obj) throws java.io.IOException {
        ...
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$writeLines_u24default, "<this>");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(lines, "lines");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(charset, "charset");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(options, "options");
        ...
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(pathWrite, "write(...)");
        return pathWrite;
    }

    private static final java.nio.file.Path writeLines(java.nio.file.Path $this$writeLines, java.lang.Iterable<? extends java.lang.CharSequence> iterable, java.nio.charset.Charset charset, java.nio.file.OpenOption... options) throws java.io.IOException {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$writeLines, "<this>");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(iterable, "lines");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(charset, "charset");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(options, "options");
        java.nio.file.Path pathWrite = java.nio.file.Files.write($this$writeLines, iterable, charset, (java.nio.file.OpenOption[]) java.util.Arrays.copyOf(options, options.length));
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(pathWrite, "write(...)");
        return pathWrite;
    }

    static /* synthetic */ java.nio.file.Path writeLines$default(java.nio.file.Path $this$writeLines_u24default, com.android.server.permission.jarjar.kotlin.sequences.Sequence lines, java.nio.charset.Charset charset, java.nio.file.OpenOption[] options, int i, java.lang.Object obj) throws java.io.IOException {
        if ((i & 2) != 0) {
            charset = com.android.server.permission.jarjar.kotlin.text.Charsets.UTF_8;
        }
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$writeLines_u24default, "<this>");
        ...
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(charset, "charset");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(options, "options");
        java.nio.file.Path pathWrite = java.nio.file.Files.write($this$writeLines_u24default, com.android.server.permission.jarjar.kotlin.sequences.SequencesKt.asIterable(lines), charset, (java.nio.file.OpenOption[]) java.util.Arrays.copyOf(options, options.length));
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(pathWrite, "write(...)");
        return pathWrite;
    }

    private static final java.nio.file.Path writeLines(java.nio.file.Path $this$writeLines, com.android.server.permission.jarjar.kotlin.sequences.Sequence<? extends java.lang.CharSequence> sequence, java.nio.charset.Charset charset, java.nio.file.OpenOption... options) throws java.io.IOException {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$writeLines, "<this>");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(sequence, "lines");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(charset, "charset");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(options, "options");
        java.nio.file.Path pathWrite = java.nio.file.Files.write($this$writeLines, com.android.server.permission.jarjar.kotlin.sequences.SequencesKt.asIterable(sequence), charset, (java.nio.file.OpenOption[]) java.util.Arrays.copyOf(options, options.length));
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(pathWrite, "write(...)");
        return pathWrite;
    }
    ...
    static /* synthetic */ java.nio.file.Path appendLines$default(java.nio.file.Path $this$appendLines_u24default, java.lang.Iterable lines, java.nio.charset.Charset charset, int i, java.lang.Object obj) throws java.io.IOException {
        ...
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$appendLines_u24default, "<this>");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(lines, "lines");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(charset, "charset");
    ...
    private static final java.nio.file.Path appendLines(java.nio.file.Path $this$appendLines, java.lang.Iterable<? extends java.lang.CharSequence> iterable, java.nio.charset.Charset charset) throws java.io.IOException {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$appendLines, "<this>");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(iterable, "lines");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(charset, "charset");
        java.nio.file.Path pathWrite = java.nio.file.Files.write($this$appendLines, iterable, charset, java.nio.file.StandardOpenOption.APPEND);
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(pathWrite, "write(...)");
        return pathWrite;
    }

    static /* synthetic */ java.nio.file.Path appendLines$default(java.nio.file.Path $this$appendLines_u24default, com.android.server.permission.jarjar.kotlin.sequences.Sequence lines, java.nio.charset.Charset charset, int i, java.lang.Object obj) throws java.io.IOException {
        if ((i & 2) != 0) {
            charset = com.android.server.permission.jarjar.kotlin.text.Charsets.UTF_8;
        }
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$appendLines_u24default, "<this>");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(lines, "lines");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(charset, "charset");
        java.nio.file.Path pathWrite = java.nio.file.Files.write($this$appendLines_u24default, com.android.server.permission.jarjar.kotlin.sequences.SequencesKt.asIterable(lines), charset, java.nio.file.StandardOpenOption.APPEND);
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(pathWrite, "write(...)");
        return pathWrite;
    }

    private static final java.nio.file.Path appendLines(java.nio.file.Path $this$appendLines, com.android.server.permission.jarjar.kotlin.sequences.Sequence<? extends java.lang.CharSequence> sequence, java.nio.charset.Charset charset) throws java.io.IOException {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter($this$appendLines, "<this>");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(sequence, "lines");
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(charset, "charset");
        java.nio.file.Path pathWrite = java.nio.file.Files.write($this$appendLines, com.android.server.permission.jarjar.kotlin.sequences.SequencesKt.asIterable(sequence), charset, java.nio.file.StandardOpenOption.APPEND);
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(pathWrite, "write(...)");
        return pathWrite;
    }
}
