...
public interface IHdmiCec extends android.hidl.base.V1_0.IBase {
    ...
    static android.hardware.tv.cec.V1_0.IHdmiCec asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        android.os.IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof android.hardware.tv.cec.V1_0.IHdmiCec)) {
            return (android.hardware.tv.cec.V1_0.IHdmiCec) iface;
        }
        android.hardware.tv.cec.V1_0.IHdmiCec proxy = new android.hardware.tv.cec.V1_0.IHdmiCec.Proxy(binder);
        try {
    ...
    static android.hardware.tv.cec.V1_0.IHdmiCec castFrom(android.os.IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static android.hardware.tv.cec.V1_0.IHdmiCec getService(java.lang.String serviceName, boolean retry) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static android.hardware.tv.cec.V1_0.IHdmiCec getService(boolean retry) throws android.os.RemoteException {
        return getService("default", retry);
    }

    @java.lang.Deprecated
    static android.hardware.tv.cec.V1_0.IHdmiCec getService(java.lang.String serviceName) throws android.os.RemoteException {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.tv.cec.V1_0.IHdmiCec {
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String descriptor) {
            if (android.hardware.tv.cec.V1_0.IHdmiCec.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
