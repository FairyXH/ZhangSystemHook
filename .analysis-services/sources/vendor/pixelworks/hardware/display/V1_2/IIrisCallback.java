...
public interface IIrisCallback extends vendor.pixelworks.hardware.display.V1_1.IIrisCallback {
    public static final java.lang.String kInterfaceName = "vendor.pixelworks.hardware.display@1.2::IIrisCallback";

    @java.lang.FunctionalInterface
    public interface onContentSamplingRequestedCallback {
        void onValues(int i, java.util.ArrayList<java.lang.Long> arrayList, java.util.ArrayList<java.lang.Long> arrayList2, java.util.ArrayList<java.lang.Long> arrayList3, java.util.ArrayList<java.lang.Long> arrayList4);
    }
    ...
    void onContentSamplingRequested(long j, int i, long j2, vendor.pixelworks.hardware.display.V1_2.IIrisCallback.onContentSamplingRequestedCallback oncontentsamplingrequestedcallback) throws android.os.RemoteException;
    ...
    static vendor.pixelworks.hardware.display.V1_2.IIrisCallback asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        android.os.IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof vendor.pixelworks.hardware.display.V1_2.IIrisCallback)) {
            return (vendor.pixelworks.hardware.display.V1_2.IIrisCallback) iface;
        }
        vendor.pixelworks.hardware.display.V1_2.IIrisCallback proxy = new vendor.pixelworks.hardware.display.V1_2.IIrisCallback.Proxy(binder);
        try {
    ...
    static vendor.pixelworks.hardware.display.V1_2.IIrisCallback castFrom(android.os.IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static vendor.pixelworks.hardware.display.V1_2.IIrisCallback getService(java.lang.String serviceName, boolean retry) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static vendor.pixelworks.hardware.display.V1_2.IIrisCallback getService(boolean retry) throws android.os.RemoteException {
        return getService("default", retry);
    }

    @java.lang.Deprecated
    static vendor.pixelworks.hardware.display.V1_2.IIrisCallback getService(java.lang.String serviceName) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName));
    }

    @java.lang.Deprecated
    static vendor.pixelworks.hardware.display.V1_2.IIrisCallback getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements vendor.pixelworks.hardware.display.V1_2.IIrisCallback {
        ...
        @Override // vendor.pixelworks.hardware.display.V1_2.IIrisCallback, vendor.pixelworks.hardware.display.V1_1.IIrisCallback, vendor.pixelworks.hardware.display.V1_0.IIrisCallback, android.hidl.base.V1_0.IBase
        ...
        public void onContentSamplingRequested(long display, int action, long maxFrames, vendor.pixelworks.hardware.display.V1_2.IIrisCallback.onContentSamplingRequestedCallback _hidl_cb) throws android.os.RemoteException {
            android.os.HwParcel _hidl_request = new android.os.HwParcel();
            _hidl_request.writeInterfaceToken(vendor.pixelworks.hardware.display.V1_2.IIrisCallback.kInterfaceName);
            _hidl_request.writeInt64(display);
            _hidl_request.writeInt32(action);
            _hidl_request.writeInt64(maxFrames);
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                ...
                _hidl_request.releaseTemporaryStorage();
                int _hidl_out_result = _hidl_reply.readInt32();
                java.util.ArrayList<java.lang.Long> _hidl_out_samples0 = _hidl_reply.readInt64Vector();
                java.util.ArrayList<java.lang.Long> _hidl_out_samples1 = _hidl_reply.readInt64Vector();
                java.util.ArrayList<java.lang.Long> _hidl_out_samples2 = _hidl_reply.readInt64Vector();
                java.util.ArrayList<java.lang.Long> _hidl_out_samples3 = _hidl_reply.readInt64Vector();
                _hidl_cb.onValues(_hidl_out_result, _hidl_out_samples0, _hidl_out_samples1, _hidl_out_samples2, _hidl_out_samples3);
            } finally {
                _hidl_reply.release();
            }
        }
    ...
    public static abstract class Stub extends android.os.HwBinder implements vendor.pixelworks.hardware.display.V1_2.IIrisCallback {
        @Override // vendor.pixelworks.hardware.display.V1_2.IIrisCallback, vendor.pixelworks.hardware.display.V1_1.IIrisCallback, vendor.pixelworks.hardware.display.V1_0.IIrisCallback, android.hidl.base.V1_0.IBase
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(vendor.pixelworks.hardware.display.V1_2.IIrisCallback.kInterfaceName, vendor.pixelworks.hardware.display.V1_1.IIrisCallback.kInterfaceName, vendor.pixelworks.hardware.display.V1_0.IIrisCallback.kInterfaceName, android.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String descriptor) {
            if (vendor.pixelworks.hardware.display.V1_2.IIrisCallback.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int _hidl_code, android.os.HwParcel _hidl_request, final android.os.HwParcel _hidl_reply, int _hidl_flags) throws android.os.RemoteException {
            switch (_hidl_code) {
                ...
                case 4:
                    ...
                    return;
                case 5:
                    _hidl_request.enforceInterface(vendor.pixelworks.hardware.display.V1_2.IIrisCallback.kInterfaceName);
                    long display4 = _hidl_request.readInt64();
                    int action = _hidl_request.readInt32();
                    long maxFrames = _hidl_request.readInt64();
                    onContentSamplingRequested(display4, action, maxFrames, new vendor.pixelworks.hardware.display.V1_2.IIrisCallback.onContentSamplingRequestedCallback() { // from class: vendor.pixelworks.hardware.display.V1_2.IIrisCallback.Stub.1
                        @Override // vendor.pixelworks.hardware.display.V1_2.IIrisCallback.onContentSamplingRequestedCallback
                        public void onValues(int result, java.util.ArrayList<java.lang.Long> samples0, java.util.ArrayList<java.lang.Long> samples1, java.util.ArrayList<java.lang.Long> samples2, java.util.ArrayList<java.lang.Long> samples3) {
                            _hidl_reply.writeStatus(0);
                            _hidl_reply.writeInt32(result);
                            _hidl_reply.writeInt64Vector(samples0);
                            _hidl_reply.writeInt64Vector(samples1);
                            _hidl_reply.writeInt64Vector(samples2);
                            _hidl_reply.writeInt64Vector(samples3);
                            _hidl_reply.send();
                        }
                    });
                    return;
