...
public class MappedImage implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.gsi.MappedImage> CREATOR = new android.os.Parcelable.Creator<android.gsi.MappedImage>() { // from class: android.gsi.MappedImage.1
        ...
        public android.gsi.MappedImage createFromParcel(android.os.Parcel _aidl_source) {
            android.gsi.MappedImage _aidl_out = new android.gsi.MappedImage();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.gsi.MappedImage[] newArray(int _aidl_size) {
            return new android.gsi.MappedImage[_aidl_size];
        }
    };
