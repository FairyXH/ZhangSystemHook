...
public final class DeepRecursiveKt {
    ...
    public static final <T, R> R invoke(com.android.server.permission.jarjar.kotlin.DeepRecursiveFunction<T, R> deepRecursiveFunction, T t) {
        com.android.server.permission.jarjar.kotlin.jvm.internal.Intrinsics.checkNotNullParameter(deepRecursiveFunction, "<this>");
        return (R) new com.android.server.permission.jarjar.kotlin.DeepRecursiveScopeImpl(deepRecursiveFunction.getBlock$kotlin_stdlib(), t).runCallLoop();
    }
    ...
    static {
        ...
        UNDEFINED_RESULT = com.android.server.permission.jarjar.kotlin.Result.m6089constructorimpl(com.android.server.permission.jarjar.kotlin.coroutines.intrinsics.IntrinsicsKt.getCOROUTINE_SUSPENDED());
    }
}
