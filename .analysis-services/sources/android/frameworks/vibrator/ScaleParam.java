...
public class ScaleParam implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.frameworks.vibrator.ScaleParam> CREATOR = new android.os.Parcelable.Creator<android.frameworks.vibrator.ScaleParam>() { // from class: android.frameworks.vibrator.ScaleParam.1
        ...
        public android.frameworks.vibrator.ScaleParam createFromParcel(android.os.Parcel _aidl_source) {
            android.frameworks.vibrator.ScaleParam _aidl_out = new android.frameworks.vibrator.ScaleParam();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.frameworks.vibrator.ScaleParam[] newArray(int _aidl_size) {
            return new android.frameworks.vibrator.ScaleParam[_aidl_size];
        }
    };
    ...
    public final void writeToParcel(android.os.Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeInt(this.typesMask);
    ...
    public final void readFromParcel(android.os.Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.typesMask = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new android.os.BadParcelableException("Overflow in the size of parcelable");
                }
