...
public class FakeFeatureFlagsImpl extends com.android.server.power.hint.CustomFeatureFlags {
    private final com.android.server.power.hint.FeatureFlags mDefaults;
    ...
    public FakeFeatureFlagsImpl(com.android.server.power.hint.FeatureFlags defaults) {
        super(null);
    ...
    @Override // com.android.server.power.hint.CustomFeatureFlags
