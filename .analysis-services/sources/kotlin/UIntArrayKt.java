...
public final class UIntArrayKt {
    private static final int[] UIntArray(int size, kotlin.jvm.functions.Function1<? super java.lang.Integer, kotlin.UInt> init) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(init, "init");
        int[] iArr = new int[size];
        for (int i = 0; i < size; i++) {
            iArr[i] = init.invoke(java.lang.Integer.valueOf(i)).getData();
        }
        return kotlin.UIntArray.m11457constructorimpl(iArr);
    }

    /* JADX INFO: renamed from: uintArrayOf--ajY-9A, reason: not valid java name */
    private static final int[] m11473uintArrayOfajY9A(int... elements) {
