...
public enum OnErrorResult {
    ...
    public static com.android.server.permission.jarjar.kotlin.enums.EnumEntries<com.android.server.permission.jarjar.kotlin.io.path.OnErrorResult> getEntries() {
        return $ENTRIES;
    }
}
