...
public class SchedulerCoroutineDispatcher extends kotlinx.coroutines.ExecutorCoroutineDispatcher {
    ...
    public SchedulerCoroutineDispatcher(int corePoolSize, int maxPoolSize, long idleWorkerKeepAliveNs, java.lang.String schedulerName) {
    ...
    public final void dispatchWithContext$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host(java.lang.Runnable block, kotlinx.coroutines.scheduling.TaskContext context, boolean tailDispatch) {
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(block, "block");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(context, "context");
    ...
    public final synchronized void usePrivateScheduler$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host() {
        this.coroutineScheduler.shutdown(1000L);
        this.coroutineScheduler = createScheduler();
    }

    public final synchronized void shutdown$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host(long timeout) {
        this.coroutineScheduler.shutdown(timeout);
    }

    public final void restore$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host() {
