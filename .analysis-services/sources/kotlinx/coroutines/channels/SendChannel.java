...
public interface SendChannel<E> {
    ...
    java.lang.Object mo12809trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(kotlinx.coroutines.channels.SendChannel<? super E> sendChannel, E e) throws java.lang.Throwable {
            java.lang.Object result = sendChannel.mo12809trySendJP2dKIU(e);
            if (kotlinx.coroutines.channels.ChannelResult.m12829isSuccessimpl(result)) {
                return true;
            }
            java.lang.Throwable thM12823exceptionOrNullimpl = kotlinx.coroutines.channels.ChannelResult.m12823exceptionOrNullimpl(result);
