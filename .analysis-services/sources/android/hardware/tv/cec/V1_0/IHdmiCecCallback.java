...
public interface IHdmiCecCallback extends android.hidl.base.V1_0.IBase {
    ...
    static android.hardware.tv.cec.V1_0.IHdmiCecCallback asInterface(android.os.IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        android.os.IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof android.hardware.tv.cec.V1_0.IHdmiCecCallback)) {
            return (android.hardware.tv.cec.V1_0.IHdmiCecCallback) iface;
        }
        android.hardware.tv.cec.V1_0.IHdmiCecCallback proxy = new android.hardware.tv.cec.V1_0.IHdmiCecCallback.Proxy(binder);
        try {
    ...
    static android.hardware.tv.cec.V1_0.IHdmiCecCallback castFrom(android.os.IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static android.hardware.tv.cec.V1_0.IHdmiCecCallback getService(java.lang.String serviceName, boolean retry) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static android.hardware.tv.cec.V1_0.IHdmiCecCallback getService(boolean retry) throws android.os.RemoteException {
        return getService("default", retry);
    }

    @java.lang.Deprecated
    static android.hardware.tv.cec.V1_0.IHdmiCecCallback getService(java.lang.String serviceName) throws android.os.RemoteException {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.tv.cec.V1_0.IHdmiCecCallback {
        ...
        public final java.util.ArrayList<byte[]> getHashChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(new byte[]{-25, 91, 110, -22, 113, 29, 54, -6, -58, 120, -68, -32, 114, -77, -50, -58, 84, 75, 39, -6, -97, 76, -39, 3, -103, -108, 4, -27, -63, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_CAPABILITY, -54, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_CAPABILITY}, new byte[]{-20, 127, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_PHYSICAL, -17, 5, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_INTERFACE, -13, -51, 105, 87, 19, -109, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_INTERFACE, -72, 59, 24, -54, 76}));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String descriptor) {
            if (android.hardware.tv.cec.V1_0.IHdmiCecCallback.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
