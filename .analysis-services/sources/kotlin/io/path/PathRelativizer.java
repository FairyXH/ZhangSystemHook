...
final class PathRelativizer {
    ...
    public final java.nio.file.Path tryRelativeTo(java.nio.file.Path path, java.nio.file.Path base) {
        ...
        for (int i = 0; i < iMin && kotlin.jvm.internal.Intrinsics.areEqual(bn.getName(i), parentPath); i++) {
            if (!kotlin.jvm.internal.Intrinsics.areEqual(pn.getName(i), parentPath)) {
                throw new java.lang.IllegalArgumentException("Unable to compute relative path");
            }
        }
        if (!kotlin.jvm.internal.Intrinsics.areEqual(pn, bn) && kotlin.jvm.internal.Intrinsics.areEqual(bn, emptyPath)) {
            path2 = pn;
        } else {
            ...
            if (kotlin.text.StringsKt.endsWith$default(rnString, separator, false, 2, (java.lang.Object) null)) {
                path2 = rn.getFileSystem().getPath(kotlin.text.StringsKt.dropLast(rnString, rn.getFileSystem().getSeparator().length()), new java.lang.String[0]);
            } else {
                path2 = rn;
            }
        }
