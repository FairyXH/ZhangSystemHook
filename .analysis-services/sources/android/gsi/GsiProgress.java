...
public class GsiProgress implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.gsi.GsiProgress> CREATOR = new android.os.Parcelable.Creator<android.gsi.GsiProgress>() { // from class: android.gsi.GsiProgress.1
        ...
        public android.gsi.GsiProgress createFromParcel(android.os.Parcel _aidl_source) {
            android.gsi.GsiProgress _aidl_out = new android.gsi.GsiProgress();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.gsi.GsiProgress[] newArray(int _aidl_size) {
            return new android.gsi.GsiProgress[_aidl_size];
        }
    };
